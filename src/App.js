        ...
        <div className="max-w-md sm:max-w-2xl lg:max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-6 mb-4">
            <div className="flex items-center justify-center mb-6">
              <svg className="w-10 h-10 mr-2" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2C10 2 8.5 2.5 7.5 3.5C6.5 4.5 6 6 6 8C6 10 5.5 12 4.5 14C3.5 16 3 18 3 20C3 21.1 3.9 22 5 22C6.1 22 7 21.1 7 20C7 19 7.5 17.5 8 16C8.5 14.5 9 13 9 12C9 11 9.5 10.5 10 10.5C10.5 10.5 11 11 11 12L11 20C11 21.1 11.9 22 13 22C14.1 22 15 21.1 15 20L15 12C15 11 15.5 10.5 16 10.5C16.5 10.5 17 11 17 12C17 13 17.5 14.5 18 16C18.5 17.5 19 19 19 20C19 21.1 19.9 22 21 22C22.1 22 23 21.1 23 20C23 18 22 16 21 14C20 12 19.5 10 19.5 8C19.5 6 19 4.5 18 3.5C17 2.5 15.5 2 14 2C13 2 12.5 2 12 2Z" stroke="#e0e0e0" stroke-width="0.5"/>
              </svg>
