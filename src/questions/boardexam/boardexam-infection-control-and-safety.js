// Board Exam - Infection Control and Safety
...
export const questions = {
  "1. Infection Control": [
    {
      id: 15100,
      question: "What is the primary objective of infection prevention and control in healthcare settings?",
      options: [
        "To prevent healthcare-associated infections in patients and occupational injuries in personnel",
        "To eliminate all microorganisms from the environment",
        "To identify all patients with infectious diseases",
    ...
    },
    {
      ...
      options: [
        ...
        "Invasive Procedure Control"
      ],
      correct: "B"
    },
    {
      id: 15102,
      question: "What is a healthcare-associated infection (HAI)?",
      options: [
        "An infection acquired in the community",
        "An infection present before hospital admission",
        "An infection acquired by patients during healthcare delivery",
        "An infection that only affects healthcare workers"
      ],
      correct: "C"
    },
    {
      id: 15103,
      question: "Which statement best describes the infection-control model?",
      options: [
        "It is identical to the traditional patient care model",
        "It focuses on tasks and procedures to protect both patient and provider",
        "It relies solely on patient health histories",
        "It only protects the healthcare provider"
      ],
      correct: "B"
    },
    {
      ...
      options: [
        ...
        "Health histories are too time-consuming",
        "Healthcare workers cannot read health histories"
      ],
      correct: "B"
    },
    {
      id: 15105,
      question: "Which agency develops infection-control guidelines but does NOT enforce them?",
      options: [
        "OSHA",
        "FDA",
        "CDC",
    ...
    },
    {
      ...
      options: [
        ...
        "To regulate chemical germicides"
      ],
      correct: "B"
    },
    {
      id: 15107,
      question: "Which agency enforces workplace safety regulations including those for IPC in healthcare settings?",
      options: [
        "CDC",
        "EPA",
        "FDA",
    ...
    },
    {
      ...
      options: [
        ...
        "Operational Standards for Healthcare Activities"
      ],
      correct: "B"
    },
    {
      id: 15109,
      question: "Which agency regulates medical devices from simple items to complex technologies?",
      options: [
        "CDC",
        "EPA",
        "FDA",
    ...
    },
    {
      ...
      options: [
        ...
        "To develop infection control guidelines"
      ],
      correct: "C"
    },
    {
      id: 15111,
      question: "What is the standard of care in infection control?",
      options: [
        "The maximum level of care possible",
        "The minimum level acceptable in all aspects of patient care",
        "Care provided only in hospital settings",
        "Care determined by individual practitioners"
      ],
      correct: "B"
    },
    {
      id: 15112,
      question: "What determines the standard of care for infection-control practices?",
      options: [
        "Individual practitioner preference only",
        "Patient requests",
        "Regulations, evidence-based guidelines, government agencies, licensing boards, and expert opinion",
        "Cost considerations"
      ],
      correct: "C"
    },
    {
      id: 15113,
      question: "Which pathogen can be transmitted in dental healthcare settings?",
      options: [
        "Only bacteria",
        "Only viruses",
        "Pathogens including HBV, HCV, HIV, TB, staphylococci, streptococci, influenza, and coronavirus",
        "Only bloodborne pathogens"
      ],
      correct: "C"
    },
    {
      id: 15114,
      question: "What are the routes of transmission in dental settings?",
      options: [
        "Airborne transmission only",
        "Direct contact, indirect contact, droplet contact, and inhalation of airborne microorganisms",
        "Only through blood exposure",
    ...
    {
      id: 15115,
      question: "What conditions must be present for infection to occur?",
      options: [
        "Only a pathogenic organism",
        "Only a susceptible host",
        "Pathogenic organism, reservoir, mode of transmission, portal of entry, and susceptible host",
        "Only a mode of transmission"
      ],
      correct: "C"
    },
    {
      id: 15116,
      question: "How do effective infection-control strategies prevent disease transmission?",
      options: [
        "By treating all infected patients",
        "By interrupting one or more links in the chain of infection",
        "By isolating all patients",
        "By using antibiotics prophylactically"
      ],
      correct: "B"
    },
    {
      id: 15117,
      question: "How many principles of IPC does the CDC identify?",
      options: [
        "Two",
        "Three",
        "Four",
    ...
    {
      id: 15118,
      question: "What is Principle 1 of IPC?",
      options: [
    ...
    {
      id: 15119,
      question: "What should a personnel health program include according to CDC guidelines?",
      options: [
        "Only immunizations",
        "Hand hygiene, medical evaluation, training, work-related illness management, postexposure management, and immunization",
        "Only annual physical exams",
        "Only infection control training"
      ],
      correct: "B"
    },
    {
      id: 15120,
      question: "What is one of the most effective means of preventing disease transmission?",
      options: [
    ...
    {
      id: 15121,
      question: "Which vaccine is recommended annually for all healthcare personnel?",
      options: [
        "Hepatitis B",
        "MMR",
        "Influenza",
    ...
    {
      id: 15122,
      question: "What does the HBV vaccine protect against?",
      options: [
        "Hepatitis A virus",
        "Hepatitis B virus",
        "Hepatitis C virus",
    ...
    {
      id: 15123,
      question: "How many doses are in the standard HBV vaccination series?",
      options: [
        "One",
        "Two",
        "Three",
    ...
    {
      id: 15124,
      question: "When should anti-HBs testing be performed after HBV vaccination?",
      options: [
        "Immediately after the first dose",
        "Before starting the series",
        "1 to 2 months after the third dose",
    ...
    {
      id: 15125,
      question: "What does Tdap protect against?",
      options: [
        "Tuberculosis, diphtheria, and pertussis",
        "Tetanus, diphtheria, and acellular pertussis",
        "Typhoid, dengue, and plague",
        "Toxoplasmosis, diarrhea, and pneumonia"
      ],
      correct: "B"
    },
    {
      id: 15126,
      question: "How often should the Td booster be given?",
      options: [
        "Every 5 years",
        "Every 10 years",
        "Every 15 years",
    ...
    {
      id: 15127,
      question: "What should HCP with active tuberculosis do?",
      options: [
        "Continue working with a mask",
        "Refrain from working until illness resolves",
        "Work only with adult patients",
        "Take antibiotics while working"
      ],
      correct: "B"
    },
    {
      id: 15128,
      question: "What should HCP with measles or mumps do?",
      options: [
        "Continue working with precautions",
        "Work only half days",
        "Refrain from working during acute illness and after exposure if not immunized",
    ...
    {
      id: 15129,
      question: "What is Principle 2 of IPC?",
      options: [
        "Take action to stay healthy",
    ...
    },
    {
      ...
      options: [
        ...
        "Primary Prevention Essentials",
        "Patient Protection Elements"
      ],
      correct: "B"
    },
    {
      id: 15131,
      question: "What do standard precautions require?",
      options: [
        "Different protocols for different patients",
        "The same protocols for all patients regardless of infectious status",
        "Extra precautions only for known infected patients",
        "Precautions based on health history"
      ],
      correct: "B"
    },
    {
      ...
      options: [
        ...
        "Health histories take too long to review",
        "DHCP are not trained to interpret health histories"
      ],
      correct: "B"
    },
    {
      id: 15133,
      question: "To what do standard precautions apply?",
      options: [
        "Blood only",
        "All body fluids except sweat and tears",
        "Only visibly contaminated fluids",
        "Only bloodborne pathogens"
      ],
      correct: "B"
    },
    {
      id: 15134,
      question: "What are transmission-based precautions?",
      options: [
        "Replacements for standard precautions",
        "Measures in addition to standard precautions based on route of transmission",
        "Precautions used instead of PPE",
        "Precautions only for surgical procedures"
      ],
      correct: "B"
    },
    {
      id: 15135,
      question: "What are the three categories of transmission-based precautions?",
      options: [
        "Blood, saliva, and respiratory",
    ...
    {
      id: 15136,
      question: "For clinically active TB, what type of precautions are needed?",
      options: [
        "Standard precautions only",
        "Contact precautions",
        "A hierarchy including administrative controls, environmental controls, and respiratory protection",
    ...
    {
      id: 15137,
      question: "What should be done for patients with active TB?",
      options: [
        "Treat immediately in the regular operatory",
        "Evaluate away from others, defer elective treatment, refer urgent treatment to appropriate facility",
        "Provide treatment with standard precautions",
    ...
    {
      id: 15138,
      question: "What are signs and symptoms of TB?",
      options: [
        "Rash and fever only",
        "Coughing, chest pain, sweating, weight loss, night sweats, and fever",
        "Headache and nausea",
    ...
    {
      id: 15139,
      question: "What type of control is considered most effective in reducing workplace injury risk?",
      options: [
    ...
    {
      id: 15140,
      question: "What are examples of engineering controls?",
      options: [
        "Training programs",
        "Written policies",
        "Devices with retractable needles, shielding mechanisms, and sharps disposal containers",
    ...
    {
      id: 15141,
      question: "When should engineering controls be used?",
      options: [
        "Only when required by law",
        "When reasonable to believe they will reduce exposure potential",
        "Only in surgical settings",
    ...
    {
      id: 15142,
      question: "What are work practice controls?",
      options: [
        "Devices that reduce hazards",
        "Administrative policies",
        "Precautionary measures that alter how a task is performed",
    ...
    {
      id: 15143,
      question: "What is an example of a work practice control?",
      options: [
        "An autoclave",
        "A sharps container",
        "Using a stabilized sponge instead of gauze wrapped around a finger",
        "A face shield"
      ],
      correct: "C"
    },
    {
      id: 15144,
      question: "What is the one-handed scoop technique used for?",
      options: [
        "Removing sutures",
        "Recapping used anesthetic needles",
    ...
    {
      id: 15145,
      question: "What percentage of exposures in dental settings are associated with needles or sharps?",
      options: [
        "50%",
        "70%",
        "More than 90%",
    ...
    {
      id: 15146,
      question: "Where do most transmissions in dental settings occur?",
      options: [
        "In the mouth",
        "Outside the mouth on hands and fingers",
        "In the operatory air",
    ...
    },
    {
      ...
      options: [
        "Equipment that prevents hazards",
        "Techniques for performing procedures",
        "Actions taken to reduce or eliminate a hazard",
    ...
    {
      id: 15148,
      question: "What does appropriate PPE protect?",
      options: [
        "Only the hands",
        "Only the face",
        "Skin, clothing, eyes, mouth, and other mucous membranes",
        "Only against bloodborne pathogens"
      ],
      correct: "C"
    },
    {
      id: 15149,
      question: "On what should PPE selection be based?",
      options: [
        "Cost considerations",
        "The nature of the procedure and anticipated exposure risks",
        "Patient preference",
        "Time of day"
      ],
      correct: "B"
    },
    {
      ...
      options: [
        ...
        "No, infection-control precautions should be the same for each patient",
    ...
    {
      id: 15151,
      question: "What is appropriate eye protection?",
      options: [
        "Reading glasses only",
        "Goggles, glasses with solid side shields, or face shield",
        "Sunglasses",
        "Contact lenses"
      ],
      correct: "B"
    ...
    {
      id: 15152,
      question: "Must prescription eyewear meet standards for protective eyewear?",
      options: [
        "No, prescription glasses are always adequate",
        "Yes, or goggles/face shields should be worn over them",
        "Only for surgical procedures",
    ...
    {
      id: 15153,
      question: "What additional eye protection is required for laser use?",
      options: [
        "None if wearing regular protective eyewear",
        "Laser-specific goggles with labeled wavelengths and optical density",
        "Darker tinted glasses",
        "Double layers of regular protective eyewear"
      ],
      correct: "B"
    },
    {
      id: 15154,
      question: "What does a surgical mask protect?",
      options: [
        "Only the nose",
        "Only the mouth",
        "The mucous membranes of the nose and mouth from spatter",
        "Against all airborne pathogens"
      ],
      correct: "C"
    },
    {
      id: 15155,
      question: "How are surgical face masks classified?",
      options: [
        "By size only",
        "By color",
        "By performance classes based on fluid resistance and filtration efficiency",
    ...
    {
      id: 15156,
      question: "What are the ASTM rating designations for surgical masks?",
      options: [
        "Types A, B, and C",
        "Classes 1, 2, and 3",
        "Levels 1, 2, and 3",
    ...
    {
      id: 15157,
      question: "Which level mask has the lowest barrier performance?",
      options: [
        "Level 3",
        "Level 2",
        "Level 1",
    ...
    {
      id: 15158,
      question: "When should a level 2 or 3 mask be considered?",
      options: [
        "For all procedures",
        "For procedures likely to produce splatter, excess moisture, or higher velocity",
        "Only for surgical procedures",
        "Never, level 1 is always adequate"
      ],
      correct: "B"
    },
    {
      id: 15159,
      question: "What provides greater protection for the respiratory system than a face mask?",
      options: [
        "Double masking",
        "A face shield",
        "A respirator",
    ...
    {
      id: 15160,
      question: "What type of respirator is commonly recommended for aerosol-generating procedures?",
      options: [
        "N50",
        "N75",
        "N95",
    ...
    {
      id: 15161,
      question: "What must a respiratory protection program include?",
      options: [
        "Only providing respirators",
        "Fit testing, medical evaluation, education, and training",
        "Only annual training",
        "Only medical evaluation"
      ],
      correct: "B"
    },
    {
      id: 15162,
      question: "What should protective clothing cover?",
      options: [
        "Only the torso",
        "Only the arms",
        "Personal clothing and skin including forearms",
        "Only the hands"
      ],
      correct: "C"
    },
    {
      id: 15163,
      question: "When should protective clothing be removed?",
      options: [
    ...
    {
      id: 15164,
      question: "Are scrubs alone considered protective attire?",
      options: [
        "Yes, always",
        "Yes, if they are clean",
        "No, they should be worn with a long-sleeved gown or lab coat",
        "Only in surgical settings"
      ],
      correct: "C"
    },
    {
      id: 15165,
      question: "Who must arrange for laundering reusable protective attire?",
      options: [
        "The employee",
        "The employer",
    ...
    {
      id: 15166,
      question: "What are the three categories of gloves used in dental procedures?",
      options: [
    ...
    {
      id: 15167,
      question: "When should medical gloves be worn?",
      options: [
        "Only during surgical procedures",
        "At all times in the dental office",
        "When potential exists for contacting blood, saliva, OPIM, or mucous membranes",
        "Only when treating known infected patients"
      ],
      correct: "C"
    },
    {
      id: 15168,
      question: "Should gloves be worn for each patient?",
      options: [
        "No, they can be reused if not visibly soiled",
        "Yes, a new pair for each patient",
        "Only if the patient requests",
        "Only for bloody procedures"
      ],
      correct: "B"
    },
    {
      id: 15169,
      question: "What should be done if gloves are torn, cut, or punctured?",
      options: [
        "Continue wearing them",
        "Cover with tape",
        "Remove them, wash hands, and reglove",
        "Wear double gloves next time"
      ],
      correct: "C"
    },
    {
      id: 15170,
      question: "What might cause dermatitis or allergic reactions from glove use?",
      options: [
        "Washing hands too frequently",
        "Contact with chemicals used in glove manufacture or latex proteins",
        "Applying lotion before donning gloves",
    ...
    {
      id: 15171,
      question: "What should HCP experiencing dermal problems from gloves do?",
      options: [
        "Continue using the same gloves",
        "Apply more lotion",
    ...
    {
      id: 15172,
      question: "What is the most important behavior in disease transmission prevention?",
      options: [
        "Wearing gloves",
        "Hand hygiene",
        "Wearing masks",
    ...
    {
      id: 15173,
      question: "On what does the preferred hand hygiene method depend?",
      options: [
        "Time of day",
        "Type of procedure, degree of contamination, and desired antimicrobial persistence",
        "Personal preference",
        "Water temperature"
      ],
      correct: "B"
    ...
    {
      id: 15174,
      question: "For routine dental procedures, how can hands be washed?",
      options: [
        "Only with antimicrobial soap",
        "With plain or antimicrobial soap and water, or alcohol-based hand rub if not visibly soiled",
        "Only with alcohol-based hand rub",
        "Only with water"
      ],
      correct: "B"
    },
    {
      id: 15175,
      question: "What type of hand hygiene is required for surgical procedures?",
      options: [
        "Routine handwashing",
    ...
    {
      id: 15177,
      question: "Why should healthcare personnel keep fingernails short?",
      options: [
        "For appearance",
    ...
    {
      id: 15178,
      question: "Should healthcare personnel wear artificial fingernails when having direct patient contact?",
      options: [
        "Yes, if they are clean",
        "Yes, if they are short",
        "No, they should not wear artificial nails",
        "Only gel nails are acceptable"
      ],
      correct: "C"
    },
    {
      id: 15179,
      question: "What is Principle 3 of IPC?",
      options: [
        "Take action to stay healthy",
        "Avoid contact with blood",
    ...
    {
      id: 15180,
      question: "What are patient care items classified as if they penetrate soft tissue or bone?",
      options: [
        "Semicritical",
        "Noncritical",
        "Critical",
    ...
    {
      id: 15181,
      question: "How must critical instruments be managed between patients?",
      options: [
        "Wiped with disinfectant",
        "Heat sterilized or discarded if disposable",
        "Soaked in alcohol",
        "Rinsed with water"
      ],
      correct: "B"
    ...
    {
      id: 15182,
      question: "What are examples of critical instruments?",
      options: [
        "Blood pressure cuffs",
        "Mouth mirrors",
        "Periodontal probes, explorers, scalers, and ultrasonic scaler tips",
        "X-ray cones"
      ],
      correct: "C"
    },
    {
      id: 15183,
      question: "What are semicritical instruments?",
      options: [
        "Instruments that penetrate soft tissue",
        "Instruments that do not penetrate tissue but contact oral fluids",
        "Instruments that only contact intact skin",
        "Instruments that are never contaminated"
      ],
      correct: "B"
    },
    {
      id: 15184,
      question: "How should semicritical instruments be managed?",
      options: [
        "Low-level disinfection",
        "Heat sterilized or high-level disinfection if heat sterilization not possible",
        "Wiped clean only",
        "Rinsed with water"
      ],
      correct: "B"
    ...
    {
      id: 15185,
      question: "What are examples of semicritical instruments?",
      options: [
        "X-ray heads",
        "Light handles",
        "Mouth mirrors, ultrasonic handpieces, impression trays",
    ...
    {
      id: 15186,
      question: "What are noncritical instruments?",
      options: [
        "Instruments that penetrate tissue",
    ...
    {
      id: 15187,
      question: "How should noncritical items be managed?",
      options: [
        "Heat sterilization",
        "High-level disinfection",
        "Surface barriers or low- to intermediate-level disinfection",
        "No cleaning needed"
      ],
      correct: "C"
    },
    ...
    {
      id: 15189,
      question: "What provides the highest level of assurance that no pathogenic organisms remain?",
      options: [
        "Disinfection only",
        "Properly performed cleaning and sterilization",
        "Wiping with alcohol",
        "Air drying"
      ],
      correct: "B"
    ...
    {
      id: 15190,
      question: "How should sterilization areas be arranged?",
      options: [
        "In a random pattern",
        "To encourage a one-directional workflow",
        "For maximum storage",
    ...
    {
      id: 15191,
      question: "In what type of container should used instruments be transported?",
      options: [
        "Open tray",
        "Plastic bag",
        "Container solid on sides and bottom labeled with biohazard symbol",
        "Paper bag"
      ],
      correct: "C"
    },
    {
      id: 15192,
      question: "What PPE should be worn throughout instrument processing?",
      options: [
        "Gloves only",
        "Mask only",
        "Heavy-duty gloves, face protection, and gown or lab coat",
        "Shoe covers only"
      ],
      correct: "C"
    },
    {
      id: 15193,
      question: "What is the most effective means of cleaning instruments before sterilization?",
      options: [
        "Hand scrubbing",
        "Automated devices like ultrasonic cleaners or instrument washers",
        "Soaking in water",
        "Wiping with gauze"
      ],
      correct: "B"
    ...
    {
      id: 15194,
      question: "What should be used for heavily soiled instruments?",
      options: [
        "Extra hot water",
        "A product containing enzyme for presoak or prespray",
        "Bleach solution",
        "Alcohol"
      ],
      correct: "B"
    ...
    {
      id: 15195,
      question: "After cleaning, what should be done with instruments?",
      options: [
        "Air dried and stored",
        "Inspected for debris, placed in sterilization pouches or wrapped trays",
        "Used immediately",
        "Soaked in water"
      ],
      correct: "B"
    ...
    {
      id: 15196,
      question: "How should instrument packs be placed in the sterilizer?",
      options: [
        "Stacked tightly",
        "In single layer or loosely on sides",
    ...
    {
      id: 15197,
      question: "Where should sterilized instrument packs be stored?",
      options: [
        "In a humid area",
        "Near the sink",
        "In a dry area away from contamination",
        "In the operatory"
      ],
      correct: "C"
    },
    {
      id: 15198,
      question: "What is the most common method of heat sterilization in dental offices?",
      options: [
        "Dry heat",
        "Chemical vapor",
        "Steam autoclave",
    ...
    {
      id: 15199,
      question: "What does a steam autoclave use to sterilize?",
      options: [
        "Dry heat only",
        "Steam in a pressurized chamber",
        "Chemical vapors",
        "Ultraviolet light"
      ],
      correct: "B"
    ...
    {
      id: 15200,
      question: "What are the two methods of air evacuation in autoclaves?",
      options: [
        "Fast and slow",
    ...
    {
      id: 15201,
      question: "What is more efficient at air removal?",
      options: [
    ...
    {
      id: 15202,
      question: "What test should be conducted with dynamic air removal sterilizers?",
      options: [
        "Spore test only",
        "Chemical indicator only",
        "Air removal test such as Bowie-Dick test",
        "Temperature test only"
      ],
      correct: "C"
    },
    {
      id: 15203,
      question: "When should the Bowie-Dick test be performed?",
      options: [
        "Weekly",
        "Monthly",
    ...
    {
      id: 15204,
      question: "What might result from incomplete air removal?",
      options: [
        "Faster sterilization",
        "Incomplete sterilization of contents",
        "Equipment damage",
    ...
    {
      id: 15205,
      question: "What does an unsaturated chemical vapor sterilizer use?",
      options: [
        "Steam",
        "Dry heat",
        "Chemical vapor in a pressurized chamber",
        "Moist heat"
      ],
      correct: "C"
    },
    {
      id: 15206,
      question: "What advantage does chemical vapor sterilization offer?",
      options: [
        "Faster cycles",
        "Lower temperature",
        "Reduced humidity reducing rust and corrosion",
    ...
    {
      id: 15207,
      question: "What is a disadvantage of dry-heat sterilization?",
      options: [
        "It is too slow",
        "High temperatures may damage heat-sensitive items",
        "It requires water",
        "It is not effective"
      ],
      correct: "B"
    ...
    {
      id: 15208,
      question: "Why does the CDC discourage use of chemical disinfectants for sterilization?",
      options: [
        "They are not effective",
        "They are too expensive",
        "Toxic properties and less reliability than heat sterilization",
        "They take too long"
      ],
      correct: "C"
    },
    {
      id: 15209,
      question: "What do chemical indicators show?",
      options: [
        "Complete sterilization",
        "Presence of necessary parameters like heat or steam",
    ...
    {
      id: 15210,
      question: "How many types of chemical indicators exist?",
      options: [
        "Two",
        "Four",
        "Six",
    ...
    {
      id: 15211,
      question: "Where should chemical indicators be used?",
      options: [
        "Only outside packages",
        "Inside every packet of instruments",
        "Only for surgical instruments",
    ...
    {
      id: 15212,
      question: "What is the highest level of sterility assurance?",
      options: [
        "Chemical indicators",
    ...
    {
      id: 15213,
      question: "What do biologic indicators use?",
      options: [
        "Chemical strips",
        "Nonpathogenic spores resistant to sterilization",
        "Temperature sensors",
        "pH indicators"
      ],
      correct: "B"
    ...
    {
      id: 15214,
      question: "What organism is used for testing steam and chemical vapor sterilization?",
      options: [
        "Bacillus pumilus",
    ...
    {
      id: 15215,
      question: "What organism is most resistant to dry heat sterilization?",
      options: [
        "Geobacillus stearothermophilus",
        "Bacillus pumilus",
    ...
    {
      id: 15216,
      question: "How often should spore testing be performed?",
      options: [
        "Daily",
        "At least weekly and with each implantable device",
        "Monthly",
        "Annually"
      ],
      correct: "B"
    ...
    {
      id: 15217,
      question: "Should records of spore testing be maintained?",
      options: [
        "No, they are not necessary",
        "Yes, and many states require this",
    ...
    {
      id: 15218,
      question: "What is the EPA standard for heterotrophic bacteria in drinking water?",
      options: [
        "≤100 CFU/mL",
        "≤200 CFU/mL",
        "≤500 CFU/mL",
    ...
    {
      id: 15219,
      question: "What standard should dental unit output water meet for nonsurgical procedures?",
      options: [
        "Sterile water standards",
        "Distilled water standards",
        "Drinking water standards (≤500 CFU/mL)",
    ...
    {
      id: 15220,
      question: "Do independent water reservoirs alone prevent biofilm development?",
      options: [
        "Yes, completely",
        "No, they must be combined with other approaches",
        "Only if using distilled water",
        "Only if changed daily"
      ],
      correct: "B"
    },
    {
      id: 15221,
      question: "What should independent water reservoirs be combined with?",
      options: [
        "Nothing else needed",
        "Periodic or continuous chemical treatments, filters, or centralized treatment",
        "Frequent replacement only",
        "Boiling the water"
      ],
      correct: "B"
    },
    {
      id: 15222,
      question: "What are two types of dental water treatment systems?",
      options: [
        "Hot and cold",
        "Treatment cartridges that disinfect and filter devices that remove particles",
    ...
    {
      id: 15223,
      question: "Where are filter devices installed?",
      options: [
        "In the water reservoir",
        "At the water source",
        "Between dental unit water line and dental instrument",
        "In the sterilizer"
      ],
      correct: "C"
    },
    {
      id: 15224,
      question: "Must filter devices be replaced?",
      options: [
        "No, they last indefinitely",
        "Yes, periodically according to manufacturer instructions",
        "Only if clogged",
        "Only annually"
      ],
      correct: "B"
    ...
    {
      id: 15225,
      question: "Who regulates continuous chemical treatment products for dental water lines?",
      options: [
        "EPA",
        "OSHA",
        "FDA",
    ...
    {
      id: 15226,
      question: "Who registers intermittent chemical treatment products for dental water lines?",
      options: [
        "FDA",
        "CDC",
        "EPA",
    ...
    {
      id: 15227,
      question: "What quality water should be used during surgical procedures?",
      options: [
        "Tap water",
        "Only sterile solutions as coolants/irrigants",
        "Distilled water",
        "Bottled water"
      ],
      correct: "B"
    ...
    {
      id: 15228,
      question: "How is an oral surgical procedure defined?",
      options: [
        "Any procedure in the mouth",
        "Incision, excision, or reflection of tissue exposing normally sterile areas",
        "Routine cleaning",
        "X-ray procedures"
      ],
      correct: "B"
    ...
    {
      id: 15229,
      question: "What is Principle 4 of IPC?",
      options: [
        "Take action to stay healthy",
        "Make patient care items safe",
    ...
    {
      id: 15230,
      question: "What are examples of measures to limit spread of contamination?",
      options: [
        "Gloves only",
        "Protective barriers, high-volume evacuation, cleaning, disinfection, waste management",
        "Masks only",
        "Hand hygiene only"
      ],
      correct: "B"
    ...
    {
      id: 15231,
      question: "What are housekeeping surfaces?",
      options: [
        "Clinical contact surfaces",
        "Surfaces like floors, walls, and sinks with less transmission risk",
        "Surfaces that must be sterilized",
    ...
    {
      id: 15232,
      question: "How should housekeeping surfaces be cleaned?",
      options: [
        "High-level disinfection",
        "Sterilization",
        "Soap and water; disinfected if visibly contaminated with blood or OPIM",
        "Alcohol only"
      ],
      correct: "C"
    },
    {
      id: 15233,
      question: "What are clinical contact surfaces?",
      options: [
        "Floors and walls",
        "Surfaces contaminated from spray/droplets or touched with gloved hands",
        "Surfaces outside the operatory",
        "Surfaces in waiting room"
      ],
      correct: "B"
    },
    {
      id: 15234,
      question: "How should clinical contact surfaces be managed?",
      options: [
        "Left as is",
        "Cleaned and disinfected or barrier-protected",
        "Wiped with water",
        "Vacuumed only"
      ],
      correct: "B"
    ...
    {
      id: 15235,
      question: "What are examples of clinical contact surfaces?",
      options: [
        "Floors and ceilings",
        "Dental chair touch areas, dental unit, light handles, countertops",
    ...
    {
      id: 15236,
      question: "Should barriers be changed between patients?",
      options: [
        "No, once per day is sufficient",
        "Only if visibly soiled",
        "Yes, always change barriers between patients",
        "Only once per week"
      ],
      correct: "C"
    },
    {
      id: 15237,
      question: "What level of disinfectant should be used for surfaces without barriers?",
      options: [
        "High-level disinfectant",
        "Sterilization",
        "EPA-registered hospital disinfectant (low or intermediate level)",
        "Soap and water only"
      ],
      correct: "C"
    },
    {
      id: 15238,
      question: "When should intermediate-level disinfectant be used?",
      options: [
        "For all surfaces",
        "For surfaces with visible blood or OPIM",
        "Never",
        "Only in surgical suites"
      ],
      correct: "B"
    },
    {
      id: 15239,
      question: "What PPE should be worn during environmental cleaning?",
      options: [
        "Gloves only",
        "Mask only",
        "Gloves and other PPE to prevent exposure",
        "No PPE needed"
      ],
      correct: "C"
    },
    {
      id: 15240,
      question: "What type of gloves offer more protection when using chemical disinfectants?",
      options: [
    ...
    {
      id: 15241,
      question: "What is an occupational exposure?",
      options: [
        "Any time at work",
        "Percutaneous injury or mucous membrane contact with potentially infectious materials",
        "Being near a patient",
    ...
    {
      id: 15242,
      question: "Are all exposures of equal risk?",
      options: [
        "Yes, all are the same",
        "No, risk varies with amount of blood, viral titer, depth of injury, type of exposure, and immune status",
        "Yes, if same pathogen involved",
        "No, only needlesticks are risky"
      ],
      correct: "B"
    },
    {
      id: 15243,
      question: "What is the goal when an exposure occurs?",
      options: [
        "To document it thoroughly",
        "To contain the injury as soon as possible to reduce transmission risk",
    ...
    {
      id: 15244,
      question: "Who should provide postexposure management?",
      options: [
        "Any physician",
        "The office manager",
        "A qualified healthcare provider trained in infectious diseases",
        "The dentist"
      ],
      correct: "C"
    },
    {
      id: 15245,
      question: "What is Step 1 of postexposure management?",
      options: [
        "Report the incident",
        "Apply immediate first aid - wash or flush the area",
        "Contact the patient",
        "Complete paperwork"
      ],
      correct: "B"
    ...
    {
      id: 15246,
      question: "Should the wound be \"milked\" to encourage bleeding?",
      options: [
        "Yes, to remove contaminants",
        "No, this would further irritate the area",
        "Only for deep wounds",
        "Only for needlesticks"
      ],
      correct: "B"
    },
    {
      id: 15247,
      question: "Should caustic agents like bleach be used on exposure wounds?",
      options: [
        "Yes, to kill viruses",
        "No, they further irritate the area",
        "Only diluted bleach",
        "Only for HBV exposure"
      ],
      correct: "B"
    },
    {
      id: 15248,
      question: "What is Step 2 of postexposure management?",
      options: [
        "Seek medical care",
    ...
    {
      id: 15249,
      question: "Should reporting delay treatment?",
      options: [
    ...
    {
      id: 15250,
      question: "When should postexposure management begin?",
      options: [
        "Within 24 hours",
    ...
    {
      id: 15251,
      question: "How effective can prompt postexposure management be in reducing HIV infection risk?",
      options: [
        "50% reduction",
        "60% reduction",
    ...
    {
      id: 15252,
      question: "What might postexposure prophylaxis for HIV involve?",
      options: [
        "One antiretroviral drug",
        "Antibiotics",
        "A 4-week regimen of 2 or more antiretroviral drugs",
    ...
    {
      id: 15253,
      question: "What is the average risk of HBV infection after exposure in unvaccinated persons?",
      options: [
        "1% to 5%",
        "6% to 30%",
        "50% to 60%",
    ...
    {
      id: 15254,
      question: "What is the best protection against HBV?",
      options: [
    ...
    {
      id: 15255,
      question: "What is the average risk of HCV infection after percutaneous exposure?",
      options: [
        "Less than 1%",
        "About 1.8%",
        "About 5%",
    ...
    {
      id: 15256,
      question: "Is there a vaccine for HCV?",
      options: [
        "Yes, three doses",
        "Yes, one dose",
        "No",
    ...
    {
      id: 15257,
      question: "What is the average risk of HIV infection after percutaneous exposure?",
      options: [
        "1% to 2%",
        "About 0.3%",
        "5% to 10%",
    ...
    {
      id: 15258,
      question: "Is it ethical to refuse treatment to a patient because they have an infectious disease?",
      options: [
        "Yes, for provider safety",
        "Yes, if the patient is high risk",
    ...
    {
      id: 15259,
      question: "Should patients be referred elsewhere based on infectious disease status?",
      options: [
        "Yes, always",
        "Yes, if convenient",
        "No, understanding risk and prevention is appropriate",
        "Only for HIV"
      ],
      correct: "C"
    },
    {
      id: 15260,
      question: "Who should be the designated infection prevention coordinator?",
      options: [
        "The newest employee",
        "Any volunteer",
        "Designated personnel to facilitate effective IPC implementation",
    ...
    {
      id: 15261,
      question: "What should the infection prevention coordinator ensure?",
      options: [
        "Only that supplies are ordered",
        "Equipment and supplies are available and maintain communication with staff",
        "Only that training is documented",
        "Only OSHA compliance"
      ],
      correct: "B"
    },
    {
      id: 15262,
      question: "What does OSAP stand for?",
      options: [
        "Occupational Safety Assurance Program",
        "Organization for Safety, Asepsis and Prevention",
        "Office Standards and Protocols",
        "Oral Safety Assessment Procedures"
      ],
      correct: "B"
    },
    {
      id: 15263,
      question: "What demonstrates a culture of safety?",
      options: [
        "Written policies only",
        "Expensive equipment",
        "Commitment to IPC by all personnel demonstrated in daily practices",
    ...
    {
      id: 15264,
      question: "How can patients be part of the safety culture?",
      options: [
        "By observing only",
        "By making informed decisions, having IPC explained, and asking questions",
        "By bringing their own PPE",
        "By reviewing OSHA regulations"
      ],
      correct: "B"
    }
  ],
  "2. Medical Emergencies in Dentistry": [
    ...
    },
    {
      ...
      options: [
        ...
        "To manually preserve brain function until further medical care is available",
    ...
    },
    {
      ...
      options: [
        ...
        "Automatic Electrical Detector"
      ],
      correct: "C"
    },
    {
      id: 15204,
      question: "Which organizations provide BLS/CPR guidelines?",
      options: [
        "FDA and EPA",
        "American Heart Association and International Liaison Committee on Resuscitation",
        "OSHA and CDC",
        "WHO and NIH"
      ],
      correct: "B"
    },
    {
      ...
      options: [
        ...
        "Recognition that a medical emergency is occurring",
        "Recovery"
      ],
      correct: "C"
    },
    {
      id: 15206,
      question: "How many links are in the chain of survival?",
      options: [
        "Three",
        "Four",
        "Five",
    ...
    {
      id: 15207,
      question: "What factors increase the likelihood of medical emergencies in dental settings?",
      options: [
        "Only increased number of medically compromised patients",
        "Only medical advances in drug therapy",
        "Increased medically compromised patients, drug advances, invasive procedures, and drug use in dental settings",
        "Only longer appointments"
      ],
      correct: "C"
    },
    {
      id: 15208,
      question: "What begins the prevention of medical emergencies?",
      options: [
        "Having emergency equipment only",
    ...
    {
      id: 15209,
      question: "What should be included in prevention strategies?",
      options: [
        "Only vital sign monitoring",
        "Only medication review",
        "Health history, vital signs, anxiety management, treatment modifications, and stress reduction",
        "Only emergency equipment availability"
      ],
      correct: "C"
    },
    {
      id: 15210,
      question: "How often should protocols for managing medical emergencies be reviewed?",
      options: [
        "Monthly",
        "Quarterly",
    ...
    {
      id: 15211,
      question: "What type of training is recommended annually for dental personnel?",
      options: [
        "Only CPR certification",
        "Advanced cardiac life support",
        "Refresher course in medical emergency management",
        "Pharmacy training"
      ],
      correct: "C"
    },
    {
      id: 15212,
      question: "What should practice emergency simulations prepare dental personnel for?",
      options: [
        "Only using the AED",
        "Implementation of protocols and use of emergency equipment",
        "Only calling 911",
        "Only taking vital signs"
      ],
      correct: "B"
    },
    {
      id: 15213,
      question: "What color are portable oxygen tanks in the United States?",
      options: [
        "White",
        "Blue",
        "Green",
    ...
    {
      id: 15214,
      question: "What size oxygen cylinder do most dental settings use?",
      options: [
        "Size C",
        "Size D",
        "Size E",
    ...
    {
      id: 15215,
      question: "How is oxygen delivery measured?",
      options: [
    ...
    {
      id: 15216,
      question: "Approximately how many minutes of oxygen will a size E cylinder supply?",
      options: [
        "15 minutes",
        "20 minutes",
        "30 minutes",
    ...
    {
      id: 15217,
      question: "What should be determined with a pulse oximeter before administering oxygen?",
      options: [
        "Heart rate",
        "Blood pressure",
        "Oxygen saturation",
    ...
    {
      id: 15218,
      question: "What does SpO2 stand for?",
      options: [
        "Special oxygen level 2",
        "Peripheral capillary oxygen saturation",
        "Systemic pressure of oxygen",
        "Standard pulse oxygen 2"
      ],
      correct: "B"
    },
    {
      id: 15219,
      question: "If a patient appears stable with an SpO2 of 90% to 94%, what may be true?",
      options: [
        "They definitely need oxygen",
        "They are in critical condition",
        "They may not require further oxygen supplementation",
        "They should be given maximum oxygen"
      ],
      correct: "C"
    },
    {
      id: 15220,
      question: "What is the target SpO2 for a patient who is acutely ill or having difficulty breathing?",
      options: [
        "85% to 90%",
        "90% to 94%",
        "94% to 98%",
    ...
    {
      id: 15221,
      question: "What are the three ways oxygen can be delivered?",
      options: [
        "IV line, injection, or orally",
        "Nasal cannula, simple face mask, or nonrebreather mask",
        "Through skin patches only",
    ...
    {
      id: 15222,
      question: "What is the initial oxygen flow rate when using a nasal cannula?",
      options: [
        "1 L/min",
        "2 L/min",
        "4 L/min",
    ...
    {
      id: 15223,
      question: "What is the maximum oxygen flow rate via nasal cannula?",
      options: [
        "2 L/min",
        "4 L/min",
        "6 L/min",
    ...
    {
      id: 15224,
      question: "At a minimum, what should an emergency kit include?",
      options: [
        "Only epinephrine",
        "Only oxygen",
        "Epinephrine, histamine blocker, nitroglycerin, bronchodilator, oxygen, pulse oximeter, aspirin, and oral glucose",
        "Only nitroglycerin and aspirin"
      ],
      correct: "C"
    },
    {
      id: 15225,
      question: "What should the emergency kit contain regarding drug administration?",
      options: [
        "All available emergency drugs",
        "Only drugs the dentist or hygienist is trained to administer",
        "Only injectable medications",
        "Any drugs requested by patients"
      ],
      correct: "B"
    },
    {
      id: 15226,
      question: "What drug can reverse an opioid overdose?",
      options: [
        "Flumazenil",
        "Epinephrine",
        "Naloxone",
    ...
    {
      id: 15227,
      question: "What drug reverses the effects of benzodiazepines?",
      options: [
        "Naloxone",
        "Flumazenil",
        "Diphenhydramine",
    ...
    {
      id: 15228,
      question: "Why is the use of ammonia inhalants for unconscious patients no longer recommended?",
      options: [
        "They are too expensive",
        "They may be harmful and produce complications",
        "They are not effective for any condition",
    ...
    {
      id: 15229,
      question: "What may ammonia inhalants cause in patients with impaired gag reflex?",
      options: [
        "Improved breathing",
        "Faster recovery",
        "Aspiration from coughing, nausea, and vomiting",
    ...
    {
      id: 15230,
      question: "What additional items might be included in an emergency kit?",
      options: [
        "Only gauze",
        "Pocket mask, syringes, sugar packets, blanket, thermometer, emesis basin, and Magill forceps",
        "Only bandages",
        "Only scissors"
      ],
      correct: "B"
    ...
    {
      id: 15231,
      question: "How often should the dental emergency kit be monitored and updated?",
      options: [
        "Annually",
        "Monthly",
        "At least quarterly and after every emergency",
    ...
    {
      id: 15232,
      question: "Who should be designated to monitor emergency kit contents?",
      options: [
        "Any staff member when they have time",
        "The receptionist only",
        "An individual in the dental setting",
        "An outside vendor"
      ],
      correct: "C"
    },
    {
      id: 15233,
      question: "What should dental hygienists have in their treatment area?",
      options: [
        "Only gloves",
        "Their own resuscitation masks",
        "Only gauze",
        "Only suction equipment"
      ],
      correct: "B"
    },
    {
      id: 15234,
      question: "What forms should be available to record emergency information?",
      options: [
        "Only consent forms",
        "Emergency medical report forms",
        "Only insurance forms",
        "Only health history forms"
      ],
      correct: "B"
    },
    {
      id: 15235,
      question: "What information should emergency medical report forms record?",
      options: [
        "Only patient name",
        "Time of onset, treatment or drugs administered, and vital signs",
        "Only vital signs",
        "Only time of onset"
      ],
      correct: "B"
    ...
    {
      id: 15236,
      question: "What should be done with a copy of the emergency report?",
      options: [
        "Destroyed after 24 hours",
        "Only kept in office files",
        "Given to EMS personnel and accompany patient to emergency department",
        "Sent to insurance company only"
      ],
      correct: "C"
    },
    {
      id: 15237,
      question: "What should be readily available if an emergency arises?",
      options: [
        "Only phone numbers",
        "Emergency assistance numbers, emergency drug kit, oxygen, and AED",
    ...
    {
      id: 15238,
      question: "What telephone numbers should be visibly posted?",
      options: [
        "Only 911",
        "Staff home numbers",
        "Local police, fire, poison control center, and facility address with room number",
        "Only poison control"
      ],
      correct: "C"
    },
    {
      id: 15239,
      question: "How often should posted emergency numbers be updated?",
      options: [
        "Monthly",
        "Quarterly",
        "Annually",
    ...
    {
      id: 15240,
      question: "What should every dental setting have regarding medical emergencies?",
      options: [
        "Only emergency equipment",
        "A medical emergency plan",
        "Only trained staff",
        "Only emergency phone numbers"
      ],
      correct: "B"
    },
    {
      id: 15241,
      question: "What should each oral care team member have in an emergency?",
      options: [
        "Their own equipment",
    ...
    {
      id: 15242,
      question: "How should roles in an emergency be maintained?",
      options: [
        "Never reviewed",
        "Periodically reviewed and practiced",
        "Only written down",
        "Only discussed once"
      ],
      correct: "B"
    ...
    {
      id: 15243,
      question: "What should be provided to all new employees regarding emergencies?",
      options: [
        "Only a tour",
        "Protocols for managing a medical emergency",
        "Only phone numbers",
        "Only equipment location"
      ],
      correct: "B"
    },
    {
    ...
    {
      id: 15245,
      question: "How many ASA categories are there?",
      options: [
        "Three",
        "Four",
        "Five",
    ...
    {
      id: 15246,
      question: "What does ASA I represent?",
      options: [
        "Severe systemic disease",
        "Normal health - \"green light\" for elective dental treatment",
    ...
    {
      id: 15247,
      question: "What do ASA II or III represent?",
      options: [
        "Red light",
        "Green light",
        "Yellow light requiring caution",
    ...
    {
      id: 15248,
      question: "Which ASA categories will dental hygienists commonly see?",
      options: [
        "Only ASA I",
        "ASA I, II, and III",
        "Only ASA IV and V",
    ...
    {
      id: 15249,
      question: "What does ASA IV represent?",
      options: [
        "Normal health",
        "Mild disease",
        "Severe systemic disease constantly threatening life - \"red light\"",
        "Brain dead"
      ],
      correct: "C"
    },
    {
      id: 15250,
      question: "When should ASA IV patients receive dental treatment?",
      options: [
        "Anytime",
        "Only conservative emergency treatments until condition stabilizes",
        "Never",
        "Only in hospitals"
      ],
      correct: "B"
    ...
    {
      id: 15251,
      question: "What does ASA VI indicate?",
      options: [
        "Normal health",
        "Mild disease",
        "Declared brain dead; organs being removed for donor purposes",
        "Severe but stable disease"
      ],
      correct: "C"
    },
    {
      id: 15252,
      question: "Why is monitoring vital signs important?",
      options: [
        "Only for documentation",
        "To assess overall health and compare normal with emergency readings",
        "Only required by law",
    ...
    {
      id: 15253,
      question: "What may vital signs outside normal ranges indicate?",
      options: [
        "Nothing significant",
        "Underlying medical issues",
        "Only measurement error",
        "Only patient anxiety"
      ],
      correct: "B"
    },
    {
      id: 15254,
      question: "When may a physician consultation be needed?",
      options: [
        "Never",
        "To determine if modifications or delay in treatment is necessary",
        "Only for surgical procedures",
    ...
    {
      id: 15255,
      question: "What can heightened anxiety and fear of dental care lead to?",
      options: [
        "Only mild discomfort",
        "Hyperventilation, syncope, or acute exacerbation of conditions",
    ...
    {
      id: 15256,
      question: "What is one goal of patient assessment regarding psychology?",
      options: [
        "To judge the patient",
        "To determine if patient can tolerate stress associated with planned care",
        "To determine payment method",
    ...
    {
      id: 15257,
      question: "How can anxiety be recognized?",
      options: [
        "Only through complex testing",
        "By asking about fear, anxiety, and past traumatic experiences",
        "It cannot be recognized",
        "Only through vital signs"
      ],
      correct: "B"
    },
    {
    ...
    {
      id: 15259,
      question: "What are signs of severely anxious individuals?",
      options: [
        "Calm demeanor",
        "Slow heart rate",
        "Increased blood pressure, trembling, excessive perspiration, and dilated pupils",
        "Normal appearance"
      ],
      correct: "C"
    },
    {
      id: 15260,
      question: "What are stress-reduction protocols?",
      options: [
        "Only medication",
        "Steps taken to reduce dental anxiety and fear",
    ...
    {
      id: 15261,
      question: "When should stress reduction start?",
      options: [
        "Only during the appointment",
        "Only after treatment",
        "Before appointment, continue throughout, and into postoperative period if necessary",
    ...
    {
      id: 15262,
      question: "What general stress reduction strategies are recommended?",
      options: [
        "Only pharmacologic",
        "Building rapport, maintaining communication, minimizing wait time, and short morning appointments",
        "Only longer appointments",
        "Only afternoon appointments"
      ],
      correct: "B"
    },
    {
      id: 15263,
      question: "What pharmacologic stress reduction options may be used?",
      options: [
        "Only pain medications",
        "Only local anesthesia",
        "Preappointment sedation, nitrous oxide, profound local anesthesia, adequate pain control",
        "Only antibiotics"
      ],
      correct: "C"
    },
    {
      id: 15264,
      question: "What management techniques can help dental anxiety?",
      options: [
        "Only medication",
        "Acupuncture, biofeedback, cognitive therapy, distraction, guided imagery, relaxation techniques",
        "Only sedation",
        "Only restraints"
      ],
      correct: "B"
    ...
    {
      id: 15265,
      question: "What does unresponsiveness mean?",
      options: [
        "Patient is sleeping",
        "Patient does not respond to sensory stimulation",
        "Patient is resting",
        "Patient is meditating"
      ],
      correct: "B"
    },
    {
      id: 15266,
      question: "How is unresponsiveness tested?",
      options: [
        "Only checking pulse",
        "Gently shaking and shouting \"Are you all right?\"",
        "Only checking breathing",
        "Waiting to see if patient wakes up"
      ],
      correct: "B"
    },
    {
      id: 15267,
      question: "If a patient is unresponsive, not breathing, or only gasping, what should be done?",
      options: [
        "Wait and observe",
        "Give them water",
        "Immediately activate BLS",
        "Leave them alone"
      ],
      correct: "C"
    },
    ...
    },
    {
      ...
      options: [
        "An emergency number in all countries",
        "The standard emergency number in the United States and Canada",
    ...
    {
      id: 15270,
      question: "What position should an unconscious person be placed in?",
      options: [
        "Sitting upright",
        "On their side",
        "Supine (horizontal)",
    ...
    {
      id: 15272,
      question: "What should be removed from the dental chair headrest when a patient loses consciousness?",
      options: [
        "Nothing",
        "The chair itself",
        "Any extra head supports like pillows",
        "The armrests"
      ],
      correct: "C"
    },
    {
      id: 15273,
      question: "What should be done after placing an unconscious patient in supine position?",
      options: [
        "Wait for them to wake up",
        "Give them water",
        "Begin life support by delivering high-quality CPR",
    ...
    {
      id: 15274,
      question: "What can assisting personnel obtain during an emergency?",
      options: [
        "Coffee",
        "Patient records only",
        "AED, oxygen, bag-valve-mask, aspirin from emergency kit",
        "Only paperwork"
      ],
      correct: "C"
    },
    {
      id: 15275,
      question: "Early defibrillation can restore what?",
      options: [
        "Blood pressure only",
    ...
    {
      id: 15276,
      question: "Each minute of delayed defibrillation reduces survival chance by approximately what percentage?",
      options: [
        "5%",
        "10%",
        "15%",
    ...
    {
      id: 15277,
      question: "What is the final link in the chain of survival?",
      options: [
        "CPR",
        "Defibrillation",
    ...
    {
      id: 15278,
      question: "In all medical emergencies, what should be done first?",
      options: [
        "Give medication",
    ...
    {
      id: 15279,
      question: "If a patient becomes unconscious or unresponsive in any emergency, what should be initiated?",
      options: [
    ...
    {
      id: 15280,
      question: "What is adrenal crisis?",
      options: [
    ...
    {
      id: 15281,
      question: "What are signs of adrenal crisis?",
      options: [
        "High blood pressure and fast pulse",
        "Confusion, weakness, respiratory depression, low blood pressure, weak rapid pulse",
        "High energy",
        "Increased appetite"
      ],
      correct: "B"
    ...
    {
      id: 15282,
      question: "How should a responsive patient with adrenal crisis be positioned?",
      options: [
        "Upright",
        "On their side",
    ...
    {
      id: 15283,
      question: "What should a responsive patient with adrenal crisis be asked to do?",
      options: [
        "Drink water",
        "Self-administer a stress dose of their own corticosteroid medication",
        "Take aspirin",
        "Use their inhaler"
      ],
      correct: "B"
    ...
    {
      id: 15284,
      question: "What indicates partial (mild) airway obstruction?",
      options: [
        "Silent cough",
        "Effective coughing with adequate oxygen exchange",
        "Unable to speak",
        "Complete blockage"
      ],
      correct: "B"
    ...
    {
      id: 15285,
      question: "What should be done for partial airway obstruction if air exchange is adequate?",
      options: [
    ...
    {
      id: 15286,
      question: "What indicates complete (severe) airway obstruction?",
      options: [
        "Effective coughing",
        "Able to speak",
        "Silent cough, unable to speak, cyanosis",
        "Loud wheezing"
      ],
      correct: "C"
    },
    {
      id: 15287,
      question: "What should be done for complete airway obstruction?",
      options: [
        "Give water",
        "Encourage coughing",
        "Begin abdominal thrusts (Heimlich maneuver) until object is dislodged",
        "Wait for EMS"
      ],
      correct: "C"
    },
    {
      id: 15288,
      question: "What should be used instead of abdominal thrusts for pregnant or obese patients with airway obstruction?",
      options: [
        "Back blows",
        "Chest compressions",
        "Finger sweeps",
    ...
    },
    {
      ...
      options: [
        "Lung pain",
        "Chest pain due to inadequate blood and oxygen supply to heart muscle",
        "Stomach pain",
        "Headache"
      ],
      correct: "B"
    ...
    {
      id: 15291,
      question: "What position should a patient with stable angina be placed in?",
      options: [
        "Supine",
        "Comfortable position, usually upright",
        "On their side",
        "Trendelenburg"
      ],
      correct: "B"
    ...
    {
      id: 15292,
      question: "What medication should be administered for angina?",
      options: [
        "Aspirin",
        "Epinephrine",
        "Nitroglycerin 0.4 mg sublingually (preferably self-administered)",
        "Glucagon"
      ],
      correct: "C"
    },
    {
      id: 15293,
      question: "How often can nitroglycerin be given for angina?",
      options: [
        "Every 2 minutes",
        "Every 5 minutes, maximum of three doses",
        "Every 10 minutes",
        "Only once"
      ],
      correct: "B"
    ...
    {
      id: 15294,
      question: "If angina pain is not relieved by nitroglycerin, what should be done?",
      options: [
        "Give more nitroglycerin",
        "Wait longer",
        "Activate EMS and treat as myocardial infarction",
        "Send patient home"
      ],
      correct: "C"
    },
    {
      ...
      options: [
        "High blood pressure",
        "Narrowing of bronchial airways due to bronchospasm, excessive mucus, or inflammation",
        "Low blood sugar",
        "Dehydration"
      ],
      correct: "B"
    ...
    {
      id: 15296,
      question: "What are signs of an asthma attack?",
      options: [
        "High blood pressure",
        "Nonproductive cough, wheezing, increased respiratory efforts, shortness of breath",
        "Fever",
        "Rash"
      ],
      correct: "B"
    ...
    {
      id: 15297,
      question: "What position facilitates breathing for asthma patients?",
      options: [
        "Supine",
    ...
    {
      id: 15298,
      question: "What medication should be administered for an asthma attack?",
      options: [
        "Nitroglycerin",
        "Aspirin",
        "Bronchodilator (preferably self-administered)",
    ...
    {
      id: 15299,
      question: "If an asthma patient becomes unresponsive, what should be administered?",
      options: [
        "Nitroglycerin",
        "Aspirin",
        "Bronchodilator",
        "Epinephrine 0.3 mg of 1:1000"
      ],
      correct: "D"
    },
    {
    ...
    {
      id: 15301,
      question: "What are signs of cardiac arrest?",
      options: [
        "Fast pulse",
        "Absence of pulse, absence of respirations, unconsciousness",
        "High blood pressure",
        "Fever"
      ],
      correct: "B"
    ...
    {
      id: 15302,
      question: "What is the first step in managing cardiac arrest?",
      options: [
        "Give medication",
        "Check blood pressure",
        "Place patient in supine position and activate EMS",
        "Give oxygen only"
      ],
      correct: "C"
    },
    {
      id: 15303,
      question: "What should be initiated immediately for cardiac arrest?",
      options: [
        "Only oxygen",
        "Only medication",
        "BLS",
    ...
    },
    {
      ...
      options: [
        "Heart attack",
        "Seizure",
        "Occlusion or hemorrhage of cerebral blood vessel resulting in ischemia (stroke)",
        "Allergic reaction"
      ],
      correct: "C"
    },
    {
      ...
      options: [
        "Chest pain",
        "Sudden weakness of one side, severe headache, difficulty speaking, vision changes",
        "Abdominal pain",
        "Rash"
      ],
      correct: "B"
    ...
    {
      id: 15306,
      question: "What position should a stroke patient be placed in?",
      options: [
        "Supine",
        "Semisupine",
        "Upright",
    ...
    {
      id: 15307,
      question: "What should be done immediately when a stroke is suspected?",
      options: [
        "Wait and observe",
        "Give aspirin",
        "Activate EMS",
    ...
    {
      id: 15308,
      question: "What should be avoided doing to an injured eye?",
      options: [
        "Looking at it",
        "Touching, rubbing, or applying medicine or pressure",
        "Calling for help",
    ...
    {
      id: 15309,
      question: "For an eye puncture or cut, what should be done?",
      options: [
        "Rinse with water",
        "Remove the object",
        "Activate EMS and place a shield over the eye",
        "Apply pressure"
      ],
      correct: "C"
    },
    {
      id: 15310,
      question: "How should a chemical burn to the eye be treated?",
      options: [
        "Do nothing",
        "Apply ointment",
        "Immediately flush the eye mesially to distally with clean water or saline for 15 minutes, then activate EMS",
        "Cover with bandage"
      ],
      correct: "C"
    },
    {
      id: 15311,
      question: "How should arterial hemorrhage be controlled?",
      options: [
        "Ice only",
        "Elevation only",
        "Apply compression over hemorrhage, usually with gauze",
        "Wait for it to stop"
      ],
      correct: "C"
    },
    ...
    {
      id: 15313,
      question: "For a dental extraction site bleeding, what should be done?",
      options: [
        "Do nothing",
        "Rinse with water",
        "Pack the area with gauze and have patient bite down",
        "Give antibiotics"
      ],
      correct: "C"
    },
    {
      ...
      options: [
        ...
        "Systolic >140 mm Hg",
        "Severe blood pressure elevation with evidence of target organ damage",
        "Diastolic >100 mm Hg"
      ],
      correct: "C"
    },
    {
      id: 15315,
      question: "What blood pressure readings indicate hypertensive crisis?",
      options: [
        "Systolic >140 and/or diastolic >90",
        "Systolic >160 and/or diastolic >100",
        "Systolic >180 and/or diastolic >120",
        "Systolic >200 and/or diastolic >140"
      ],
      correct: "C"
    },
    {
      id: 15316,
      question: "What should be done for hypertensive urgency?",
      options: [
        "Give medication in office",
        "Advise patient to seek advanced medical assessment immediately",
    ...
    {
      id: 15317,
      question: "What causes hyperventilation?",
      options: [
        "Low oxygen",
        "Respiratory alkalosis from excessive loss of carbon dioxide",
        "High carbon dioxide",
        "Infection"
      ],
      correct: "B"
    ...
    {
      id: 15318,
      question: "What are signs of hyperventilation?",
      options: [
        "Slow breathing",
        "Rapid or shallow respirations, lightheadedness, tingling in extremities",
        "Fever",
        "Rash"
      ],
      correct: "B"
    ...
    {
      id: 15319,
      question: "What position should a hyperventilating patient be placed in?",
      options: [
        "Supine",
        "On their side",
        "Upright",
    ...
    {
      id: 15320,
      question: "Should oxygen be administered for hyperventilation?",
      options: [
        "Yes, always",
        "Yes, at maximum flow",
        "No",
    ...
    {
      id: 15321,
      question: "How should a hyperventilating patient breathe?",
      options: [
        "Rapidly",
        "Hold their breath",
        "Slowly and normally, through pursed lips or into cupped hands",
        "Only through nose"
      ],
      correct: "C"
    },
    {
      ...
      options: [
        "Lung collapse",
        "Stroke",
        "Necrosis of myocardium due to total or partial occlusion of an artery (heart attack)",
        "Seizure"
      ],
      correct: "C"
    },
    {
      id: 15323,
      question: "How is myocardial infarction pain different from angina?",
      options: [
        "It is milder",
        "It is usually more severe and not relieved by rest and nitroglycerin",
    ...
    {
      id: 15324,
      question: "What position should a myocardial infarction patient be placed in?",
      options: [
        "Supine",
        "Comfortable position, usually semisupine or upright",
        "Flat on back",
        "On left side"
      ],
      correct: "B"
    ...
    {
      id: 15325,
      question: "What medication should a myocardial infarction patient chew?",
      options: [
        "Nitroglycerin",
        "Diphenhydramine",
        "162 to 325 mg of chewable, nonenteric-coated aspirin",
        "Glucagon"
      ],
      correct: "C"
    },
    {
      id: 15326,
      question: "What causes pulmonary edema (acute)?",
      options: [
        "Dehydration",
        "Impairment of heart muscle from left ventricular failure, resulting in fluid in lungs",
        "Infection",
        "Allergic reaction"
      ],
      correct: "B"
    ...
    {
      id: 15327,
      question: "What are signs of acute pulmonary edema?",
      options: [
        "Rash",
        "Shortness of breath, difficulty breathing, pink frothy sputum, swelling of lower extremities",
        "Fever",
        "Headache"
      ],
      correct: "B"
    ...
    {
      id: 15328,
      question: "What position should a patient with pulmonary edema be placed in?",
      options: [
        "Supine",
        "Upright",
        "On their side",
    ...
    {
      id: 15329,
      question: "How much nitroglycerin should be administered for pulmonary edema?",
      options: [
        "0.4 mg once",
        "0.8 to 1.2 mg (2 to 3 tablets or sprays) every 5 to 10 minutes",
        "2 mg once",
        "No nitroglycerin"
      ],
      correct: "B"
    ...
    {
      id: 15330,
      question: "What is psychogenic shock?",
      options: [
        "Electric shock",
        "Cerebral hypoxia (treated same as syncope)",
        "Anaphylaxis",
        "Hemorrhagic shock"
      ],
      correct: "B"
    },
    {
      ...
      options: [
        "High blood pressure",
        "Hypotension, pale clammy skin, rapid weak pulse, rapid shallow respirations",
        "Fever",
        "Rash"
      ],
      correct: "B"
    ...
    {
      id: 15332,
      question: "How should a patient in shock be positioned?",
      options: [
        "Upright",
        "On their side",
    ...
    {
      id: 15334,
      question: "What are early signs of syncope?",
      options: [
        "High blood pressure",
        "Pallor, nausea, fast pulse (early), perspiration, pupil dilation",
        "Fever",
        "Rash"
      ],
      correct: "B"
    ...
    {
      id: 15335,
      question: "How should a syncopal patient be positioned?",
      options: [
        "Upright",
        "Supine with legs slightly elevated; pregnant patient rolled on left side",
        "On their back flat",
        "Sitting"
      ],
      correct: "B"
    ...
    {
      id: 15336,
      question: "If hypoglycemia is suspected during postsyncopal recovery, what should be administered?",
      options: [
        "Insulin",
        "Epinephrine",
        "Oral glucose",
    ...
    {
      id: 15337,
      question: "What is a generalized tonic-clonic (grand mal) seizure?",
      options: [
        "Brief staring spell",
        "Generalized electronic abnormality in brain with loss of consciousness",
        "Localized muscle twitch",
        "Headache"
      ],
      correct: "B"
    },
    {
      id: 15338,
      question: "What might precede a tonic-clonic seizure?",
      options: [
        "Nothing",
        "Aura (change in taste, smell, or sight)",
        "Fever",
        "Rash"
      ],
      correct: "B"
    ...
    {
      id: 15339,
      question: "What should be done during a tonic-clonic seizure?",
      options: [
        "Restrain the patient",
        "Put something in their mouth",
        "Place patient in supine position, protect from injury, clear area of sharp objects",
        "Give water"
      ],
      correct: "C"
    },
    {
      id: 15340,
      question: "Should you restrain a person having a seizure?",
      options: [
        "Yes, always",
        "Yes, to protect them",
        "No, do not attempt to restrain",
        "Only if violent"
      ],
      correct: "C"
    },
    {
      id: 15341,
      question: "If a seizure is unresolved (status epilepticus), what should be done?",
      options: [
        "Wait longer",
        "Give oral medication",
        "Activate EMS",
        "Continue observing only"
      ],
      correct: "C"
    },
    {
      id: 15342,
      question: "What is a nonconvulsive (petit mal) seizure?",
      options: [
        "Loss of consciousness with convulsions",
        "Generalized electronic abnormality without loss of consciousness",
        "Stroke",
        "Fainting"
      ],
      correct: "B"
    ...
    {
      id: 15343,
      question: "How long does a petit mal seizure typically last?",
      options: [
        "Less than 1 second",
        "Several to 90 seconds",
        "5 minutes",
        "Over 10 minutes"
      ],
      correct: "B"
    ...
    {
      id: 15344,
      question: "What is hyperglycemia (ketoacidosis)?",
      options: [
        "Low blood sugar",
        "Excess glucose and insufficient insulin levels",
        "High insulin",
        "Low cortisol"
      ],
      correct: "B"
    },
    {
      ...
      options: [
        "Hunger, perspiration, confusion",
        "Excessive thirst, urination, hunger, dry flushed skin, fruity breath smell",
        "High blood pressure",
        "Rash"
      ],
      correct: "B"
    ...
    {
      id: 15346,
      question: "For a responsive hyperglycemic patient, what should be retrieved?",
      options: [
        "Their food",
        "Oral glucose",
    ...
    {
      id: 15347,
      question: "Who should administer insulin to a hyperglycemic patient if able?",
      options: [
        "The dental hygienist",
        "The dentist",
        "The patient should self-administer",
        "EMS only"
      ],
      correct: "C"
    },
    {
      ...
      options: [
        "High blood sugar",
        "Insufficient glucose levels (insulin shock)",
    ...
    },
    {
      ...
      options: [
        "Dry skin, slow pulse",
        "Mood changes, hunger, perspiration, confusion, irritation, weakness",
        "High blood pressure",
        "Rash"
      ],
      correct: "B"
    ...
    {
      id: 15350,
      question: "For a responsive hypoglycemic patient, what should be given?",
      options: [
        "Insulin",
        "Water only",
        "Concentrated form of oral sugar",
        "Protein"
      ],
      correct: "C"
    },
    {
      id: 15351,
      question: "What are examples of concentrated oral sugar?",
      options: [
        "Diet soda, water",
        "Sugar packet, cake icing, concentrated orange juice, sugar-containing soda",
        "Crackers, bread",
        "Vegetables"
      ],
      correct: "B"
    ...
    {
      id: 15353,
      question: "For an unresponsive hypoglycemic patient, what medication should be given if available and trained?",
      options: [
        "Insulin",
        "Epinephrine",
    ...
    },
    {
      ...
      options: [
        ...
        "An allergic reaction with immediate hypersensitivity",
        "Asthma attack",
        "Heart attack"
      ],
      correct: "B"
    },
    {
      ...
      options: [
        "Mild itching only",
        "Rapid severe hives, swelling of mucous membranes, respiratory distress, wheezing",
        "Headache",
        "Nausea only"
      ],
      correct: "B"
    ...
    {
      id: 15356,
      question: "For a responsive anaphylaxis patient, what should be administered?",
      options: [
        "Antihistamine",
        "Bronchodilator",
        "Epinephrine (0.15 mg for ≤30 kg; 0.3 to 0.5 mg for >30 kg)",
        "Nitroglycerin"
      ],
      correct: "C"
    },
    ...
    {
      id: 15358,
      question: "What is a localized skin response to an allergen?",
      options: [
        "Anaphylaxis",
        "Slow onset of mild itching, mild skin rash, hives",
        "Severe swelling",
    ...
    {
      id: 15359,
      question: "What medication should be administered for localized allergic skin response?",
      options: [
        "Epinephrine",
        "Nitroglycerin",
        "Diphenhydramine",
    ...
    {
      id: 15360,
      question: "What is the adult dose of diphenhydramine for localized allergic reaction?",
      options: [
        "10 mg",
        "15 to 20 mg",
        "25 to 50 mg",
    ...
    {
      id: 15361,
      question: "What might cause toxicity from local anesthesia?",
      options: [
        "Too little anesthetic",
        "Sensitivity to ingredient or overdose",
    ...
    {
      id: 15362,
      question: "What are signs of local anesthetic toxicity?",
      options: [
        "Rash",
        "Lightheadedness, blurred vision, slurred speech, confusion, drowsiness",
        "High blood pressure",
        "Fever"
      ],
      correct: "B"
    ...
    {
      id: 15363,
      question: "What are signs of toxicity from vasoconstrictor?",
      options: [
        "Slow pulse",
        "Anxiety, fast pulse, fast respirations, chest pain, possible dysrhythmias",
        "Low blood pressure",
        "Drowsiness"
      ],
      correct: "B"
    ...
    {
      id: 15364,
      question: "For an avulsed tooth, what is the best immediate action?",
      options: [
        "Store in milk",
        "Immediately reimplant the tooth",
        "Throw it away",
        "Store in tap water"
      ],
      correct: "B"
    ...
    {
      id: 15365,
      question: "If reimplantation of an avulsed tooth is not immediately possible, how should it be stored?",
      options: [
        "In tap water",
        "In alcohol",
    ...
    {
      id: 15366,
      question: "Is storage of an avulsed tooth in tap water recommended?",
      options: [
    ...
    {
      id: 15367,
      question: "What is informed consent for emergency treatment?",
      options: [
        "Only written permission",
        "Permission obtained if patient is conscious; assumed if unconscious",
        "Never needed in emergencies",
        "Only needed from family"
      ],
      correct: "B"
    },
    {
      id: 15368,
      question: "Can emergency assistance begin immediately if a patient is unconscious?",
      options: [
        "No, must wait for family",
        "No, must get written consent",
        "Yes, permission can be assumed",
        "Only if EMS approves"
      ],
      correct: "C"
    },
    {
      id: 15369,
      question: "What is a Good Samaritan?",
      options: [
        "A healthcare worker on duty",
        "Someone who renders aid in an emergency to injured person on voluntary basis",
        "An EMS worker",
        "A hospital employee"
      ],
      correct: "B"
    ...
    {
      id: 15370,
      question: "What do Good Samaritan statutes generally provide?",
      options: [
        "Financial compensation",
        "Immunity from civil liability for rendering care in emergency situations",
        "Mandatory duty to help",
    ...
    {
      id: 15371,
      question: "What must be true for Good Samaritan protection?",
      options: [
        "Expect payment",
        "Emergency care at scene, proper training, acting gratuitously in good faith without remuneration",
        "Any care anywhere",
        "Only in hospitals"
      ],
      correct: "B"
    ...
    {
      id: 15372,
      question: "Is gross negligence covered under Good Samaritan statutes?",
      options: [
        "Yes, always",
        "Yes, in most states",
        "No, not covered in most jurisdictions",
        "Only in some states"
      ],
      correct: "C"
    },
    {
      ...
      options: [
        "Minor error",
        "Accidental mistake",
        "Intentional failure to perform task with reckless disregard for consequences",
        "Honest mistake"
      ],
      correct: "C"
    },
    ...
    {
      id: 15375,
      question: "What duty do dental hygienists have regarding emergency services?",
      options: [
        "No duty",
        "Duty to deliver emergency services within scope of their training",
        "Only call EMS",
        "Only observe"
      ],
      correct: "B"
    ...
    {
      id: 15376,
      question: "What duty do all dental professionals have regarding competency?",
      options: [
        "No duty",
        "Remain competent through training, retraining, certification, and practice",
        "Only initial training",
        "Only if employer requires"
      ],
      correct: "B"
    }
  ],
