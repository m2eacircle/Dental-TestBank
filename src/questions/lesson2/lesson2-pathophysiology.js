...
export const questions = {
  ...
  "7. Cardiovascular System (Part 1)": [
    { id: 901, question: "The cardiac conduction system pathway begins at which structure?", options: ["AV bundle (Bundle of His)","SA node","Purkinje fibers","AV node"], correct: 1 },
    { id: 902, question: "Which component of the ECG represents ventricular depolarization?", options: ["P wave","T wave","QRS wave","U wave"], correct: 2 },
    { id: 903, question: "The cardiac control center that regulates heart rate is located in which part of the brain?", options: ["Cerebellum","Pons","Hypothalamus","Medulla"], correct: 3 },
    { id: 904, question: "What is the normal sinus rhythm heart rate initiated by the SA node?", options: ["Approximately 50 beats per minute","Approximately 70 beats per minute","Approximately 90 beats per minute","Approximately 110 beats per minute"], correct: 1 },
    { id: 905, question: "Which lipoprotein is considered \"bad\" because it transports cholesterol from the liver to cells?", options: ["HDL (High-density lipoprotein)","VLDL (Very low-density lipoprotein)","LDL (Low-density lipoprotein)","Chylomicrons"], correct: 2 },
    { id: 906, question: "Baroreceptors that detect changes in blood pressure are located in which vessels?", options: ["Femoral artery and subclavian vein","Aorta and internal carotid arteries","Pulmonary artery and vena cava","Brachial artery and jugular vein"], correct: 1 },
    { id: 907, question: "The left coronary artery divides into which two branches?", options: ["Right marginal and posterior interventricular arteries","Anterior interventricular and left circumflex arteries","Superior and inferior ventricular arteries","Lateral and medial coronary arteries"], correct: 1 },
    { id: 908, question: "During the cardiac cycle, systole refers to:", options: ["Cardiac relaxation including ventricles and atria","The filling phase of the ventricles","Cardiac contraction including atria and ventricles","The resting phase between heartbeats"], correct: 2 },
    { id: 909, question: "The \"lubb\" sound of the heart is due to closure of which valves?", options: ["Semilunar valves during ventricular diastole","AV valves during ventricular systole","Pulmonary valves during atrial systole","Aortic valves during atrial diastole"], correct: 1 },
    { id: 910, question: "What is the formula for calculating cardiac output?", options: ["Stroke volume × peripheral resistance","Heart rate × blood pressure","Heart rate × stroke volume","Preload × afterload"], correct: 2 },
    { id: 911, question: "Normal blood pressure at rest is approximately:", options: ["100/60 mmHg","120/70 mmHg","140/90 mmHg","160/100 mmHg"], correct: 1 },
    { id: 912, question: "Which factor does NOT directly affect blood pressure?", options: ["Cardiac output","Blood volume","Body temperature","Peripheral resistance"], correct: 2 },
    { id: 913, question: "Angina pectoris is characterized by:", options: ["Complete blockage of coronary arteries","Oxygen deficiency of the heart muscle","Inflammation of the pericardium","Abnormal heart valve function"], correct: 1 },
    { id: 914, question: "The most common cause of myocardial infarction is:", options: ["Viral infection","Rheumatic fever","Atherosclerosis","Congenital defect"], correct: 2 },
    { id: 915, question: "If blood supply is restored within what timeframe during MI, damage may be reversible?", options: ["Less than 10 minutes","Less than half an hour","Less than 2 hours","Less than 6 hours"], correct: 1 },
    { id: 916, question: "Bradycardia is defined as a heart rate:", options: ["Less than 50 beats per minute","Less than 60 beats per minute","Less than 70 beats per minute","Less than 80 beats per minute"], correct: 1 },
    { id: 917, question: "Tachycardia is defined as a heart rate:", options: ["More than 80 beats per minute","More than 90 beats per minute","More than 100 beats per minute","More than 110 beats per minute"], correct: 2 },
    { id: 918, question: "Atrial fibrillation is characterized by an atrial rate of:", options: ["100-150 beats per minute","160-250 beats per minute","260-349 beats per minute","350 or more beats per minute"], correct: 3 },
    { id: 919, question: "Which cardiac arrhythmia shows a flat line on ECG?", options: ["Ventricular fibrillation","Cardiac arrest (Standstill)","Premature ventricular contraction","Bundle branch block"], correct: 1 },
    { id: 920, question: "In congestive heart failure, the heart is unable to:", options: ["Maintain normal electrical conduction","Prevent blood clot formation","Pump sufficient blood to meet metabolic demands","Regulate body temperature effectively"], correct: 2 },
    { id: 921, question: "Left-sided congestive heart failure primarily causes backup in which system?", options: ["Systemic venous circulation","Hepatic portal system","Pulmonary circulation","Lymphatic system"], correct: 2 },
    { id: 922, question: "Which symptom is characteristic of right-sided heart failure?", options: ["Pulmonary edema","Dependent edema in feet and legs","Paroxysmal nocturnal dyspnea","Persistent cough with frothy sputum"], correct: 1 },
    { id: 923, question: "Paroxysmal nocturnal dyspnea indicates:", options: ["Chronic bronchitis","Acute pulmonary edema","Pleural effusion","Pneumothorax"], correct: 1 },
    { id: 924, question: "Congenital heart defects typically develop during which period of embryonic life?", options: ["The first two months","The second trimester","The third trimester","Throughout entire gestation"], correct: 0 },
    { id: 925, question: "Stenosis in cardiac terminology refers to:", options: ["Backward flow of blood through a valve","Abnormal narrowing in a blood vessel","Inflammation of heart tissue","Irregular heart rhythm"], correct: 1 },
    { id: 926, question: "An acyanotic septal defect results in:", options: ["Complete mixing of arterial and venous blood","Systemic blood with reduced oxygen content","Normal oxygen levels in systemic blood","Increased oxygen levels in venous blood"], correct: 1 },
    { id: 927, question: "Rheumatic fever is an abnormal immune reaction that occurs after infection with:", options: ["Staphylococcus aureus","Streptococcus pyogenes","Streptococcus viridans","Escherichia coli"], correct: 1 },
    { id: 928, question: "Which heart structure is NOT commonly affected by rheumatic fever?", options: ["Pericardium","Myocardium","Endocardium","Coronary arteries"], correct: 3 },
    { id: 929, question: "Subacute bacterial endocarditis is typically caused by:", options: ["Streptococcus viridans","Staphylococcus aureus","Streptococcus pyogenes","Streptococcus pneumoniae"], correct: 0 },
    { id: 930, question: "Acute bacterial endocarditis is typically caused by:", options: ["Streptococcus viridans","Staphylococcus aureus","Streptococcus pyogenes","Escherichia coli"], correct: 1 },
    { id: 931, question: "Which condition is NOT a common etiological factor for pericarditis?", options: ["Open heart surgery","Myocardial infarction","Hypertension","Viral infection"], correct: 2 },
    { id: 932, question: "Chronic pericarditis results in:", options: ["Fluid accumulation in pleural space","Adhesions between pericardial membranes","Dilation of coronary arteries","Thickening of heart valves"], correct: 1 },
    { id: 933, question: "Primary (essential) hypertension is characterized by:", options: ["Known renal cause","Endocrine disorder origin","Idiopathic (unknown cause)","Medication side effect"], correct: 2 },
    { id: 934, question: "What percentage of the population is affected by hypertension?", options: ["Approximately one tenth","Approximately one fifth","Approximately one third","Approximately one half"], correct: 2 },
    { id: 935, question: "Which factor is NOT a modifiable risk factor for atherosclerosis?", options: ["Obesity","Smoking","Age","Diabetes"], correct: 2 },
    { id: 936, question: "The normal preload state occurs at:", options: ["The beginning of systole when ventricles begin contracting","The end of diastole when ventricles are at maximum volume","The middle of systole when ejection is occurring","The beginning of diastole when ventricles start filling"], correct: 1 },
    { id: 937, question: "Afterload refers to:", options: ["The volume of blood in ventricles at end-diastole","The force required to eject blood from the ventricles","The amount of blood returning to the heart","The pressure in the atria during filling"], correct: 1 },
    { id: 938, question: "Which factor increases heart rate?", options: ["Decreased thyroid hormones","Parasympathetic nervous system stimulation","Elevated body temperature","Decreased environmental temperature"], correct: 2 },
    { id: 939, question: "The P wave on an ECG represents:", options: ["Ventricular depolarization","Atrial depolarization","Ventricular repolarization","Atrial repolarization"], correct: 1 },
    { id: 940, question: "The T wave on an ECG represents:", options: ["Ventricular depolarization","Atrial depolarization","Ventricular repolarization","Atrial repolarization"], correct: 2 },
    { id: 941, question: "Which vessel branches off the aorta to supply the heart muscle?", options: ["Pulmonary arteries","Coronary arteries","Carotid arteries","Subclavian arteries"], correct: 1 },
    { id: 942, question: "The right coronary artery divides into which branches?", options: ["Anterior interventricular and left circumflex arteries","Right marginal and posterior interventricular arteries","Superior and inferior coronary arteries","Lateral and medial ventricular arteries"], correct: 1 },
    { id: 943, question: "Heart murmurs result from:", options: ["Normal valve function","Valvular incompetency","Optimal blood flow","Proper cardiac timing"], correct: 1 },
    { id: 944, question: "During ventricular systole, which valves are open?", options: ["AV valves (tricuspid and mitral)","Semilunar valves (aortic and pulmonary)","All valves are closed","All valves are open"], correct: 1 },
    { id: 945, question: "Which sympathetic response increases cardiac output?", options: ["Vasodilation","Decreased heart rate","Epinephrine release","Vagal stimulation"], correct: 2 },
    { id: 946, question: "Average cardiac output in mL per minute is:", options: ["3000-4000 mL","4900-5000 mL","6000-7000 mL","8000-9000 mL"], correct: 1 },
    { id: 947, question: "Average stroke volume per contraction is:", options: ["50 mL","70 mL","90 mL","110 mL"], correct: 1 },
    { id: 948, question: "Systolic blood pressure represents:", options: ["Ventricular relaxation pressure","Blood ejection from the left ventricle","Atrial contraction pressure","Diastolic filling pressure"], correct: 1 },
    { id: 949, question: "Diastolic pressure during the cardiac cycle represents:", options: ["Pressure when atria contract","Pressure during ventricular contraction","Pressure when ventricles relax","Pressure during valve opening"], correct: 2 },
    { id: 950, question: "Rheumatic fever is most commonly seen in:", options: ["Elderly adults","Middle-aged adults","Children","Newborns"], correct: 2 },
    { id: 951, question: "Acute rheumatic fever can affect all EXCEPT:", options: ["Joints","Kidneys","Heart","Skin"], correct: 1 },
    { id: 952, question: "Rheumatic heart disease results from:", options: ["Acute bacterial infection","Scar tissue and loss of valve function","Improved cardiac function","Enhanced valve flexibility"], correct: 1 },
    { id: 953, question: "Infective endocarditis requires which three factors?", options: ["Young age, good immunity, normal valves","Abnormal tissues/valves, microorganisms, reduced host defenses","High blood pressure, diabetes, obesity","Genetic predisposition, smoking, stress"], correct: 1 },
    { id: 954, question: "Symptoms of infective endocarditis include:", options: ["Bradycardia and hypotension","Murmurs, fever, and splenomegaly","Weight gain and edema","Improved exercise tolerance"], correct: 1 },
    { id: 955, question: "Acute pericarditis causes chest pain due to:", options: ["Smooth pericardial surfaces","Rough and swollen pericardial surfaces","Decreased pericardial fluid","Enhanced cardiac contractility"], correct: 1 },
    { id: 956, question: "Pericardial effusion refers to:", options: ["Decreased pericardial fluid","Thickened pericardial membrane","Large volume of fluid accumulation in pericardial sac","Normal pericardial fluid levels"], correct: 2 },
    { id: 957, question: "Treatment for pericarditis with effusion includes:", options: ["Increasing fluid intake","Aspiration of fluid from the cavity","Vigorous exercise","High-sodium diet"], correct: 1 },
    { id: 958, question: "What percentage of the population has hypertension?", options: ["Approximately 10%","Approximately 20%","Approximately 33%","Approximately 50%"], correct: 2 },
    { id: 959, question: "Until what age are men more likely to have hypertension than women?", options: ["Age 45","Age 55","Age 65","Age 75"], correct: 1 },
    { id: 960, question: "Secondary hypertension results from:", options: ["Unknown causes","Renal or endocrine failure","Genetic factors only","Normal aging process"], correct: 1 },
    { id: 961, question: "Malignant hypertension is characterized by:", options: ["Easily controlled blood pressure","Mild elevation of pressure","Uncontrollable high blood pressure","Normal blood pressure with symptoms"], correct: 2 },
    { id: 962, question: "Modifiable risk factors for hypertension include all EXCEPT:", options: ["Obesity","Smoking","Age","Stress"], correct: 2 },
    { id: 963, question: "Common symptoms of hypertension include:", options: ["Severe chest pain","Morning headache and fatigue","Rapid weight loss","Increased energy levels"], correct: 1 },
    { id: 964, question: "Lifestyle changes for hypertension treatment include:", options: ["Increased salt intake","Weight loss and stress reduction","Decreased physical activity","High-fat diet"], correct: 1 },
    { id: 965, question: "Medications for hypertension include all EXCEPT:", options: ["ACE inhibitors","Calcium channel blockers","Stimulants","Mild diuretics"], correct: 2 },
    { id: 966, question: "The AV node serves as:", options: ["The primary pacemaker","The only connection site between atria and ventricles","The fastest conducting tissue","A backup system only"], correct: 1 },
    { id: 967, question: "The AV bundle along with Purkinje fibers:", options: ["Stimulate atrial contraction","Slow down conduction","Stimulate contraction of both ventricles","Prevent ventricular contraction"], correct: 2 },
    { id: 968, question: "No nerves are present in the myocardium.", options: ["True","False"], correct: 0 },
    { id: 969, question: "The SA node is known as the pacemaker of the heart.", options: ["True","False"], correct: 0 },
    { id: 970, question: "The normal sinus rhythm is approximately 70 beats per minute.", options: ["True","False"], correct: 0 },
    { id: 971, question: "HDL is considered \"bad\" cholesterol that causes atheroma formation.", options: ["True","False"], correct: 1 },
    { id: 972, question: "Smoking is a factor that increases heart rate.", options: ["True","False"], correct: 0 },
    { id: 973, question: "The systolic pressure is represented by the lower number in a blood pressure reading.", options: ["True","False"], correct: 1 },
    { id: 974, question: "Atherosclerosis can lead to angina pectoris and myocardial infarction.", options: ["True","False"], correct: 0 },
    { id: 975, question: "If blood supply is restored within less than half an hour during MI, damage may be reversible.", options: ["True","False"], correct: 0 },
    { id: 976, question: "Ventricular fibrillation results in improved cardiac output.", options: ["True","False"], correct: 1 },
    { id: 977, question: "In left-sided congestive heart failure, backup occurs in the pulmonary circulation.", options: ["True","False"], correct: 0 },
    { id: 978, question: "Dependent edema in feet and legs is a sign of left-sided heart failure.", options: ["True","False"], correct: 1 },
    { id: 979, question: "Congenital heart defects typically develop during the first two months of embryonic life.", options: ["True","False"], correct: 0 },
    { id: 980, question: "Rheumatic fever is caused by Staphylococcus aureus infection.", options: ["True","False"], correct: 1 },
    { id: 981, question: "Acute bacterial endocarditis is typically caused by Staphylococcus aureus.", options: ["True","False"], correct: 0 },
    { id: 982, question: "Chronic pericarditis causes adhesions between pericardial membranes.", options: ["True","False"], correct: 0 },
    { id: 983, question: "Primary hypertension has a known, identifiable cause.", options: ["True","False"], correct: 1 },
    { id: 984, question: "Men are more likely than women to have hypertension until age 55.", options: ["True","False"], correct: 0 },
    { id: 985, question: "The cardiac cycle consists of alternating systole and diastole.", options: ["True","False"], correct: 0 },
    { id: 986, question: "The P wave represents ventricular depolarization on an ECG.", options: ["True","False"], correct: 1 },
    { id: 987, question: "Cardiac output equals heart rate multiplied by stroke volume.", options: ["True","False"], correct: 0 },
    { id: 988, question: "Baroreceptors stimulate either sympathetic or parasympathetic systems to regulate heart rate.", options: ["True","False"], correct: 0 },
    { id: 989, question: "The right and left coronary arteries branch directly from the pulmonary artery.", options: ["True","False"], correct: 1 },
    { id: 990, question: "Heart murmurs result from valvular incompetency.", options: ["True","False"], correct: 0 },
    { id: 991, question: "LDL transports cholesterol from cells back to the liver.", options: ["True","False"], correct: 1 },
    { id: 992, question: "Angina pectoris represents complete obstruction of coronary arteries.", options: ["True","False"], correct: 1 },
    { id: 993, question: "Collateral circulation can reduce the size of myocardial infarction.", options: ["True","False"], correct: 0 },
    { id: 994, question: "ECG is the best method for monitoring cardiac arrhythmias.", options: ["True","False"], correct: 0 },
    { id: 995, question: "Tachycardia is defined as heart rate less than 60 beats per minute.", options: ["True","False"], correct: 1 },
    { id: 996, question: "In congestive heart failure, the heart cannot pump sufficient blood to meet metabolic demands.", options: ["True","False"], correct: 0 },
    { id: 997, question: "Orthopnea refers to difficulty breathing when lying flat.", options: ["True","False"], correct: 0 },
    { id: 998, question: "All congenital heart defects result in decreased oxygen supply to tissues.", options: ["True","False"], correct: 0 },
    { id: 999, question: "Stenosis refers to abnormal narrowing in a blood vessel.", options: ["True","False"], correct: 0 },
    { id: 1000, question: "Rheumatic fever occurs during active streptococcal infection.", options: ["True","False"], correct: 1 },
    { id: 1001, question: "Subacute bacterial endocarditis is caused by Streptococcus viridans.", options: ["True","False"], correct: 0 },
    { id: 1002, question: "Pericardial effusion refers to decreased pericardial fluid.", options: ["True","False"], correct: 1 },
    { id: 1003, question: "Approximately one-third of the population has hypertension.", options: ["True","False"], correct: 0 },
    { id: 1004, question: "Age is a modifiable risk factor for atherosclerosis.", options: ["True","False"], correct: 1 },
    { id: 1005, question: "Weight loss and stress reduction are effective lifestyle changes for hypertension.", options: ["True","False"], correct: 0 },
    { id: 1006, question: "The AV node is the only connection site between atria and ventricles.", options: ["True","False"], correct: 0 },
    { id: 1007, question: "Pregnancy is a factor that can increase heart rate.", options: ["True","False"], correct: 0 }
  ],

  "8. Respiratory System Disorders (Part 1)": [
    { id: 1101, question: "What are the two critical functions of the nasal passages?", options: ["They filter blood and produce mucus for digestion","They warm and moisturize air, and filter out foreign materials","They regulate blood pressure and control heart rate","They produce antibodies and destroy pathogens"], correct: 1 },
    { id: 1102, question: "Which type of sinus is NOT one of the four sinuses in the skull?", options: ["Sphenoid","Maxillary","Temporal","Frontal"], correct: 2 },
    { id: 1103, question: "What is the ciliary escalator?", options: ["A muscle that controls breathing rate","A unique respiratory tract feature with ciliated epithelium and mucus-secreting goblet cells that sweep foreign particles upward","A system of blood vessels in the lungs","A type of immune cell found only in the bronchi"], correct: 1 },
    { id: 1104, question: "Where are pharyngeal tonsils (adenoids) located?", options: ["At the back of the base of the tongue","In the posterior portion of the oral cavity","On the posterior wall of the nasopharynx","Inside the larynx near the vocal cords"], correct: 2 },
    { id: 1105, question: "What is the primary function of the epiglottis?", options: ["It produces sound for speech","It filters air entering the lungs","It is a cartilaginous appendage that flips up and down during swallowing","It secretes mucus to trap bacteria"], correct: 2 },
    { id: 1106, question: "Which bronchus is straighter and larger?", options: ["The left bronchus","The right bronchus","Both are equal in size and angle","Neither, the trachea doesn't branch"], correct: 1 },
    { id: 1107, question: "What is the hilum?", options: ["The bottom portion of the lung","A type of alveolar cell","The outer membrane covering the lung","The point at which the bronchus enters the lung"], correct: 3 },
    { id: 1108, question: "What causes bronchodilation?", options: ["Parasympathetic nervous system stimulation","Sympathetic nervous system stimulation","Decreased oxygen levels","Increased carbon dioxide levels"], correct: 1 },
    { id: 1109, question: "What is the respiratory membrane?", options: ["The lining of the nasal passages","The tissue surrounding the trachea","The combined alveolar and capillary wall through which gas exchange occurs","The pleural sac around each lung"], correct: 2 },
    { id: 1110, question: "What is surfactant and what does it do?", options: ["A hormone that increases breathing rate during exercise","An enzyme that breaks down foreign particles","A special fluid secreted by alveolar cells that reduces surface tension and facilitates inspiration and expiration","A type of mucus that traps bacteria"], correct: 2 },
    { id: 1111, question: "How many lobes does the right lung have?", options: ["One","Two","Three","Four"], correct: 2 },
    { id: 1112, question: "What is the pleural membrane?", options: ["The lining of the trachea","A single-layered protective covering","A double-walled sac covering each lung","The membrane separating the two lungs"], correct: 2 },
    { id: 1113, question: "During inspiration, what happens to intrapulmonic pressure?", options: ["It increases above atmospheric pressure","It becomes negative (approximately 756 mm Hg)","It remains constant at 760 mm Hg","It equalizes with intrapleural pressure"], correct: 1 },
    { id: 1114, question: "What is hypoxemia?", options: ["Excessive oxygen in the blood","Excessive carbon dioxide in the blood","A marked decrease in blood oxygen","Normal oxygen levels during exercise"], correct: 2 },
    { id: 1115, question: "What condition results from hypoventilation?", options: ["Respiratory alkalosis","Hypocapnia","Hypercapnia and respiratory acidosis","Increased blood pH"], correct: 2 },
    { id: 1116, question: "How is most oxygen transported in the blood?", options: ["Dissolved in plasma (98-99%)","Bound to hemoglobin as oxyhemoglobin","As bicarbonate ions","Attached to white blood cells"], correct: 1 },
    { id: 1117, question: "What is the major form in which carbon dioxide is carried in blood?", options: ["Dissolved in plasma","Bound to hemoglobin as carbaminoglobin","As bicarbonate ions resulting from carbonic acid dissociation","Attached to platelets"], correct: 2 },
    { id: 1118, question: "What type of discharge characterizes bacterial infection in the respiratory tract?", options: ["Clear and watery mucus","Bright red and frothy sputum","Yellowish-green, cloudy, thick mucus","Thin, white discharge"], correct: 2 },
    { id: 1119, question: "What is hemoptysis?", options: ["Difficulty breathing at night","Coughing up blood or blood-stained sputum","Excessive mucus production","Inflammation of the pleura"], correct: 1 },
    { id: 1120, question: "What is the normal breathing rate (eupnea)?", options: ["5-8 inspirations per minute","10-18 inspirations per minute","20-25 inspirations per minute","30-40 inspirations per minute"], correct: 1 },
    { id: 1121, question: "What does Kussmaul breathing indicate?", options: ["Normal resting respiration","Shallow, rapid breathing","Deep, rapid breathing often seen in acidosis or strenuous exercise","Irregular, gasping breaths"], correct: 2 },
    { id: 1122, question: "What do rales sound like and what causes them?", options: ["Deep, harsh sounds from thick mucus","Bubbly sounds as a result of serous secretions","High-pitched sounds from airway obstruction","Silent breathing with no audible sounds"], correct: 1 },
    { id: 1123, question: "What is cyanosis?", options: ["Redness of the skin due to fever","Yellowing of the skin and eyes","Pale skin from anemia","Bluish coloring of skin and mucous membranes due to unoxygenated hemoglobin"], correct: 3 },
    { id: 1124, question: "What causes clubbed fingers or toes?", options: ["Acute respiratory infection","Short-term oxygen deprivation","Chronic hypoxia","Excessive carbon dioxide"], correct: 2 },
    { id: 1125, question: "What is the typical causative agent of the common cold?", options: ["Streptococcus bacteria","Staphylococcus aureus","Mycobacterium tuberculosis","Rhinovirus"], correct: 3 },
    { id: 1126, question: "What are fomites?", options: ["Living organisms that cause disease","Antibodies produced against viruses","Non-living objects that can transmit infection","White blood cells that fight infection"], correct: 2 },
    { id: 1127, question: "What is the primary characteristic of sinusitis?", options: ["Inflammation of the larynx","Obstruction of sinus drainage due to bacterial infection or allergy","Viral infection of the bronchi","Fluid accumulation in the lungs"], correct: 1 },
    { id: 1128, question: "Which bacteria most commonly cause sinusitis?", options: ["Mycobacterium tuberculosis","Legionella pneumophila","Pneumococci, streptococci, or H. influenzae","Pseudomonas aeruginosa"], correct: 2 },
    { id: 1129, question: "What is croup specifically characterized as?", options: ["Bronchiolitis with wheezing","Pneumonia in children","Laryngotracheobronchitis","Sinusitis with fever"], correct: 2 },
    { id: 1130, question: "Which age group is most commonly affected by croup?", options: ["Newborns under 6 months","Children between 1 and 2 years of age","Adolescents 13-17 years","Adults over 30 years"], correct: 1 },
    { id: 1131, question: "How many types of influenza virus are there?", options: ["Two (A and B)","Three (A, B, and C)","Four (A, B, C, and D)","Five (A, B, C, D, and E)"], correct: 2 },
    { id: 1132, question: "What is the most serious complication of influenza?", options: ["Ear infection","Sinusitis","Dehydration","Pneumonia from secondary bacterial infection"], correct: 3 },
    { id: 1133, question: "Which antiviral drug is commonly used for influenza (brand name Tamiflu)?", options: ["Amantadine","Rimantadine","Zanamivir","Oseltamivir"], correct: 3 },
    { id: 1134, question: "What causes scarlet fever?", options: ["Rhinovirus","Influenza virus","Streptococcus pyogenes","Adenovirus"], correct: 2 },
    { id: 1135, question: "What is a characteristic sign of scarlet fever?", options: ["Blue tongue","Strawberry tongue","Black tongue","White patches on tongue"], correct: 1 },
    { id: 1136, question: "What is pneumonia?", options: ["Inflammation of the nasal passages","An infection that inflames air sacs in one or both lungs, which may fill with fluid or pus","Chronic obstruction of the bronchi","Viral infection of the upper respiratory tract"], correct: 1 },
    { id: 1137, question: "Which organism causes lobar pneumonia?", options: ["Staphylococcus aureus","Haemophilus influenzae","Streptococcus pneumoniae","Mycoplasma pneumoniae"], correct: 2 },
    { id: 1138, question: "What is consolidation in lobar pneumonia?", options: ["Clearing of the infection","Accumulation of neutrophils, RBCs and fibrin in alveolar exudate","Formation of antibodies","Expansion of the airways"], correct: 1 },
    { id: 1139, question: "What is empyema?", options: ["Excess air in the lungs","Inflammation spreading into the pleural cavity","Collapse of alveoli","Thickening of bronchial walls"], correct: 1 },
    { id: 1140, question: "Which organisms most commonly cause bronchopneumonia?", options: ["Rhinovirus and coronavirus","Streptococcus pneumoniae only","S. aureus and H. influenzae","Mycobacterium tuberculosis"], correct: 2 },
    { id: 1141, question: "Where is Legionella pneumophila commonly acquired?", options: ["From person-to-person contact","From contaminated food","As a nosocomial (hospital-acquired) infection","From animal bites"], correct: 2 },
    { id: 1142, question: "What additional symptoms distinguish Legionnaires' disease from other pneumonias?", options: ["Severe headache and confusion","Diarrhea, proteinuria and hematuria","Skin rash and joint pain","Vision problems and dizziness"], correct: 1 },
    { id: 1143, question: "Which antibiotics are best for treating Legionnaires' disease?", options: ["Penicillin and amoxicillin","Ciprofloxacin, rifampin and erythromycin","Vancomycin and methicillin","Cephalosporins only"], correct: 1 },
    { id: 1144, question: "What causes primary atypical bacterial pneumonia?", options: ["Streptococcus pneumoniae","Staphylococcus aureus","Mycoplasma pneumoniae","Haemophilus influenzae"], correct: 2 },
    { id: 1145, question: "What causes tuberculosis?", options: ["Streptococcus tuberculosis","Mycobacterium tuberculosis","Staphylococcus tuberculosis","Pneumococcus tuberculosis"], correct: 1 },
    { id: 1146, question: "Why can mycobacteria survive in dry environments?", options: ["They form protective spores","They have thick peptidoglycan walls","They have high amounts of mycolic acid in their cell walls","They produce resistant biofilms"], correct: 2 },
    { id: 1147, question: "What is a tubercle?", options: ["A type of immune cell","The granuloma containing live bacilli","An antibiotic used to treat TB","A breathing pattern in TB patients"], correct: 1 },
    { id: 1148, question: "What is caseation in tuberculosis?", options: ["The healing process of the infection","The spread of bacteria to other organs","Cheese-like material in the center of tubercles containing dead macrophages and necrotic tissue","Formation of new blood vessels"], correct: 2 },
    { id: 1149, question: "What are Ghon complexes?", options: ["Large cavities in the lung tissue","Types of antibiotics for TB","Small, calcified lesions in lung and lymph nodes resistant to bacterial invasion","Immune cells that attack TB bacteria"], correct: 2 },
    { id: 1150, question: "What is miliary tuberculosis?", options: ["A mild, self-limiting form of TB","TB affecting only the lymph nodes","A rapidly progressive form with multiple granulomas affecting large lung areas and spreading to other tissues","TB that only affects military personnel"], correct: 2 },
    { id: 1151, question: "What is the basis of the tuberculin skin test?", options: ["Detection of antibodies in blood","Hypersensitivity reaction in response to tuberculoprotein","Bacterial culture growth","X-ray imaging of the lungs"], correct: 1 },
    { id: 1152, question: "What is cavitation in secondary tuberculosis?", options: ["Formation of protective scar tissue","A large open area in the lung","Calcification of infected tissue","Accumulation of fluid in airways"], correct: 1 },
    { id: 1153, question: "Which drugs are used in combination for tuberculosis treatment?", options: ["Penicillin, amoxicillin, cephalexin","Isoniazid, ethambutol, rifampin and pyrazinamide","Erythromycin, azithromycin, clarithromycin","Vancomycin, gentamicin, tobramycin"], correct: 1 },
    { id: 1154, question: "Why is BCG vaccine not frequently used in North America?", options: ["It is too expensive","It has severe side effects","It prevents diagnosis by skin test","It is not effective against TB"], correct: 2 },
    { id: 1155, question: "When did COVID-19 first emerge?", options: ["January 2018 in Beijing, China","March 2020 in Italy","December 2019 in Wuhan, China","February 2021 in the United States"], correct: 2 },
    { id: 1156, question: "What type of virus is SARS-CoV-2?", options: ["Rhinovirus","Influenza virus","Coronavirus","Adenovirus"], correct: 2 },
    { id: 1157, question: "What is the typical incubation period for COVID-19?", options: ["1-3 hours","2-14 days","3-4 weeks","6-8 months"], correct: 1 },
    { id: 1158, question: "Which COVID-19 variant was first identified in India?", options: ["Alpha (B.1.1.7)","Beta (B.1.351)","Gamma (P.1)","Delta (B.1.617.2)"], correct: 3 },
    { id: 1159, question: "What is Remdesivir (Veklury) used for?", options: ["Prevention of COVID-19 in healthy individuals","Treatment of mild COVID-19 symptoms at home","Treatment of hospitalized COVID-19 patients with severe symptoms","Treatment of COVID-19 vaccine side effects"], correct: 2 },
    { id: 1160, question: "Which test looks for genetic material of SARS-CoV-2?", options: ["Antigen test","Antibody test","PCR test","Culture test"], correct: 2 },
    { id: 1161, question: "How many doses of Pfizer-BioNTech COVID-19 vaccine are required?", options: ["1 dose","2 doses, 3 weeks apart","2 doses, 4 weeks apart","3 doses, 2 weeks apart"], correct: 1 },
    { id: 1162, question: "What type of vaccine is the Moderna COVID-19 vaccine?", options: ["Live attenuated vaccine","Viral vector-based vaccine","Protein subunit vaccine","mRNA vaccine"], correct: 3 },
    { id: 1163, question: "What gene is mutated in cystic fibrosis?", options: ["BRCA1 gene","CFTR gene","TP53 gene","HLA gene"], correct: 1 },
    { id: 1164, question: "What does cystic fibrosis primarily affect?", options: ["The cardiovascular system","The nervous system","The exocrine glands","The endocrine glands"], correct: 2 },
    { id: 1165, question: "Which bacteria commonly cause infections in cystic fibrosis patients?", options: ["Streptococcus pneumoniae and Mycobacterium tuberculosis","Pseudomonas aeruginosa and Staphylococcus aureus","Escherichia coli and Klebsiella pneumoniae","Haemophilus influenzae and Moraxella catarrhalis"], correct: 1 },
    { id: 1166, question: "What happens in the pancreas of cystic fibrosis patients?", options: ["Insulin production increases dramatically","The organ enlarges and becomes hyperactive","Ducts of exocrine glands become obstructed, leading to enzyme shortage","Cancer develops in most cases"], correct: 2 },
    { id: 1167, question: "What is steatorrhea?", options: ["Excessive protein in stool","Blood in stool","Fatty stools due to malabsorption","Constipation with hard stools"], correct: 2 },
    { id: 1168, question: "What inheritance pattern does cystic fibrosis follow?", options: ["X-linked dominant","Autosomal dominant","Autosomal recessive","Mitochondrial inheritance"], correct: 2 },
    { id: 1169, question: "Which racial group has higher prevalence of cystic fibrosis?", options: ["Asians from Eastern Asia","Whites from Northern Europe","Africans from Sub-Saharan Africa","Indigenous peoples of South America"], correct: 1 },
    { id: 1170, question: "What is extrinsic asthma?", options: ["Asthma triggered by exercise only","Asthma caused by type I hypersensitivity reaction to inhaled antigens","Asthma from chronic bacterial infection","Asthma resulting from genetic mutations"], correct: 1 },
    { id: 1171, question: "Which age group more commonly experiences extrinsic asthma?", options: ["Elderly adults over 70","Middle-aged adults 40-60","Young adults 20-35","Children"], correct: 3 },
    { id: 1172, question: "What triggers intrinsic asthma?", options: ["Only pollen and dust mites","Infections, smoking, stress, drugs, and cold","Exercise exclusively","Food allergies only"], correct: 1 },
    { id: 1173, question: "What are the three pathophysiologic changes in asthma (in order)?", options: ["Mucus production, muscle relaxation, reduced inflammation","Inflammation of mucosa, bronchoconstriction, increased thick mucus secretion","Bronchodilation, decreased mucus, healing of mucosa","Coughing, wheezing, chest tightness"], correct: 1 },
    { id: 1174, question: "What can total airway obstruction in asthma lead to?", options: ["Pneumonia","Tuberculosis","Atelectasis","Lung cancer"], correct: 2 },
    { id: 1175, question: "Which drug is a glucocorticoid used in asthma treatment?", options: ["Salbutamol","Beclomethasone","Cromolyn sodium","Montelukast"], correct: 1 },
    { id: 1176, question: "What type of drug is salbutamol?", options: ["Antibiotic","Antiviral","Bronchodilator inhaler","Antihistamine"], correct: 2 },
    { id: 1177, question: "The right bronchus is smaller and more curved than the left bronchus.", options: ["True","False"], correct: 1 },
    { id: 1178, question: "Alveoli have their own specialized macrophages called alveolar macrophages.", options: ["True","False"], correct: 0 },
    { id: 1179, question: "The left lung has three lobes while the right lung has two lobes.", options: ["True","False"], correct: 1 },
    { id: 1180, question: "Hypercapnia is caused by hyperventilation.", options: ["True","False"], correct: 1 },
    { id: 1181, question: "Most carbon dioxide in blood is carried as bicarbonate ions.", options: ["True","False"], correct: 0 },
    { id: 1182, question: "Wheezing indicates obstruction of large airways.", options: ["True","False"], correct: 1 },
    { id: 1183, question: "The common cold is caused by bacteria and requires antibiotic treatment.", options: ["True","False"], correct: 1 },
    { id: 1184, question: "Influenza can affect both upper and lower respiratory tracts.", options: ["True","False"], correct: 0 },
    { id: 1185, question: "Lobar pneumonia typically affects multiple scattered areas of both lungs.", options: ["True","False"], correct: 1 },
    { id: 1186, question: "Primary tuberculosis infection is usually asymptomatic.", options: ["True","False"], correct: 0 },
    { id: 1187, question: "COVID-19 symptoms typically develop 2-14 days after exposure to the virus.", options: ["True","False"], correct: 0 },
    { id: 1188, question: "The Janssen COVID-19 vaccine requires two doses.", options: ["True","False"], correct: 1 },
    { id: 1189, question: "Cystic fibrosis affects both the lungs and the pancreas.", options: ["True","False"], correct: 0 },
    { id: 1190, question: "Intrinsic asthma is more common in children than adults.", options: ["True","False"], correct: 1 },
    { id: 1191, question: "Atelectasis refers to lung collapse or non-aeration.", options: ["True","False"], correct: 0 }
  ],

  "9. Digestive System Disorders (Part 1)": [
    { id: 1301, question: "What are the four accessory structures of the GI tract?", options: ["Liver, kidney, spleen, and pancreas","Salivary glands, liver, pancreas, and gallbladder","Esophagus, stomach, small intestine, and colon","Tongue, teeth, uvula, and tonsils"], correct: 1 },
    { id: 1302, question: "The peritoneum is best described as:", options: ["A muscular tube connecting the throat to the stomach","The inner lining of the small intestine","A large serous membrane covering the abdominal wall and encasing digestive organs","A sphincter controlling food passage"], correct: 2 },
    { id: 1303, question: "Where does the initial phase of mechanical breakdown and digestion take place?", options: ["Esophagus through peristalsis","Stomach through churning","Small intestine through segmentation","Oral cavity through mastication"], correct: 3 },
    { id: 1304, question: "What are the two important roles of saliva in digestion?", options: ["Killing bacteria and producing vitamins","Facilitating food passage and beginning carbohydrate digestion","Neutralizing acids and absorbing nutrients","Secreting enzymes and storing minerals"], correct: 1 },
    { id: 1305, question: "The esophagus connects the throat to the stomach through which involuntary process?", options: ["Segmentation that mixes food particles","Mastication that breaks down food","Peristalsis that pushes the bolus downward","Churning that liquefies the bolus"], correct: 2 },
    { id: 1306, question: "What is the term for the ball of food that moves down to the stomach?", options: ["Chyme","Bolus","Cud","Mucus"], correct: 1 },
    { id: 1307, question: "The stomach's wall falls into folds called _____ when empty:", options: ["Villi","Crypts","Rugae","Haustra"], correct: 2 },
    { id: 1308, question: "Which gastric secretion converts pepsinogen to pepsin?", options: ["Intrinsic factor","Mucus","Gastrin","Hydrochloric acid (HCl)"], correct: 3 },
    { id: 1309, question: "What is the pH level of gastric HCl secreted by gastric glands?", options: ["pH = 7 (neutral)","pH = 2 (highly acidic)","pH = 10 (alkaline)","pH = 5 (mildly acidic)"], correct: 1 },
    { id: 1310, question: "Which hormone stimulates the production of HCl and pepsinogen?", options: ["Insulin","Secretin","Gastrin","Cholecystokinin"], correct: 2 },
    { id: 1311, question: "Where is the liver located in the abdominal cavity?", options: ["Lower left quadrant (LLQ)","Upper right quadrant (URQ)","Lower right quadrant (LRQ)","Upper left quadrant (ULQ)"], correct: 1 },
    { id: 1312, question: "How are hepatocytes arranged within the liver?", options: ["In random clusters throughout the organ","In linear chains along blood vessels","In small lobes called lobules with radiating cell plates","In concentric circles around the bile ducts"], correct: 2 },
    { id: 1313, question: "Which liver function involves phagocytosis of foreign materials?", options: ["Synthesis of plasma proteins","Removal of foreign materials and microbes from the GI tract","Maintenance of blood glucose levels","Detoxification of drugs and chemicals"], correct: 1 },
    { id: 1314, question: "Which vitamins does the liver store?", options: ["Vitamins C, E, and B1 only","Vitamins A, B6, B12, D, K, and folic acid","Only fat-soluble vitamins A, D, E, and K","All B-complex vitamins exclusively"], correct: 1 },
    { id: 1315, question: "The liver maintains blood glucose through which three processes?", options: ["Absorption, secretion, and elimination","Filtration, reabsorption, and excretion","Glycogenesis, glycogenolysis, and gluconeogenesis","Hydrolysis, synthesis, and phosphorylation"], correct: 2 },
    { id: 1316, question: "What components make up bile?", options: ["Enzymes, hormones, and antibodies","Water, salts, conjugated bilirubin, cholesterol, and electrolytes","Proteins, lipids, and nucleic acids","Glucose, amino acids, and fatty acids"], correct: 1 },
    { id: 1317, question: "Bile is necessary for the emulsification of:", options: ["Proteins and amino acids","Carbohydrates and sugars","Fats and fat-soluble vitamins (A, D, E, K)","Water-soluble vitamins and minerals"], correct: 2 },
    { id: 1318, question: "Where is the pancreas located in relation to the stomach?", options: ["In front of the stomach","Behind the stomach","Below the stomach","To the right of the stomach"], correct: 1 },
    { id: 1319, question: "What type of enzymes do the exocrine glands of the pancreas secrete?", options: ["Insulin, glucagon, and somatostatin","Bile salts, bilirubin, and cholesterol","Gastrin, secretin, and cholecystokinin","Trypsin, chymotrypsin, amylase, and lipase"], correct: 3 },
    { id: 1320, question: "What do the islets of Langerhans in the pancreas release?", options: ["Digestive enzymes into the duodenum","Insulin and glucagon into the bloodstream","Bile into the gallbladder","Mucus into the stomach"], correct: 1 },
    { id: 1321, question: "What are the three sections of the small intestine?", options: ["Cecum, ascending colon, and transverse colon","Fundus, body, and pylorus","Duodenum, jejunum, and ileum","Cardiac, fundic, and pyloric regions"], correct: 2 },
    { id: 1322, question: "In which section of the small intestine is chyme mixed with pancreatic enzymes and bile?", options: ["Ileum","Jejunum","Duodenum","Cecum"], correct: 2 },
    { id: 1323, question: "What structures in the jejunum greatly increase the absorptive surface area?", options: ["Rugae and gastric pits","Haustra and taeniae coli","Villi and microvilli","Crypts and nodes"], correct: 2 },
    { id: 1324, question: "The ileum is the main site of absorption of which specific nutrients?", options: ["Carbohydrates and simple sugars","Proteins and amino acids","Vitamin B12 and bile","Water and electrolytes"], correct: 2 },
    { id: 1325, question: "What are the main components of the large intestine?", options: ["Duodenum, jejunum, and ileum","Fundus, body, and antrum","Cecum, colon (ascending, transverse, descending, sigmoid), rectum, and anal canal","Cardia, pylorus, and sphincter"], correct: 2 },
    { id: 1326, question: "What is the primary function of the colon?", options: ["Secretion of digestive enzymes","Absorption of water and electrolytes","Production of bile and bilirubin","Mechanical breakdown of food"], correct: 1 },
    { id: 1327, question: "Which vitamin do resident bacteria in the colon synthesize?", options: ["Vitamin C","Vitamin B12","Vitamin D","Vitamin K"], correct: 3 },
    { id: 1328, question: "What effect does increased fiber in the intestine have?", options: ["Decreases motility and slows passage rate","Increases acidity and enzyme production","Increases motility and rate of passage","Reduces water absorption and causes dehydration"], correct: 2 },
    { id: 1329, question: "How does sympathetic nervous system (SANS) stimulation affect GI activity?", options: ["Increases peristalsis and secretions","Inhibits GI activity","Has no effect on digestion","Enhances nutrient absorption"], correct: 1 },
    { id: 1330, question: "What effect does parasympathetic nervous system (PANS) activation have on digestion?", options: ["Inhibits all digestive processes","Only affects saliva production","Increases peristalsis and secretions","Decreases blood flow to digestive organs"], correct: 2 },
    { id: 1331, question: "Where are carbohydrates digested in the digestive system?", options: ["Only in the stomach","In the mouth and intestine","Exclusively in the small intestine","In the esophagus and colon"], correct: 1 },
    { id: 1332, question: "Where are carbohydrates absorbed after digestion?", options: ["In the stomach and duodenum","In the oral cavity and esophagus","In the jejunum and ileum","In the colon and rectum"], correct: 2 },
    { id: 1333, question: "Where does protein digestion begin?", options: ["In the mouth with salivary amylase","In the colon with bacterial enzymes","In the stomach and intestine with pepsin and other enzymes","In the liver with bile salts"], correct: 2 },
    { id: 1334, question: "What is the first step in lipid digestion?", options: ["Absorption by intestinal villi","Emulsification by bile in the small intestine","Breakdown by stomach acid","Conversion to glucose in the liver"], correct: 1 },
    { id: 1335, question: "Where can very small lipid-soluble molecules like alcohol be absorbed?", options: ["Only in the small intestine","Only in the colon","From the empty stomach","Exclusively in the duodenum"], correct: 2 },
    { id: 1336, question: "How are fat-soluble vitamins absorbed?", options: ["Through active transport in the colon","By diffusion in the stomach","With fats in the small intestine","Via receptor-mediated endocytosis"], correct: 2 },
    { id: 1337, question: "How are water-soluble vitamins, electrolytes, and minerals absorbed?", options: ["Through emulsification with bile","By diffusion into the blood","Via lymphatic vessels only","Through bacterial synthesis"], correct: 1 },
    { id: 1338, question: "Where are drugs mainly absorbed in the digestive system?", options: ["In the stomach","In the mouth","In the intestine","In the colon"], correct: 2 },
    { id: 1339, question: "What is anorexia in the context of digestive disorders?", options: ["An eating disorder with binge-purge cycles","Loss of appetite that may precede nausea and vomiting","Excessive hunger and overeating","Inability to swallow solid foods"], correct: 1 },
    { id: 1340, question: "Nausea is best described as:", options: ["The forceful expulsion of stomach contents","A loss of appetite and food aversion","An unpleasant subjective feeling stimulated by irritation or inflammation","Excessive production of saliva"], correct: 2 },
    { id: 1341, question: "What typically accompanies nausea?", options: ["Increased appetite and energy","Constipation and bloating","Pallor, sweating, and tachycardia","Fever and chills only"], correct: 2 },
    { id: 1342, question: "Vomiting (emesis) is best characterized as:", options: ["A mild sensation of discomfort","The forceful expulsion of chyme from the stomach and/or intestine","Difficulty swallowing solid foods","Excessive gas production in the intestines"], correct: 1 },
    { id: 1343, question: "What is bulimia characterized by?", options: ["Complete loss of appetite with severe weight loss","Excessive overeating followed by purging with fear of weight gain","Normal eating patterns with digestive issues","Inability to digest certain food groups"], correct: 1 },
    { id: 1344, question: "What characterizes diarrhea?", options: ["Hard, dry stools passed infrequently","Normal bowel movements with mild discomfort","Excessive frequency of loose or watery stools","Complete absence of bowel movements"], correct: 2 },
    { id: 1345, question: "What symptoms commonly accompany diarrhea?", options: ["Increased energy and improved appetite","Constipation and abdominal distension","Nausea, vomiting, abdominal cramps, and flatulence","Weight gain and bloating only"], correct: 2 },
    { id: 1346, question: "Which type of diarrhea is usually caused by infections?", options: ["Osmotic diarrhea","Large-volume diarrhea","Small-volume diarrhea","Secretory diarrhea"], correct: 1 },
    { id: 1347, question: "What condition results from prolonged diarrhea?", options: ["Hypertension and edema","Dehydration, acidosis, and hypokalemia","Hyperglycemia and hypercalcemia","Weight gain and bloating"], correct: 1 },
    { id: 1348, question: "What characterizes constipation?", options: ["Excessive frequency of loose stools","Infrequent passage of hard, dry stool","Normal bowel movements with mild pain","Immediate passage of watery stools"], correct: 1 },
    { id: 1349, question: "What is the term for blood in the stool that is not visible to the naked eye?", options: ["Hematemesis","Melena","Occult blood","Hematochezia"], correct: 2 },
    { id: 1350, question: "What causes congenital defects like cleft lip and cleft palate?", options: ["Bacterial infections during pregnancy","Failure of maxillary and median nasal processes to fuse during the second or third month of gestation","Vitamin deficiency in the mother","Trauma during childbirth"], correct: 1 },
    { id: 1351, question: "What are aphthous ulcers commonly known as?", options: ["Cold sores","Canker sores","Fever blisters","Oral thrush"], correct: 1 },
    { id: 1352, question: "What causes aphthous ulcers?", options: ["Bacterial infection requiring antibiotics","Stress, trauma, immune deficiency, and allergies","Fungal overgrowth in the mouth","Viral infection from HSV-1"], correct: 1 },
    { id: 1353, question: "How are aphthous ulcers treated?", options: ["Surgical removal","Spontaneous recovery, topical medications, avoid irritants","Antifungal medications","Long-term antibiotics"], correct: 1 },
    { id: 1354, question: "What causes oral candidiasis (thrush)?", options: ["Streptococcus mutans","Herpes simplex virus","Candida albicans","Escherichia coli"], correct: 2 },
    { id: 1355, question: "Candida albicans is normally found:", options: ["Only in diseased individuals","As normal flora of oral cavity, upper respiratory, and GI tracts","Exclusively in immunocompromised patients","Only in newborn infants"], correct: 1 },
    { id: 1356, question: "Which medication is used to treat oral candidiasis?", options: ["Acyclovir","Nystatin (antifungal)","Penicillin","Ibuprofen"], correct: 1 },
    { id: 1357, question: "What causes HSV-1 (herpes simplex) oral lesions?", options: ["Bacterial infection","Fungal infection","Viral infection by HSV-1","Allergic reaction"], correct: 2 },
    { id: 1358, question: "Where does HSV-1 virus remain dormant after recovery?", options: ["In the oral mucosa","In the lymph nodes","In trigeminal ganglions","In salivary glands"], correct: 2 },
    { id: 1359, question: "Which medication is used to treat HSV-1 infections?", options: ["Nystatin","Acyclovir (antiviral)","Amoxicillin","Metronidazole"], correct: 1 },
    { id: 1360, question: "What causes syphilis?", options: ["Herpes simplex virus","Candida albicans","Treponema pallidum (spirochete bacteria)","Streptococcus pyogenes"], correct: 2 },
    { id: 1361, question: "What characterizes the primary stage of syphilis?", options: ["Painful oral ulcers with pus","Painless chancre (hard ulcer)","Widespread skin rash","Neurological symptoms"], correct: 1 },
    { id: 1362, question: "Which bacteria initiates dental caries?", options: ["Staphylococcus aureus","Streptococcus mutans","Escherichia coli","Candida albicans"], correct: 1 },
    { id: 1363, question: "What substance is produced by bacteria that causes dental caries?", options: ["Bile acid","Lactic acid","Hydrochloric acid","Uric acid"], correct: 1 },
    { id: 1364, question: "Which mineral is highly protective against tooth decay?", options: ["Calcium","Iron","Fluoride","Magnesium"], correct: 2 },
    { id: 1365, question: "What are periodontal diseases?", options: ["Cavities in tooth enamel","Infections affecting gingivae and bone supporting teeth","Viral infections of the oral mucosa","Congenital tooth defects"], correct: 1 },
    { id: 1366, question: "What causes ANUG (acute necrotizing ulcerative gingivitis)?", options: ["Aerobic bacteria","Fungal infection","Anaerobic bacteria combined with poor hygiene","Viral infection"], correct: 2 },
    { id: 1367, question: "What is leukoplakia?", options: ["White patches on oral mucosa that may become malignant","Painful canker sores","Fungal infection of the mouth","Viral cold sores"], correct: 0 },
    { id: 1368, question: "Leukoplakia may lead to which serious condition?", options: ["Periodontal disease","Dental caries","Squamous cell carcinoma","Oral candidiasis"], correct: 2 },
    { id: 1369, question: "What causes acute gastritis?", options: ["Only bacterial infections","Irritants like ASA, alcohol, radiation, chemotherapy, spicy food","Vitamin deficiency alone","Excessive water intake"], correct: 1 },
    { id: 1370, question: "Common symptoms of acute gastritis include:", options: ["Increased appetite and weight gain","Painless digestion","Anorexia, nausea, vomiting, hematemesis, abdominal cramps, fever, and diarrhea","Constipation and bloating only"], correct: 2 },
    { id: 1371, question: "What characterizes chronic gastritis?", options: ["Sudden onset with severe pain","Atrophy of stomach mucosa with loss of secretory glands","Excessive acid production","Rapid healing without treatment"], correct: 1 },
    { id: 1372, question: "Chronic gastritis may be associated with:", options: ["Increased exercise and stress only","Peptic ulcers, alcoholism, autoimmune diseases, and H. pylori infection","Vitamin deficiency alone","Excessive water intake"], correct: 1 },
    { id: 1373, question: "What defines gastroenteritis?", options: ["Inflammation of the esophagus only","Inflammation of the stomach and intestines","Infection of the liver and pancreas","Cancer of the digestive tract"], correct: 1 },
    { id: 1374, question: "Which organisms commonly cause gastroenteritis?", options: ["Only viral pathogens","S. aureus, E. coli, Salmonella, Rotavirus, Listeria, C. botulinum, C. perfringens, E. histolytica, Campylobacter","Only parasitic organisms","Exclusively fungal infections"], correct: 1 },
    { id: 1375, question: "Where do peptic ulcers primarily occur?", options: ["Only in the esophagus","Duodenum, esophagus, or stomach","Exclusively in the large intestine","Only in the oral cavity"], correct: 1 },
    { id: 1376, question: "Peptic ulcers initially appear as:", options: ["Large bleeding wounds","Small cavities penetrating the submucosa","Surface scratches only","Bacterial colonies"], correct: 1 },
    { id: 1377, question: "Which bacterium is a major etiological factor in peptic ulcers?", options: ["Streptococcus mutans","Escherichia coli","Helicobacter pylori","Candida albicans"], correct: 2 },
    { id: 1378, question: "Which medications contribute to peptic ulcer development?", options: ["Antibiotics only","Antacids exclusively","Nonsteroidal anti-inflammatory drugs (NSAIDs) like ibuprofen","Vitamins and minerals"], correct: 2 },
    { id: 1379, question: "What are common symptoms of peptic ulcers?", options: ["Increased appetite and weight gain","Nausea, anorexia, vomiting, weight loss, and malaise","Constipation and bloating only","Excessive energy and alertness"], correct: 1 },
    { id: 1380, question: "Treatment for peptic ulcers includes:", options: ["Only dietary changes","Antibiotics, acid reducers like omeprazole and cimetidine, and sometimes surgery","Increased stress management alone","Vitamin supplements exclusively"], correct: 1 },
    { id: 1381, question: "What surgical procedures may be necessary for severe peptic ulcers?", options: ["Appendectomy and cholecystectomy","Liver transplant and splenectomy","Vagotomy and partial gastrectomy","Tonsillectomy and adenoidectomy"], correct: 2 },
    { id: 1382, question: "The GI tract consists of a hollow tube extending from mouth to anus.", options: ["True","False"], correct: 0 },
    { id: 1383, question: "The peritoneum covers the inferior surface of the bladder and uterus.", options: ["True","False"], correct: 1 },
    { id: 1384, question: "Saliva begins the digestion of proteins in the oral cavity.", options: ["True","False"], correct: 1 },
    { id: 1385, question: "Swallowing (deglutition) is a voluntary activity.", options: ["True","False"], correct: 1 },
    { id: 1386, question: "Gastric glands secrete HCl with a pH of approximately 2.", options: ["True","False"], correct: 0 },
    { id: 1387, question: "Pepsinogen is converted to pepsin in the presence of HCl.", options: ["True","False"], correct: 0 },
    { id: 1388, question: "The liver is located in the upper left quadrant (ULQ).", options: ["True","False"], correct: 1 },
    { id: 1389, question: "The liver stores vitamins A, B6, B12, D, K, and folic acid.", options: ["True","False"], correct: 0 },
    { id: 1390, question: "Bile contains digestive enzymes that break down proteins.", options: ["True","False"], correct: 1 },
    { id: 1391, question: "The pancreas contains both exocrine and endocrine components.", options: ["True","False"], correct: 0 },
    { id: 1392, question: "The ileum is the main site of vitamin B12 and bile absorption.", options: ["True","False"], correct: 0 },
    { id: 1393, question: "The colon is responsible for secreting digestive enzymes.", options: ["True","False"], correct: 1 },
    { id: 1394, question: "Resident bacteria in the colon synthesize vitamin K.", options: ["True","False"], correct: 0 },
    { id: 1395, question: "Sympathetic nervous system activation increases GI peristalsis.", options: ["True","False"], correct: 1 },
    { id: 1396, question: "Carbohydrates are digested in the mouth and intestine.", options: ["True","False"], correct: 0 },
    { id: 1397, question: "Protein digestion begins in the oral cavity.", options: ["True","False"], correct: 1 },
    { id: 1398, question: "Lipids are emulsified by bile in the small intestine.", options: ["True","False"], correct: 0 },
    { id: 1399, question: "Fat-soluble vitamins are absorbed with fats.", options: ["True","False"], correct: 0 },
    { id: 1400, question: "Water is absorbed through active transport.", options: ["True","False"], correct: 1 },
    { id: 1401, question: "Anorexia is defined as excessive appetite and overeating.", options: ["True","False"], correct: 1 },
    { id: 1402, question: "Vomiting is considered a defense mechanism.", options: ["True","False"], correct: 0 },
    { id: 1403, question: "Diarrhea is always caused by bacterial infections.", options: ["True","False"], correct: 1 },
    { id: 1404, question: "Steatorrhea is characterized by fatty stools due to malabsorption.", options: ["True","False"], correct: 0 },
    { id: 1405, question: "Cleft lip and cleft palate originate in the second or third month of gestation.", options: ["True","False"], correct: 0 },
    { id: 1406, question: "Aphthous ulcers require surgical intervention.", options: ["True","False"], correct: 1 },
    { id: 1407, question: "Candida albicans is a normal flora of the oral cavity.", options: ["True","False"], correct: 0 },
    { id: 1408, question: "Nystatin is used to treat HSV-1 infections.", options: ["True","False"], correct: 1 },
    { id: 1409, question: "HSV-1 remains dormant in trigeminal ganglions after recovery.", options: ["True","False"], correct: 0 },
    { id: 1410, question: "The primary stage of syphilis features painful oral ulcers.", options: ["True","False"], correct: 1 },
    { id: 1411, question: "Streptococcus mutans initiates dental caries.", options: ["True","False"], correct: 0 },
    { id: 1412, question: "Fluoride is highly protective against tooth decay.", options: ["True","False"], correct: 0 },
    { id: 1413, question: "Periodontal diseases only affect the gums and never the bone.", options: ["True","False"], correct: 1 },
    { id: 1414, question: "ANUG is caused by aerobic bacteria.", options: ["True","False"], correct: 1 },
    { id: 1415, question: "Leukoplakia may lead to squamous cell carcinoma in severe cases.", options: ["True","False"], correct: 0 },
    { id: 1416, question: "Acute gastritis may be caused by radiation and chemotherapy.", options: ["True","False"], correct: 0 },
    { id: 1417, question: "Chronic gastritis is characterized by sudden onset with severe symptoms.", options: ["True","False"], correct: 1 },
    { id: 1418, question: "Helicobacter pylori is associated with chronic gastritis.", options: ["True","False"], correct: 0 },
    { id: 1419, question: "Gastroenteritis affects only the stomach.", options: ["True","False"], correct: 1 },
    { id: 1420, question: "Peptic ulcers can occur in the duodenum, esophagus, or stomach.", options: ["True","False"], correct: 0 },
    { id: 1421, question: "NSAIDs like ibuprofen are protective against peptic ulcers.", options: ["True","False"], correct: 1 },
    { id: 1422, question: "Smoking is a risk factor for peptic ulcer development.", options: ["True","False"], correct: 0 },
    { id: 1423, question: "Omeprazole and cimetidine are used to reduce gastric acid.", options: ["True","False"], correct: 0 },
    { id: 1424, question: "Vagotomy may be necessary for severe peptic ulcers.", options: ["True","False"], correct: 0 },
    { id: 1425, question: "The parasympathetic nervous system inhibits GI activity.", options: ["True","False"], correct: 1 }
  ],
  ...
  "7. Cardiovascular System (Part 2)": [
    ...
    { id: 1430, question: "Which factor is most likely to increase heart rate?", options: ["Decreased thyroid hormone levels","Reduced environmental temperature","Parasympathetic stimulation","Physical exercise"], correct: 3 },
    { id: 1431, question: "Coronary circulation refers to blood flow through:", options: ["Pulmonary vessels supplying the lungs","Vessels supplying the heart muscle","Major veins returning blood to the heart","Systemic arteries supplying the body"], correct: 1 },
    { id: 1432, question: "The left coronary artery divides into which two branches?", options: ["Right marginal and posterior interventricular arteries","Anterior interventricular and left circumflex arteries","Pulmonary and aortic branches","Superior and inferior cardiac branches"], correct: 1 },
    { id: 1433, question: "Systole is best described as:", options: ["Ventricular relaxation and filling","Atrial relaxation only","Cardiac contraction of atria and ventricles","Passive blood flow into ventricles"], correct: 2 },
    { id: 1434, question: "The “lubb” heart sound is produced by closure of the:", options: ["Semilunar valves during diastole","AV valves during systole","Aortic valve during systole","Pulmonary valve during diastole"], correct: 1 },
    { id: 1435, question: "Cardiac output is defined as:", options: ["Blood volume remaining after contraction","Pressure exerted on arterial walls","Blood ejected by a ventricle per minute","Blood returning to the heart per minute"], correct: 2 },
    { id: 1436, question: "Which equation correctly represents cardiac output?", options: ["CO = BP × HR","CO = SV ÷ HR","CO = HR × SV","CO = BP ÷ SV"], correct: 2 },
    { id: 1437, question: "The higher number in a blood pressure reading represents:", options: ["Diastolic pressure during relaxation","Systolic pressure during ejection","Mean arterial pressure","Venous return pressure"], correct: 1 },
    { id: 1438, question: "Peripheral resistance is best described as:", options: ["Blood viscosity in capillaries","Friction between blood and vessel walls","Elastic recoil of arteries","Resistance within the heart chambers"], correct: 1 },
    { id: 1439, question: "Which condition involves lipid-containing plaques in large arteries?", options: ["Arteriosclerosis","Aneurysm","Atherosclerosis","Thrombosis"], correct: 2 },
    { id: 1440, question: "Low-density lipoprotein (LDL) is considered harmful because it:", options: ["Removes cholesterol from tissues","Transports cholesterol to the liver","Promotes atheroma formation","Decreases arterial plaque formation"], correct: 2 },
    { id: 1441, question: "Which is a non-modifiable risk factor for atherosclerosis?", options: ["Smoking","Obesity","Diabetes","Age"], correct: 3 },
    { id: 1442, question: "Angina pectoris is primarily caused by:", options: ["Total coronary artery obstruction","Oxygen deficiency of heart muscle","Infection of the myocardium","Congenital valve malformation"], correct: 1 },
    { id: 1443, question: "Which symptom is commonly associated with angina pectoris?", options: ["Peripheral edema","Chest pain radiating to left arm","Cyanosis of lips","Severe hypotension"], correct: 1 },
    { id: 1444, question: "Myocardial infarction is best defined as:", options: ["Partial narrowing of coronary arteries","Temporary oxygen deficiency","Total obstruction of a coronary artery","Inflammation of heart muscle"], correct: 2 },
    { id: 1445, question: "Which complication may follow myocardial infarction?", options: ["Cardiac arrhythmias","Cardiogenic shock","Congestive heart failure","All of the above"], correct: 3 },
    { id: 1446, question: "Which tool is most useful for diagnosing arrhythmias?", options: ["Chest X-ray","Blood pressure cuff","Electrocardiogram","Echocardiogram only"], correct: 2 },
    { id: 1447, question: "Which arrhythmia is characterized by absence of ventricular contraction?", options: ["First-degree heart block","Second-degree heart block","Ventricular tachycardia","Total heart block"], correct: 3 },
    { id: 1448, question: "Cardiac arrest is defined as:", options: ["Rapid ventricular contraction","Partial interruption of conduction","Complete cessation of heart activity","Reduced stroke volume"], correct: 2 },
    { id: 1449, question: "Congestive heart failure occurs when the heart:", options: ["Pumps blood too rapidly","Cannot meet metabolic demands","Develops abnormal rhythms","Becomes inflamed"], correct: 1 },
    { id: 1450, question: "Left-sided heart failure commonly leads to:", options: ["Peripheral edema","Ascites","Pulmonary congestion","Jugular vein distention"], correct: 2 },
    { id: 1451, question: "Right-sided heart failure is commonly associated with:", options: ["Pulmonary edema","Dependent peripheral edema","Paroxysmal nocturnal dyspnea","Dry cough"], correct: 1 },
    { id: 1452, question: "Congenital heart defects primarily result in:", options: ["Increased oxygen delivery","Reduced tissue oxygen supply","Elevated blood pressure","Increased cardiac output"], correct: 1 },
    { id: 1453, question: "Acyanotic congenital heart defects are characterized by:", options: ["Mixing of venous and arterial blood","Complete lack of oxygenated blood","Reduced amount of oxygenated blood","Total obstruction of blood flow"], correct: 2 },
    { id: 1454, question: "Rheumatic fever usually develops after infection with:", options: ["Staphylococcus aureus","Streptococcus viridans","Streptococcus pyogenes","Escherichia coli"], correct: 2 },
    { id: 1455, question: "Which organism commonly causes acute infective endocarditis?", options: ["Streptococcus viridans","Streptococcus pyogenes","Staphylococcus aureus","Enterococcus faecalis"], correct: 2 },
    { id: 1456, question: "Acute pericarditis is characterized by:", options: ["Silent progression without pain","Fibrous enclosure of the heart","Chest pain due to inflamed pericardium","Valve incompetency"], correct: 2 },
    { id: 1457, question: "Primary hypertension is best described as:", options: ["Caused by kidney failure","Secondary to endocrine disorders","Idiopathic with no known cause","Always malignant in nature"], correct: 2 },
    { id: 1458, question: "TRUE / FALSE QUESTIONS The myocardium contains no nerves.", options: ["True","False"], correct: 0 },
    { id: 1459, question: "The T wave on an ECG represents ventricular repolarization.", options: ["True","False"], correct: 0 },
    { id: 1460, question: "Baroreceptors detect changes in blood pressure.", options: ["True","False"], correct: 0 },
    { id: 1461, question: "HDL transports cholesterol from the liver to peripheral tissues.", options: ["True","False"], correct: 1 },
    { id: 1462, question: "Myocardial infarction damage may be reversible if blood flow is restored quickly.", options: ["True","False"], correct: 0 },
    { id: 1463, question: "ECG is not useful in diagnosing cardiac arrhythmias.", options: ["True","False"], correct: 1 },
    { id: 1464, question: "Left-sided heart failure commonly causes pulmonary edema.", options: ["True","False"], correct: 0 },
    { id: 1465, question: "Congenital heart defects develop after birth.", options: ["True","False"], correct: 1 },
    { id: 1466, question: "Pericarditis may involve fluid accumulation in the pericardial sac.", options: ["True","False"], correct: 0 },
    { id: 1467, question: "Lifestyle modification is an important treatment strategy for hypertension.", options: ["True","False"], correct: 0 }
  ],
  ...
  "8. Respiratory System Disorders (Part 2)": [
    ...
    { id: 1472, question: "The nasopharynx is best described as:", options: ["A passage connecting oral cavity and larynx","The upper pharynx above the soft palate","A lymphoid tissue in the throat","A cartilage that prevents aspiration"], correct: 1 },
    { id: 1473, question: "Which tonsils are located at the base of the tongue?", options: ["Palatine","Pharyngeal","Lingual","Maxillary"], correct: 2 },
    { id: 1474, question: "The epiglottis primarily:", options: ["Produces vocal sounds","Filters inhaled air","Covers the trachea during swallowing","Contracts during expiration"], correct: 2 },
    { id: 1475, question: "The larynx is responsible for:", options: ["Gas exchange only","Blood filtration","Voice production and airway protection","Oxygen transport"], correct: 2 },
    { id: 1476, question: "The trachea is composed mainly of:", options: ["Bone and cartilage","Fibroelastic tissue with smooth muscle","Skeletal muscle fibers","Alveolar epithelium"], correct: 1 },
    { id: 1477, question: "Which bronchus is wider and more vertical?", options: ["Left main bronchus","Secondary bronchus","Right main bronchus","Bronchiole"], correct: 2 },
    { id: 1478, question: "Bronchodilation occurs primarily due to:", options: ["Parasympathetic stimulation","Sympathetic stimulation","Increased mucus secretion","Reduced alveolar pressure"], correct: 1 },
    { id: 1479, question: "Gas exchange occurs across the:", options: ["Pleural membrane","Bronchial wall","Respiratory membrane","Tracheal lining"], correct: 2 },
    { id: 1480, question: "Surfactant functions to:", options: ["Destroy pathogens in alveoli","Reduce surface tension in alveoli","Increase mucus viscosity","Enhance ciliary movement"], correct: 1 },
    { id: 1481, question: "The right lung has how many lobes?", options: ["One","Two","Three","Four"], correct: 2 },
    { id: 1482, question: "During inspiration, the diaphragm:", options: ["Relaxes and ascends","Contracts and descends","Remains stationary","Expands laterally"], correct: 1 },
    { id: 1483, question: "Hypoxemia refers to:", options: ["Increased blood carbon dioxide","Decreased blood oxygen","Increased blood oxygen","Decreased blood bicarbonate"], correct: 1 },
    { id: 1484, question: "Hypercapnia leads to:", options: ["Respiratory alkalosis","Metabolic alkalosis","Respiratory acidosis","Metabolic acidosis"], correct: 2 },
    { id: 1485, question: "Most oxygen is transported in blood:", options: ["Dissolved in plasma","Bound to hemoglobin","As bicarbonate ions","Attached to platelets"], correct: 1 },
    { id: 1486, question: "Carbon dioxide is mainly transported as:", options: ["Dissolved gas","Carbaminohemoglobin","Bicarbonate ions","Carbonic acid"], correct: 2 },
    { id: 1487, question: "Yellow-green sputum usually indicates:", options: ["Viral infection","Pulmonary edema","Bacterial infection","Asthma"], correct: 2 },
    { id: 1488, question: "Wheezing suggests obstruction of:", options: ["Upper airways","Large bronchi","Small airways","Alveoli"], correct: 2 },
    { id: 1489, question: "Clubbing of fingers occurs due to:", options: ["Acute inflammation","Chronic hypoxia","Viral infection","Allergic response"], correct: 1 },
    { id: 1490, question: "The most common cause of the common cold is:", options: ["Adenovirus","Rhinovirus","Influenza virus","Coronavirus only"], correct: 1 },
    { id: 1491, question: "Sinusitis is most commonly caused by:", options: ["Viral infection only","Obstruction from bacteria or allergy","Trauma to nasal septum","Fungal overgrowth"], correct: 1 },
    { id: 1492, question: "Croup primarily affects:", options: ["Elderly adults","Adolescents","Children aged 1–2 years","Newborns only"], correct: 2 },
    { id: 1493, question: "The most serious complication of influenza is:", options: ["Bronchitis","Sinusitis","Pneumonia","Otitis media"], correct: 2 },
    { id: 1494, question: "Scarlet fever is caused by:", options: ["Staphylococcus aureus","Streptococcus pneumoniae","Streptococcus pyogenes","Mycoplasma pneumoniae"], correct: 2 },
    { id: 1495, question: "Lobar pneumonia is most commonly caused by:", options: ["Haemophilus influenzae","Staphylococcus aureus","Streptococcus pneumoniae","Legionella pneumophila"], correct: 2 },
    { id: 1496, question: "Bronchopneumonia usually affects:", options: ["One lung lobe","Both lungs diffusely","Only upper lobes","Only alveolar sacs"], correct: 1 },
    { id: 1497, question: "Legionnaires’ disease is associated with:", options: ["Viral pneumonia","Nosocomial infection","Pediatric asthma","Fungal infection"], correct: 1 },
    { id: 1498, question: "Tuberculosis is caused by:", options: ["Mycoplasma pneumoniae","Mycobacterium tuberculosis","Streptococcus pyogenes","Legionella pneumophila"], correct: 1 },
    { id: 1499, question: "A tubercle is best described as:", options: ["Caseous necrosis only","A granuloma containing live bacilli","A calcified lymph node","A lung cavity"], correct: 1 },
    { id: 1500, question: "Secondary tuberculosis occurs due to:", options: ["New exposure only","Reactivation of dormant bacteria","Viral superinfection","Antibiotic resistance alone"], correct: 1 },
    { id: 1501, question: "COVID-19 is caused by:", options: ["SARS-CoV","MERS-CoV","SARS-CoV-2","OC43 coronavirus"], correct: 2 },
    { id: 1502, question: "Which variant was first identified in India?", options: ["Alpha","Beta","Gamma","Delta"], correct: 3 },
    { id: 1503, question: "PCR testing for COVID-19 detects:", options: ["Viral proteins","Antibodies","Genetic material","Host enzymes"], correct: 2 },
    { id: 1504, question: "Cystic fibrosis primarily affects:", options: ["Smooth muscles only","Exocrine glands","Blood vessels","Alveolar macrophages"], correct: 1 },
    { id: 1505, question: "Asthma is characterized by:", options: ["Irreversible airway obstruction only","Periodic reversible bronchoconstriction","Alveolar destruction","Loss of surfactant"], correct: 1 },
    { id: 1506, question: "Extrinsic asthma is associated with:", options: ["Type IV hypersensitivity","IgE-mediated allergy","Bacterial infection","Genetic mutation only"], correct: 1 },
    { id: 1507, question: "TRUE / FALSE QUESTIONS The nasal passages help warm and filter inhaled air.", options: ["True","False"], correct: 0 },
    { id: 1508, question: "The ciliary escalator moves mucus downward into the lungs.", options: ["True","False"], correct: 1 },
    { id: 1509, question: "Surfactant reduces alveolar surface tension.", options: ["True","False"], correct: 0 },
    { id: 1510, question: "Hyperventilation causes hypercapnia.", options: ["True","False"], correct: 1 },
    { id: 1511, question: "Hemoptysis refers to coughing up blood.", options: ["True","False"], correct: 0 },
    { id: 1512, question: "Pneumonia may involve fluid-filled alveoli.", options: ["True","False"], correct: 0 },
    { id: 1513, question: "Tuberculosis is transmitted primarily by respiratory droplets.", options: ["True","False"], correct: 0 },
    { id: 1514, question: "COVID-19 was declared a pandemic in 2020.", options: ["True","False"], correct: 0 },
    { id: 1515, question: "Cystic fibrosis is an autosomal recessive disorder.", options: ["True","False"], correct: 0 },
    { id: 1516, question: "Asthma can lead to hypoxia if untreated.", options: ["True","False"], correct: 0 }
  ],
  ...
  "9. Digestive System Disorders (Part 2)": [
    ...
    { id: 1521, question: "Saliva contributes to digestion mainly by:", options: ["Digesting proteins","Digesting fats","Initiating carbohydrate digestion","Absorbing nutrients"], correct: 2 },
    { id: 1522, question: "Deglutition refers to:", options: ["Chewing of food","Swallowing of food","Digestion of proteins","Absorption of nutrients"], correct: 1 },
    { id: 1523, question: "Peristalsis is best described as:", options: ["Random contraction of intestinal muscles","Voluntary movement of food","Wave-like muscular contractions","Passive diffusion of nutrients"], correct: 2 },
    { id: 1524, question: "The stomach primarily functions as:", options: ["A site of nutrient absorption","A reservoir for food and fluid","A bile storage organ","A hormone-producing gland"], correct: 1 },
    { id: 1525, question: "Rugae are:", options: ["Digestive enzymes","Gastric folds of the stomach wall","Intestinal villi","Hepatic lobules"], correct: 1 },
    { id: 1526, question: "Pepsinogen is converted to pepsin in the presence of:", options: ["Bile salts","Water","Hydrochloric acid","Amylase"], correct: 2 },
    { id: 1527, question: "Gastrin primarily stimulates secretion of:", options: ["Bile and insulin","HCl and pepsinogen","Mucus and bicarbonate","Trypsin and lipase"], correct: 1 },
    { id: 1528, question: "The liver is located mainly in the:", options: ["Upper left quadrant","Lower right quadrant","Upper right quadrant","Lower left quadrant"], correct: 2 },
    { id: 1529, question: "Hepatic lobules are organized around:", options: ["Portal triads only","Central veins","Bile ducts","Sinusoids only"], correct: 1 },
    { id: 1530, question: "Which is NOT a function of the liver?", options: ["Detoxification of drugs","Production of bile","Storage of vitamins","Secretion of insulin"], correct: 3 },
    { id: 1531, question: "Bile is essential for:", options: ["Protein digestion","Emulsification of fats","Carbohydrate absorption","Water reabsorption"], correct: 1 },
    { id: 1532, question: "The pancreas has both:", options: ["Mechanical and absorptive roles","Endocrine and exocrine functions","Digestive and excretory functions","Storage and filtration roles"], correct: 1 },
    { id: 1533, question: "Which pancreatic hormone lowers blood glucose?", options: ["Glucagon","Insulin","Somatostatin","Gastrin"], correct: 1 },
    { id: 1534, question: "The small intestine consists of the:", options: ["Duodenum, jejunum, and ileum","Cecum, colon, and rectum","Stomach, pylorus, and duodenum","Ileum, colon, and rectum"], correct: 0 },
    { id: 1535, question: "Most nutrient absorption occurs in the:", options: ["Duodenum","Jejunum","Ileum","Colon"], correct: 1 },
    { id: 1536, question: "Vitamin B12 is mainly absorbed in the:", options: ["Duodenum","Jejunum","Ileum","Colon"], correct: 2 },
    { id: 1537, question: "The large intestine primarily absorbs:", options: ["Proteins and fats","Vitamins and enzymes","Water and electrolytes","Carbohydrates"], correct: 2 },
    { id: 1538, question: "Resident intestinal bacteria help synthesize:", options: ["Vitamin A","Vitamin B12","Vitamin K","Vitamin D"], correct: 2 },
    { id: 1539, question: "Sympathetic nervous system stimulation on GI tract results in:", options: ["Increased peristalsis","Increased secretions","Inhibition of GI activity","Increased absorption"], correct: 2 },
    { id: 1540, question: "Parasympathetic stimulation causes:", options: ["Decreased digestion","Reduced motility","Increased peristalsis","Inhibited secretion"], correct: 2 },
    { id: 1541, question: "Carbohydrates are absorbed mainly in the:", options: ["Stomach","Duodenum","Jejunum and ileum","Colon"], correct: 2 },
    { id: 1542, question: "Proteins are ultimately absorbed as:", options: ["Peptides","Amino acids","Fatty acids","Monosaccharides"], correct: 1 },
    { id: 1543, question: "Lipids must first be emulsified by:", options: ["Pancreatic enzymes","Gastric acid","Bile","Saliva"], correct: 2 },
    { id: 1544, question: "Fat-soluble vitamins are absorbed:", options: ["With carbohydrates","With proteins","With fats","Independently"], correct: 2 },
    { id: 1545, question: "Anorexia refers to:", options: ["Excessive eating","Loss of appetite","Nausea","Vomiting"], correct: 1 },
    { id: 1546, question: "Vomiting is best described as:", options: ["Passive regurgitation","Forceful expulsion of chyme","Failure of absorption","Excessive peristalsis"], correct: 1 },
    { id: 1547, question: "Steatorrhea indicates:", options: ["Blood in stool","Fatty stool due to malabsorption","Infection of colon","Dehydration"], correct: 1 },
    { id: 1548, question: "Cleft lip and palate primarily affect:", options: ["Liver development","Speech and feeding","Gastric acid production","Intestinal motility"], correct: 1 },
    { id: 1549, question: "Aphthous ulcers are:", options: ["Malignant oral tumors","Self-limiting painful oral lesions","Fungal infections","Viral ulcers"], correct: 1 },
    { id: 1550, question: "Oral candidiasis is caused by:", options: ["HSV-1","Candida albicans","Streptococcus mutans","Treponema pallidum"], correct: 1 },
    { id: 1551, question: "HSV-1 remains latent in the:", options: ["Spinal cord","Trigeminal ganglion","Salivary glands","Lymph nodes"], correct: 1 },
    { id: 1552, question: "Dental caries are initiated primarily by:", options: ["Lactobacillus only","Streptococcus mutans","Candida species","Actinomyces"], correct: 1 },
    { id: 1553, question: "Gingivitis is characterized by:", options: ["Bone destruction","Red, swollen gingiva","Tooth loss","Painless ulcers"], correct: 1 },
    { id: 1554, question: "Leukoplakia is an example of:", options: ["Infection","Hyperkeratosis","Ulceration","Gingivitis"], correct: 1 },
    { id: 1555, question: "Acute gastritis involves:", options: ["Mucosal atrophy only","Severe inflammation and edema","Loss of secretory glands","Intestinal obstruction"], correct: 1 },
    { id: 1556, question: "Chronic gastritis is associated with:", options: ["Helicobacter pylori infection","Viral pathogens only","Acute bleeding only","Excess bile production"], correct: 0 },
    { id: 1557, question: "Peptic ulcers commonly result from:", options: ["Reduced acid secretion","Helicobacter pylori and NSAIDs","Viral infection","Vitamin deficiency"], correct: 1 },
    { id: 1558, question: "TRUE / FALSE QUESTIONS The GI tract includes accessory organs such as the liver and pancreas.", options: ["True","False"], correct: 0 },
    { id: 1559, question: "Saliva begins protein digestion.", options: ["True","False"], correct: 1 },
    { id: 1560, question: "Peristalsis is a voluntary process.", options: ["True","False"], correct: 1 },
    { id: 1561, question: "Bile is produced by the gallbladder.", options: ["True","False"], correct: 1 },
    { id: 1562, question: "The jejunum has structures that increase surface area for absorption.", options: ["True","False"], correct: 0 },
    { id: 1563, question: "The colon absorbs most nutrients.", options: ["True","False"], correct: 1 },
    { id: 1564, question: "Anorexia may result from dehydration and malnutrition.", options: ["True","False"], correct: 0 },
    { id: 1565, question: "HSV-1 can spread during dental procedures.", options: ["True","False"], correct: 0 },
    { id: 1566, question: "Smoking increases the risk of periodontal disease.", options: ["True","False"], correct: 0 },
    { id: 1567, question: "Peptic ulcers can cause bleeding if blood vessels are damaged.", options: ["True","False"], correct: 0 }
  ],

  "10. Endocrine System Disorders": [
    { id: 1568, question: "Hormones are chemical messengers that travel through the bloodstream to reach target cells. What determines which cells respond to a specific hormone?", options: ["The presence of specific receptors on target cells","The size of the hormone molecule itself","The distance between gland and target tissue","The concentration of blood in the tissue"], correct: 0 },
    { id: 1569, question: "Which type of hormone can directly enter the cell nucleus to initiate transcription without requiring a secondary messenger system?", options: ["Peptide hormones that bind to surface receptors","Steroid hormones that are lipid-soluble molecules","Protein hormones that require enzyme activation","Amine hormones that use cyclic AMP"], correct: 1 },
    { id: 1570, question: "The endocrine system primarily uses which mechanism to maintain hormone balance and prevent excessive secretion?", options: ["Positive feedback loops that amplify hormone production","Direct nervous system control of all glands","Negative feedback systems that inhibit further release","Random fluctuation patterns without specific regulation"], correct: 2 },
    { id: 1571, question: "Calcitonin and parathyroid hormone, as well as insulin and glucagon, are examples of hormones that function as:", options: ["Synergistic pairs that work together cooperatively","Antagonists that have opposing effects on metabolism","Identical molecules with different names only","Hormones that target the same receptor sites"], correct: 1 },
    { id: 1572, question: "What is the primary distinguishing feature between Type 1 and Type 2 diabetes mellitus?", options: ["Type 1 involves autoimmune beta cell destruction requiring insulin","Type 1 only affects children under age ten","Type 1 is always caused by obesity","Type 1 can be controlled with diet alone"], correct: 0 },
    { id: 1573, question: "A patient with Type 1 diabetes mellitus would be expected to have which metabolic characteristic?", options: ["Excessive insulin production from pancreatic beta cells","Increased cellular uptake of glucose throughout body","Catabolism of fats and proteins with ketone production","Decreased blood glucose levels below normal range"], correct: 2 },
    { id: 1574, question: "Which classic triad of symptoms characterizes uncontrolled diabetes mellitus due to hyperglycemia and glucosuria?", options: ["Polyphagia, polydipsia, and polyuria as cardinal signs","Bradycardia, hypotension, and decreased respiratory rate","Fever, chills, and night sweats","Muscle spasms, seizures, and loss of consciousness"], correct: 0 },
    { id: 1575, question: "What diagnostic test monitors average blood glucose control over several months in diabetic patients?", options: ["Single fasting blood glucose measurement","Glycosylated hemoglobin test showing long-term control","Urine ketone testing for daily monitoring","Random blood glucose checks throughout day"], correct: 1 },
    { id: 1576, question: "Diabetic ketoacidosis is most commonly associated with which type of diabetes and what triggers it?", options: ["Type 2 diabetes triggered by excessive carbohydrate intake","Type 1 diabetes initiated by infection or stress","Gestational diabetes caused by pregnancy hormones only","Prediabetes with minimal metabolic changes present"], correct: 1 },
    { id: 1577, question: "A patient experiencing insulin shock would present with which characteristic findings?", options: ["Hyperglycemia with acetone breath and dehydration","Hypoglycemia with confusion and decreased consciousness","Normal blood glucose with severe abdominal pain","Elevated glucose with polyuria and polydipsia"], correct: 1 },
    { id: 1578, question: "Which acute diabetic complication occurs primarily in Type 2 diabetes and features severe dehydration without significant ketoacidosis?", options: ["Diabetic ketoacidosis with metabolic acidosis","Insulin shock from excessive insulin administration","HHNK syndrome with hyperosmolar hyperglycemia","Hypoglycemic coma from oral medication overdose"], correct: 2 },
    { id: 1579, question: "Chronic microvascular complications of diabetes mellitus most commonly affect which body systems?", options: ["Large arteries causing peripheral vascular disease only","Eyes, kidneys, and peripheral nerves through capillary damage","Skeletal muscles with reduced strength and mass","Digestive system with malabsorption of nutrients"], correct: 1 },
    { id: 1580, question: "What is the underlying mechanism causing diabetic retinopathy to become a leading cause of blindness?", options: ["Increased intraocular pressure from fluid accumulation","Obstruction or rupture of small retinal blood vessels","Bacterial infection of the cornea and lens","Vitamin deficiency affecting optic nerve function"], correct: 1 },
    { id: 1581, question: "Macroangiopathy in diabetic patients primarily results in which serious complications?", options: ["Capillary dysfunction in the glomeruli only","Heart attacks, strokes, and peripheral vascular disease","Minor skin infections without systemic involvement","Temporary visual changes that resolve spontaneously"], correct: 1 },
    { id: 1582, question: "Why are diabetic patients at increased risk for developing foot ulcers and potentially requiring amputation?", options: ["Improved sensation makes them more aware of injuries","Combination of neuropathy and vascular impairment reduces healing","Excessive bone growth creates pressure points","Rapid wound healing leads to scar tissue formation"], correct: 1 },
    { id: 1583, question: "What type of infection is particularly common in diabetic patients due to elevated glucose levels?", options: ["Viral infections of the upper respiratory tract","Parasitic infections of the gastrointestinal system","Fungal infections caused by Candida species","Prion diseases affecting the nervous system"], correct: 2 },
    { id: 1584, question: "The primary treatment goal for Type 2 diabetes focuses on which lifestyle modifications?", options: ["Increased refined sugar intake with minimal exercise","Diet with increased fiber, reduced lipids, and regular exercise","Complete bed rest with high-calorie supplementation","Elimination of all carbohydrates from the diet"], correct: 1 },
    { id: 1585, question: "Hypoparathyroidism leading to hypocalcemia would cause which neuromuscular symptoms?", options: ["Decreased nerve excitability with muscle weakness only","Increased nerve excitability with spontaneous muscle contractions","No changes in muscle or nerve function","Permanent paralysis of all skeletal muscles"], correct: 1 },
    { id: 1586, question: "Which condition results from excess parathyroid hormone causing elevated blood calcium levels?", options: ["Osteoporosis with kidney stones and cardiac effects","Increased bone density with hypocalcemia","Decreased cardiac contractility with bradycardia","Reduced kidney function without bone changes"], correct: 0 },
    { id: 1587, question: "Endemic goiter develops in regions with inadequate iodine in the diet, resulting in:", options: ["Hyperthyroid state with excessive hormone production","Hypothyroid condition with thyroid gland enlargement","Normal thyroid function with cosmetic changes only","Temporary thyroid dysfunction that resolves spontaneously"], correct: 1 },
    { id: 1588, question: "Graves' disease is characterized by hyperthyroidism with which distinctive clinical feature?", options: ["Sunken eyes with decreased orbital tissue mass","Exophthalmos with protruding eyes and decreased blinking","Complete blindness from optic nerve compression","Normal eye appearance without any changes"], correct: 1 },
    { id: 1589, question: "A patient with untreated hyperthyroidism would typically present with which metabolic signs?", options: ["Cold intolerance, weight gain, and lethargy","Heat intolerance, weight loss, and hyperactivity","Normal body temperature with stable weight","Decreased appetite with muscle mass gain"], correct: 1 },
    { id: 1590, question: "Hypothyroidism in adults results in decreased metabolism causing which characteristic symptoms?", options: ["Increased energy levels with hyperactive reflexes","Intolerance to cold, increased BMI, and fatigue","Heat sensitivity with excessive sweating patterns","Rapid heart rate with nervous system excitation"], correct: 1 },
    { id: 1591, question: "Cretinism results from untreated congenital hypothyroidism and causes which permanent effects?", options: ["Tall stature with advanced intellectual development","Short stature with severe cognitive deficits","Normal growth with temporary developmental delays","Excessive height without mental impairment"], correct: 1 },
    { id: 1592, question: "Myxedema represents severe, untreated hypothyroidism characterized by:", options: ["Pitting edema in the lower extremities only","Nonpitting edema in face with thickened tongue","Excessive urination with dehydration","Hyperactive mental state with anxiety"], correct: 1 },
    { id: 1593, question: "Pheochromocytoma is a benign tumor of the adrenal medulla that causes which symptoms?", options: ["Decreased blood pressure with bradycardia consistently","Headache, heart palpitations, and intermittent anxiety","Hypothyroidism with weight gain and fatigue","Hypocalcemia with muscle spasms and tetany"], correct: 1 },
    { id: 1594, question: "Cushing's syndrome results from excessive glucocorticoids and causes which physical changes?", options: ["Thin appearance with muscle hypertrophy throughout body","Round face, truncal obesity, and thin extremities","Uniform weight loss with decreased fat stores","No visible changes in body composition"], correct: 1 },
    { id: 1595, question: "Which complication is associated with the protein catabolism seen in Cushing's syndrome?", options: ["Increased bone density with enhanced fracture resistance","Osteoporosis with fragile skin and delayed healing","Rapid wound healing with thick scar formation","Muscle hypertrophy with increased strength"], correct: 1 },
    { id: 1596, question: "Addison's disease is characterized by inadequate corticosteroid secretion, most commonly caused by:", options: ["Excessive hormone production from adrenal hyperplasia","Autoimmune destruction of adrenal cortex tissue","Bacterial infection of the pituitary gland","Dietary excess of sodium and glucose"], correct: 1 },
    { id: 1597, question: "Patients with Addison's disease would present with which metabolic and electrolyte abnormalities?", options: ["Hyperglycemia with elevated sodium and low potassium","Hypoglycemia with low sodium and elevated potassium","Normal glucose with no electrolyte imbalances","Hyperglycemia with normal electrolyte balance maintained"], correct: 1 },
    { id: 1598, question: "Acromegaly in adults results from excess growth hormone secretion and causes:", options: ["Increased height with elongation of long bones","Broader, heavier bones with enlarged hands and feet","Decreased bone density with frequent fractures","No skeletal changes after epiphyseal plate closure"], correct: 1 },
    { id: 1599, question: "Diabetes insipidus is caused by deficient antidiuretic hormone (ADH) and results in:", options: ["Excessive urination with dehydration and thirst","Fluid retention with decreased urine output","Normal urine volume with elevated glucose","Oliguria with concentrated urine production"], correct: 0 },
    { id: 1600, question: "Which laboratory finding would indicate inadequate control of diabetes mellitus over time?", options: ["Elevated glycosylated hemoglobin showing chronic hyperglycemia","Single normal fasting glucose measurement","Decreased blood glucose levels consistently","Normal glycosylated hemoglobin with high ketones"], correct: 0 },
    { id: 1601, question: "Hashimoto's thyroiditis is an autoimmune disorder that causes:", options: ["Hyperthyroidism with excessive hormone production","Hypothyroidism with gradual thyroid destruction","Normal thyroid function without inflammation","Thyroid cancer with rapid metastasis"], correct: 1 },
    { id: 1602, question: "Which factor contributes to the development of Type 2 diabetes mellitus?", options: ["Autoimmune destruction of pancreatic beta cells","Insulin resistance combined with relative insulin deficiency","Complete absence of insulin production","Excessive insulin production without resistance"], correct: 1 },
    { id: 1603, question: "A pituitary adenoma causing excess growth hormone before puberty results in:", options: ["Dwarfism with proportionally small stature","Gigantism with excessive height before epiphyseal fusion","Acromegaly with bone thickening after maturity","Normal growth patterns without changes"], correct: 1 },
    { id: 1604, question: "The \"three P's\" of diabetes (polyphagia, polydipsia, polyuria) occur because:", options: ["Insulin excess causes cellular starvation and dehydration","Cellular glucose deficit and osmotic diuresis from glucosuria","Decreased metabolic rate reduces energy production","Normal physiological response to exercise and activity"], correct: 1 },
    { id: 1605, question: "Diabetic neuropathy causes loss of sensation in the feet, which increases risk for:", options: ["Enhanced ability to detect injuries early","Unnoticed injuries leading to ulcers and infections","Improved balance and coordination during walking","Increased sensation with hypersensitivity to touch"], correct: 1 },
    { id: 1606, question: "Which mechanism causes the characteristic \"moon face\" appearance in Cushing's syndrome?", options: ["Decreased subcutaneous fat in facial region","Fat redistribution to face and trunk with muscle wasting","Severe dehydration with sunken facial features","Excessive muscle development in jaw and cheeks"], correct: 1 },
    { id: 1607, question: "Goitrogens are foods that can interfere with thyroid hormone synthesis and include:", options: ["Foods high in iodine like seafood and seaweed","Cruciferous vegetables like kale, broccoli, and cabbage","Citrus fruits and berries with vitamin C","Red meat and poultry with high protein content"], correct: 1 },
    { id: 1608, question: "The negative feedback system regulating calcium homeostasis involves which hormone pair?", options: ["Insulin and glucagon regulating blood glucose","Parathyroid hormone and calcitonin regulating calcium","Thyroid hormone and TSH controlling metabolism","Cortisol and ACTH managing stress response"], correct: 1 },
    { id: 1609, question: "Which diagnostic test can differentiate between primary adrenal insufficiency and pituitary causes?", options: ["Blood glucose measurement during fasting state","ACTH stimulation test showing adrenal response","Thyroid function tests with TSH levels","Growth hormone levels after exercise"], correct: 1 },
    { id: 1610, question: "Iatrogenic Cushing's syndrome most commonly results from:", options: ["Spontaneous pituitary tumor development","Long-term corticosteroid medication use","Dietary excess of protein and fat","Genetic inheritance from both parents"], correct: 1 },
    { id: 1611, question: "The relationship between immobility and calcium metabolism involves:", options: ["Increased bone density from reduced stress","Bone calcium release causing hypercalcemia","Enhanced calcium absorption from diet","No effect on serum calcium levels"], correct: 1 },
    { id: 1612, question: "Which pathophysiological change explains the polyuria in uncontrolled diabetes mellitus?", options: ["Decreased kidney function with reduced filtration","Hyperosmolar filtrate from glucosuria drawing water into urine","Excessive water intake without glucose involvement","Increased production of antidiuretic hormone"], correct: 1 },
    { id: 1613, question: "Striae (stretch marks) in Cushing's syndrome develop because:", options: ["Rapid muscle growth stretches the skin","Protein catabolism causes fragile, thin skin","Excessive collagen production strengthens dermis","Increased melanin deposition in skin layers"], correct: 1 },
    { id: 1614, question: "The primary function of the hypothalamus in endocrine regulation is to:", options: ["Produce insulin and glucagon for glucose regulation","Secrete releasing hormones that control pituitary function","Directly synthesize all steroid hormones","Store and release thyroid hormone as needed"], correct: 1 },
    { id: 1615, question: "Which complication of diabetes results from atherosclerosis in large blood vessels?", options: ["Retinopathy with blindness from capillary damage","Increased risk of myocardial infarction and stroke","Nephropathy with kidney failure from glomerular disease","Neuropathy with loss of sensation in extremities"], correct: 1 },
    { id: 1616, question: "The reason pregnant women with diabetes require careful monitoring is:", options: ["Pregnancy cures diabetes without treatment needed","Complications can affect both mother and fetus development","Diabetes always resolves after delivery occurs","Fetal size is always smaller than normal"], correct: 1 },
    { id: 1617, question: "Steroid hormones require a secondary messenger system to activate transcription in the cell nucleus.", options: ["True","False"], correct: 1 },
    { id: 1618, question: "The endocrine and nervous systems work together to regulate metabolic activities in the body.", options: ["True","False"], correct: 0 },
    { id: 1619, question: "Type 1 diabetes mellitus is typically associated with obesity and occurs in people over age 50.", options: ["True","False"], correct: 1 },
    { id: 1620, question: "Glucosuria occurs when blood glucose levels exceed the renal threshold, causing glucose to appear in urine.", options: ["True","False"], correct: 0 },
    { id: 1621, question: "Exercise reduces blood glucose levels because skeletal muscle can use glucose without requiring insulin.", options: ["True","False"], correct: 0 },
    { id: 1622, question: "Diabetic ketoacidosis is characterized by metabolic acidosis, dehydration, and presence of ketones in blood.", options: ["True","False"], correct: 0 },
    { id: 1623, question: "The glycosylated hemoglobin test provides information about blood glucose control over just the past 24 hours.", options: ["True","False"], correct: 1 },
    { id: 1624, question: "Microangiopathy in diabetes affects small blood vessels and commonly causes retinopathy, nephropathy, and neuropathy.", options: ["True","False"], correct: 0 },
    { id: 1625, question: "Diabetic patients have decreased risk of infections compared to non-diabetic individuals.", options: ["True","False"], correct: 1 },
    { id: 1626, question: "Periodontal disease is more common and severe in patients with poorly controlled diabetes mellitus.", options: ["True","False"], correct: 0 },
    { id: 1627, question: "Hypocalcemia caused by hypoparathyroidism results in decreased nerve excitability and muscle weakness.", options: ["True","False"], correct: 1 },
    { id: 1628, question: "Endemic goiter develops in regions where soil and food contain inadequate amounts of iodine.", options: ["True","False"], correct: 0 },
    { id: 1629, question: "Exophthalmos is a characteristic feature of Graves' disease causing protruding eyes with decreased blinking.", options: ["True","False"], correct: 0 },
    { id: 1630, question: "Hypothyroidism causes increased metabolism, heat intolerance, and weight loss in affected patients.", options: ["True","False"], correct: 1 },
    { id: 1631, question: "Myxedema coma is a life-threatening complication of severe, untreated hypothyroidism.", options: ["True","False"], correct: 0 },
    { id: 1632, question: "Pheochromocytoma is a malignant tumor of the adrenal medulla that always requires immediate surgical removal.", options: ["True","False"], correct: 1 },
    { id: 1633, question: "Cushing's syndrome causes fat redistribution with truncal obesity, moon face, and thin extremities.", options: ["True","False"], correct: 0 },
    { id: 1634, question: "Addison's disease results from excessive corticosteroid secretion causing hypertension and hyperglycemia.", options: ["True","False"], correct: 1 },
    { id: 1635, question: "Acromegaly in adults causes increased height through elongation of long bones after epiphyseal plate closure.", options: ["True","False"], correct: 1 },
    { id: 1636, question: "Diabetes insipidus is caused by deficient antidiuretic hormone resulting in excessive urination and dehydration.", options: ["True","False"], correct: 0 },
    { id: 1637, question: "Adenomas are the most common cause of pituitary disorders affecting hormone secretion.", options: ["True","False"], correct: 0 },
    { id: 1638, question: "Growth hormone excess before puberty causes dwarfism with proportionally reduced stature.", options: ["True","False"], correct: 1 },
    { id: 1639, question: "The blood-brain barrier prevents glucose entry, making the central nervous system particularly vulnerable to hypoglycemia.", options: ["True","False"], correct: 0 },
    { id: 1640, question: "Insulin shock requires immediate administration of glucose to prevent permanent brain damage.", options: ["True","False"], correct: 0 },
    { id: 1641, question: "HHNK syndrome occurs primarily in Type 1 diabetes and features severe ketoacidosis.", options: ["True","False"], correct: 1 },
    { id: 1642, question: "Diabetic nephropathy results from degeneration of the glomeruli in the kidneys.", options: ["True","False"], correct: 0 },
    { id: 1643, question: "Candida infections in the vagina and oral cavity are common fungal infections in diabetic patients.", options: ["True","False"], correct: 0 },
    { id: 1644, question: "Cataracts in diabetic patients result from abnormal glucose metabolism affecting the lens of the eye.", options: ["True","False"], correct: 0 },
    { id: 1645, question: "Infants born to diabetic mothers typically have decreased size and weight for gestational age.", options: ["True","False"], correct: 1 },
    { id: 1646, question: "Hyperparathyroidism causes hypercalcemia, which can lead to osteoporosis and kidney stone formation.", options: ["True","False"], correct: 0 },
    { id: 1647, question: "Toxic goiter results from hyperactivity of the thyroid gland producing excessive hormones.", options: ["True","False"], correct: 0 },
    { id: 1648, question: "Cretinism can be prevented through early detection and treatment with thyroid hormone replacement therapy.", options: ["True","False"], correct: 0 },
    { id: 1649, question: "Cushing's syndrome causes increased bone density and enhanced wound healing capabilities.", options: ["True","False"], correct: 1 },
    { id: 1650, question: "Addison's disease results in hypoglycemia, low sodium levels, and elevated potassium levels.", options: ["True","False"], correct: 0 },
    { id: 1651, question: "Iatrogenic Cushing's syndrome can result from long-term use of corticosteroid medications for treating other conditions.", options: ["True","False"], correct: 0 },
    { id: 1652, question: "The hormones secreted by the endocrine system travel through the bloodstream to reach target cells.", options: ["True","False"], correct: 0 },
    { id: 1653, question: "Negative feedback systems in the endocrine system prevent excessive hormone secretion and maintain balance.", options: ["True","False"], correct: 0 }
  ],

  "11. Neoplasms and Cancer": [
    { id: 1658, question: "Which term describes programmed cell death controlled by genetic elements?", options: ["Mitosis","Apoptosis","Differentiation","Mutation"], correct: 1 },
    { id: 1659, question: "What is the defining characteristic of a neoplasm?", options: ["Cellular growth that responds to normal genetic controls","Temporary increase in cell reproduction","Cellular growth that no longer responds to normal genetic controls","Controlled cell death"], correct: 2 },
    { id: 1660, question: "Which suffix is used to name benign tumors?", options: ["-oma","-carcinoma","-sarcoma","-blastoma"], correct: 0 },
    { id: 1661, question: "Malignant tumors arising from epithelial tissue have which suffix?", options: ["-oma","-sarcoma","-lymphoma","-carcinoma"], correct: 3 },
    { id: 1662, question: "Which characteristic distinguishes benign tumors from malignant tumors?", options: ["Benign tumors are always life-threatening","Benign tumors are encapsulated","Benign tumors spread to distant sites","Benign tumors have rapid mitotic figures"], correct: 1 },
    { id: 1663, question: "What type of cells are typically found in malignant tumors?", options: ["Well-differentiated functional cells","Encapsulated cells","Undifferentiated nonfunctional cells","Cells with normal organization"], correct: 2 },
    { id: 1664, question: "Which process describes the formation of new blood vessels stimulated by tumor cells?", options: ["Metastasis","Angiogenesis","Apoptosis","Differentiation"], correct: 1 },
    { id: 1665, question: "What is cachexia in cancer patients?", options: ["Increased appetite and weight gain","Weight loss and weakness","Elevated blood pressure","Increased red blood cell production"], correct: 1 },
    { id: 1666, question: "Which warning sign is NOT typically associated with cancer?", options: ["Unusual bleeding or discharge","Change in bowel or bladder habits","Increased energy levels","A sore that does not heal"], correct: 2 },
    { id: 1667, question: "At what stage does pain typically appear in cancer patients?", options: ["Immediately upon tumor formation","During the first week of growth","May be absent until very late stages","Only after successful treatment"], correct: 2 },
    { id: 1668, question: "What is the term for the spread of cancer cells to distant sites?", options: ["Invasion","Metastasis","Angiogenesis","Differentiation"], correct: 1 },
    { id: 1669, question: "Which route is NOT commonly used for cancer metastasis?", options: ["Lymphatic system","Blood vessels","Body fluids","Nerve fibers"], correct: 3 },
    { id: 1670, question: "What does the \"T\" represent in the TNM staging system?", options: ["Type of cancer cell","Time since diagnosis","Size of primary tumor","Total number of tumors"], correct: 2 },
    { id: 1671, question: "Which factor is considered an initiating factor in carcinogenesis?", options: ["Hormones","Procarcinogens","Environmental chemicals as promoters","Chronic inflammation"], correct: 1 },
    { id: 1672, question: "What is dysplasia?", options: ["Normal cell growth","Programmed cell death","Abnormal growth","Rapid cell reproduction"], correct: 2 },
    { id: 1673, question: "Which type of radiation is mentioned as a cancer risk factor?", options: ["Sound waves","Magnetic fields","Ultraviolet rays","Radio waves only"], correct: 2 },
    { id: 1674, question: "What do oncoviruses do to host cells?", options: ["Destroy them immediately","Alter the host cell's DNA","Strengthen their defenses","Increase oxygen supply"], correct: 1 },
    { id: 1675, question: "Which dietary modification helps reduce cancer risk?", options: ["Increased fat content","Reduced fiber intake","Five to ten servings of fresh fruits and vegetables daily","Elimination of all proteins"], correct: 2 },
    { id: 1676, question: "What role does cell-mediated immunity play in cancer prevention?", options: ["It has no effect on tumors","It recognizes and destroys some tumor cells","It promotes tumor growth","It only affects bacterial infections"], correct: 1 },
    { id: 1677, question: "Which treatment involves removal of the tumor and surrounding tissue?", options: ["Chemotherapy","Radiation therapy","Surgery","Immunotherapy"], correct: 2 },
    { id: 1678, question: "What is radiofrequency ablation (RFA)?", options: ["A chemotherapy drug","A type of radiation therapy","An alternative surgery technique for various tumors","An immunotherapy treatment"], correct: 2 },
    { id: 1679, question: "How does radiation therapy primarily work against cancer cells?", options: ["By strengthening normal cells","By causing mutations or alterations in target DNA","By increasing blood flow","By promoting cell differentiation"], correct: 1 },
    { id: 1680, question: "Which cells are most affected by radiation therapy?", options: ["Slowly dividing cells","Non-dividing cells","Rapidly dividing cells","Fully differentiated cells"], correct: 2 },
    { id: 1681, question: "What is a common adverse effect of radiation therapy?", options: ["Weight gain","Increased energy","Bone marrow depression","Elevated blood pressure"], correct: 2 },
    { id: 1682, question: "How do antineoplastic drugs work?", options: ["They strengthen cancer cell membranes","They interfere with protein synthesis and/or DNA replication","They increase tumor blood supply","They promote cell differentiation"], correct: 1 },
    { id: 1683, question: "What is the nadir in chemotherapy treatment?", options: ["The highest point of cell count","The point of lowest cell count","The beginning of treatment","The end of treatment"], correct: 1 },
    { id: 1684, question: "Which adverse effect is NOT typically associated with chemotherapy?", options: ["Nausea","Hair loss","Increased appetite","Bone marrow depression"], correct: 2 },
    { id: 1685, question: "What do biological response modifiers (BRMs) do?", options: ["Destroy cancer cells directly","Augment the natural immune response","Block blood vessel formation","Alter DNA directly"], correct: 1 },
    { id: 1686, question: "What is the purpose of angiogenesis inhibitors?", options: ["To promote blood vessel growth","To inhibit the stimulus for growth of blood vessels","To increase tumor nutrition","To enhance cell division"], correct: 1 },
    { id: 1687, question: "Which factor contributes to malnutrition in cancer patients?", options: ["Increased taste sensation","Enhanced appetite","Change in taste sensation","Improved digestion"], correct: 2 },
    { id: 1688, question: "What defines a cancer-free state?", options: ["Six months without symptoms","One year survival","Five-year survival without recurrence","Complete elimination of all cells"], correct: 2 },
    { id: 1689, question: "What is remission in cancer treatment?", options: ["Complete cure of cancer","No clinical signs of cancer","Worsening of symptoms","Immediate death of all cancer cells"], correct: 1 },
    { id: 1690, question: "Which cancer has excellent prognosis due to early detection?", options: ["Ovarian cancer","Brain cancer","Skin cancer (except melanoma)","Pancreatic cancer"], correct: 2 },
    { id: 1691, question: "Why does ovarian cancer have a poor prognosis?", options: ["It grows very slowly","It is easily visible","It has a hidden nature","It never metastasizes"], correct: 2 },
    { id: 1692, question: "Which statement about brain tumors is correct?", options: ["Only malignant brain tumors are life-threatening","Both benign and malignant brain tumors can be life-threatening","Brain tumors never compress tissue","All brain tumors are easily treatable"], correct: 1 },
    { id: 1693, question: "What is the most common cancer in men?", options: ["Lung cancer","Colorectal cancer","Prostate cancer","Skin cancer"], correct: 2 },
    { id: 1694, question: "What is the most common cancer in women?", options: ["Ovarian cancer","Breast cancer","Lung cancer","Cervical cancer"], correct: 1 },
    { id: 1695, question: "Which cancer is common in both men and women?", options: ["Prostate cancer","Breast cancer","Testicular cancer","Colorectal cancer"], correct: 3 },
    { id: 1696, question: "What is a paraneoplastic syndrome?", options: ["A benign tumor","Tumor cells releasing substances that affect neurological function and may have hormonal effects","A type of chemotherapy","Normal cell growth"], correct: 1 },
    { id: 1697, question: "Which term describes cancer cells that lack normal organization?", options: ["Differentiation","Encapsulation","Anaplasia","Apoptosis"], correct: 2 },
    { id: 1698, question: "What happens when tumor cells compress blood vessels?", options: ["Increased nutrition to tumor","Faster growth","Leads to necrosis and inflammation around tumor","Improved oxygenation"], correct: 2 },
    { id: 1699, question: "Which is a systemic effect of malignant tumors?", options: ["Increased muscle mass","Elevated energy levels","Anemia","Improved appetite"], correct: 2 },
    { id: 1700, question: "What causes anemia in cancer patients?", options: ["Increased red blood cell production","Blood loss at tumor site","Enhanced hemoglobin synthesis","Improved nutrition"], correct: 1 },
    { id: 1701, question: "Which diagnostic test is most dependable for confirming malignancy?", options: ["Blood tests","X-rays","Cytological tests requiring biopsy","Physical examination"], correct: 2 },
    { id: 1702, question: "What do tumor markers in blood tests indicate?", options: ["Complete absence of cancer","Presence of specific cancers","Normal cell function","Successful treatment completion"], correct: 1 },
    { id: 1703, question: "Which self-examination is important for early cancer detection?", options: ["Blood pressure monitoring","Breast examination","Heart rate checking","Vision testing"], correct: 1 },
    { id: 1704, question: "What is the PSA test used for?", options: ["Breast cancer detection","Lung cancer screening","Prostate cancer marker detection","Skin cancer diagnosis"], correct: 2 },
    { id: 1705, question: "How often should routine cancer screening be performed?", options: ["Once in a lifetime","Only when symptoms appear","Regularly for early detection","Never necessary"], correct: 2 },
    { id: 1706, question: "What makes cancer a multifactorial disease?", options: ["It has only one cause","Environmental effects, gene expression changes, and infections","It only affects one organ","It cannot be prevented"], correct: 1 },
    { id: 1707, question: "Which infection is associated with cervical cancer?", options: ["Bacterial pneumonia","Viral infection (HPV)","Fungal infection","Parasitic infection"], correct: 1 },
    { id: 1708, question: "Which chemical is listed as a cancer risk factor?", options: ["Water","Oxygen","Asbestos","Carbon dioxide"], correct: 2 },
    { id: 1709, question: "What is chronic irritation's role in cancer development?", options: ["It prevents cancer","It has no effect","It is a biological risk factor","It only affects skin"], correct: 2 },
    { id: 1710, question: "How does diet influence cancer risk?", options: ["Diet has no effect on cancer","High fat and low fiber increase risk","All foods cause cancer equally","Only protein affects cancer risk"], correct: 1 },
    { id: 1711, question: "What is the role of hormones in cancer development?", options: ["They always prevent cancer","They have no effect","They can be biological risk factors","They only affect children"], correct: 2 },
    { id: 1712, question: "Which statement about chemotherapy drugs is correct?", options: ["They affect only cancer cells","They are given continuously without breaks","They are usually given as a combination of two to four drugs","They have no side effects"], correct: 2 },
    { id: 1713, question: "What is the purpose of giving chemotherapy at periodic intervals?", options: ["To save money","To allow recovery between treatments","To make patients uncomfortable","To reduce effectiveness"], correct: 1 },
    { id: 1714, question: "Which chemotherapy classification includes drugs that block mitosis?", options: ["Antibiotics","Antimetabolites","Antimitotics","Alkylating agents"], correct: 2 },
    { id: 1715, question: "What type of damage occurs most commonly from chemotherapy?", options: ["Bone strengthening","Epithelial cell damage","Improved skin health","Enhanced hair growth"], correct: 1 },
    { id: 1716, question: "Which organ can be specifically damaged by some antineoplastic drugs?", options: ["Stomach only","Lungs","Ears only","Eyes only"], correct: 1 },
    { id: 1717, question: "What nutritional problem is common in advanced cancer patients?", options: ["Obesity","Excessive appetite","Malabsorption","Increased metabolism"], correct: 2 },
    { id: 1718, question: "Why is nutrition difficult for cancer patients during treatment?", options: ["Food tastes better","Increased appetite","Sore mouth or vomiting from treatments","Enhanced digestion"], correct: 2 },
    { id: 1719, question: "What is the primary goal of complementary therapies in cancer care?", options: ["To replace conventional treatment entirely","To support conventional treatment","To cure cancer alone","To eliminate all symptoms immediately"], correct: 1 },
    { id: 1720, question: "Which complementary therapy is mentioned in the lecture?", options: ["Crystal healing","Massage","Bloodletting","Trepanation"], correct: 1 },
    { id: 1721, question: "What should healthcare workers know about complementary therapies?", options: ["They should discourage all of them","They should be aware of different types to advise patients","They are all equally effective","They replace medical treatment"], correct: 1 },
    { id: 1722, question: "What happens to cancer cells that lack contact inhibition?", options: ["They stop growing when touching other cells","They continue growing despite contact with other cells","They immediately die","They become normal cells"], correct: 1 },
    { id: 1723, question: "Which statement describes altered surface antigens on cancer cells?", options: ["They are identical to normal cells","They are changed from normal cells","They improve immune recognition","They prevent metastasis"], correct: 1 },
    { id: 1724, question: "What is the significance of abnormal mitotic figures in cancer?", options: ["Indicates slow cell division","Shows normal cell growth","Indicates rapid reproduction","Means cells are dying"], correct: 2 },
    { id: 1725, question: "Which type of tissue gives rise to sarcomas?", options: ["Epithelial tissue","Nervous tissue","Connective tissue","Glandular tissue"], correct: 2 },
    { id: 1726, question: "What does adenocarcinoma indicate?", options: ["Benign bone tumor","Malignant glandular tumor","Benign muscle tumor","Malignant nerve tumor"], correct: 1 },
    { id: 1727, question: "Which cancer has a unique name rather than standard nomenclature?", options: ["Adenoma","Lipoma","Hodgkin's disease","Osteoma"], correct: 2 },
    { id: 1728, question: "What is Wilms' tumor?", options: ["A benign skin tumor","A malignant kidney tumor","A benign lung tumor","A malignant bone tumor"], correct: 1 },
    { id: 1729, question: "What characterizes leukemia?", options: ["Solid tumor in one location","Cancer of blood-forming tissues","Only affects bones","Always benign condition"], correct: 1 },
    { id: 1730, question: "Why can benign tumors be life-threatening in the brain?", options: ["They always metastasize","They grow extremely fast","Compression of brain structures","They produce toxins"], correct: 2 },
    { id: 1731, question: "What is tissue invasion in cancer?", options: ["Normal cell growth","Local spread into adjacent tissues","Spread through bloodstream only","Immune response to tumor"], correct: 1 },
    { id: 1732, question: "How do cancer cells typically spread through the body?", options: ["Only by direct contact","Via blood, lymph, or other body fluids","Through nerves only","They never spread"], correct: 1 },
    { id: 1733, question: "What does carcinoma in situ mean?", options: ["Cancer that has metastasized","Tumor cells confined to surface, non-invasive","Benign tumor","End-stage cancer"], correct: 1 },
    { id: 1734, question: "When tumor cells invade the basement membrane, what stage is reached?", options: ["Non-invasive stage","Benign stage","Invasive stage","Remission stage"], correct: 2 },
    { id: 1735, question: "What is the typical pathway for breast cancer metastasis?", options: ["Directly to bones only","Lymph nodes, then potentially lungs, liver, brain, bones","Only to nearby skin","It never metastasizes"], correct: 1 },
    { id: 1736, question: "What does the \"N\" represent in TNM staging?", options: ["Number of tumors","Name of cancer","Involvement of regional lymph nodes","Necrosis extent"], correct: 2 },
    { id: 1737, question: "What does the \"M\" represent in TNM staging?", options: ["Mass of tumor","Mitotic rate","Metastasis of tumor","Mutation type"], correct: 2 },
    { id: 1738, question: "Why is TNM staging essential?", options: ["To confuse patients","To standardize comparative studies of treatments and outcomes","To increase treatment costs","To delay treatment"], correct: 1 },
    { id: 1739, question: "What characterizes the initiation stage of carcinogenesis?", options: ["Tumor becomes visible","First irreversible change in cellular DNA","Metastasis occurs","Treatment begins"], correct: 1 },
    { id: 1740, question: "What role do promoters play in carcinogenesis?", options: ["They reverse DNA damage","They cause further changes in DNA","They destroy cancer cells","They have no effect"], correct: 1 },
    { id: 1741, question: "What are oncogenes?", options: ["Genes that prevent all tumors","Genes that regulate cell growth","Genes that only affect infections","Genes that control blood pressure"], correct: 1 },
    { id: 1742, question: "How do oncoviruses contribute to cancer?", options: ["They kill cancer cells","They strengthen immunity","They alter host cell DNA","They have no effect on cells"], correct: 2 },
    { id: 1743, question: "Which type of radiation increases cancer risk cumulatively?", options: ["Visible light","Sound waves","X-rays and gamma rays","Radio waves"], correct: 2 },
    { id: 1744, question: "What makes ultraviolet radiation dangerous?", options: ["It improves skin health","It causes DNA mutations","It strengthens cells","It has no biological effect"], correct: 1 },
    { id: 1745, question: "What are radioactive isotopes' effects?", options: ["Harmless to humans","Beneficial to all tissues","Increase cancer risk with exposure","Cure all cancers"], correct: 2 },
    { id: 1746, question: "Why should exposure to organic solvents be limited?", options: ["They smell bad","They are expensive","They are chemical carcinogens","They evaporate quickly"], correct: 2 },
    { id: 1747, question: "What is the danger of asbestos exposure?", options: ["None, it is completely safe","It causes respiratory cancers","It only affects skin","It improves lung function"], correct: 1 },
    { id: 1748, question: "How does formaldehyde pose a cancer risk?", options: ["It doesn't pose any risk","It is a chemical carcinogen","It prevents all cancers","It is only dangerous when eaten"], correct: 1 },
    { id: 1749, question: "Why is chronic inflammation a cancer risk?", options: ["It strengthens tissues","It causes tissue damage that can lead to cancer","It has no long-term effects","It only affects skin"], correct: 1 },
    { id: 1750, question: "How does age relate to cancer risk?", options: ["Only children get cancer","Cancer risk increases with age","Age has no effect on cancer","Only young adults get cancer"], correct: 1 },
    { id: 1751, question: "What dietary factor helps reduce cancer risk?", options: ["High fat intake","Low fiber consumption","Antioxidants in fruits and vegetables","Processed foods only"], correct: 2 },
    { id: 1752, question: "How can UV exposure be reduced?", options: ["By increasing sun exposure","By limiting sun exposure and using protection","By avoiding all outdoor activities","By using tanning beds instead"], correct: 1 },
    { id: 1753, question: "What is the benefit of regular medical examinations for cancer?", options: ["They guarantee cancer prevention","They allow for early detection","They cure all cancers","They are unnecessary"], correct: 1 },
    { id: 1754, question: "Why is self-examination important?", options: ["It replaces medical care","It enables early detection if done consistently","It is never helpful","It causes cancer"], correct: 1 },
    { id: 1755, question: "What vaccines help reduce cancer risk?", options: ["Flu vaccine only","Tetanus vaccine","HPV vaccine for cervical cancer and hepatitis vaccine","Rabies vaccine"], correct: 2 },
    { id: 1756, question: "What is the purpose of laparoscopic surgery for cancer?", options: ["To spread cancer","To minimize tissue damage and improve recovery time","To make surgery more expensive","To delay treatment"], correct: 1 },
    { id: 1757, question: "Why must adequate surrounding tissue be removed during cancer surgery?", options: ["To make larger scars","To ensure all cancer cells are removed","To cause more pain","To slow healing"], correct: 1 },
    { id: 1758, question: "What may happen when adequate tissue is removed during surgery?", options: ["Perfect restoration of function always","Possible changes in function","Improved function","No effect on function"], correct: 1 },
    { id: 1759, question: "What is external beam radiation therapy?", options: ["Radioactive material inserted in body","Radiation for short time to specific site from outside","Oral medication","Surgical procedure"], correct: 1 },
    { id: 1760, question: "What is internal radiation therapy?", options: ["Radiation from outside the body","Insertion of radioactive material at tumor site","Oral chemotherapy","No radiation involved"], correct: 1 },
    { id: 1761, question: "Why must patients with internal radiation be monitored for leakage?", options: ["To protect others from radiation exposure","To increase treatment time","To cause discomfort","It is not necessary"], correct: 0 },
    { id: 1762, question: "What type of tumors are treated with radioactive isotopes by injection?", options: ["All tumors equally","Specific tumors like thyroid cancer","Only benign tumors","No tumors respond"], correct: 1 },
    { id: 1763, question: "What blood changes indicate bone marrow depression?", options: ["Increased all cell types","Decreased leukocytes, erythrocytes, and platelets","Only increased platelets","No changes occur"], correct: 1 },
    { id: 1764, question: "Why is bone marrow depression a limiting factor in chemotherapy?", options: ["It is harmless","It increases infection risk and causes anemia and bleeding","It improves immunity","It has no effect"], correct: 1 },
    { id: 1765, question: "What is checked before each chemotherapy treatment?", options: ["Blood pressure only","Blood cell counts","Vision","Hearing"], correct: 1 },
    { id: 1766, question: "When does chemotherapy-induced nausea typically occur?", options: ["Never occurs","Only years after treatment","Prior to, during, or shortly after treatment","Only before treatment starts"], correct: 2 },
    { id: 1767, question: "What helps decrease chemotherapy-induced nausea?", options: ["Eating large meals","Antiemetic drugs","Drinking alcohol","Avoiding all fluids"], correct: 1 },
    { id: 1768, question: "Why does hair loss occur with chemotherapy?", options: ["It doesn't occur","Damage to rapidly dividing epithelial cells","Improved hair growth","Random occurrence"], correct: 1 },
    { id: 1769, question: "What skin changes occur with chemotherapy?", options: ["Improved skin health","Breakdown of skin and mucosa","Thicker skin","No changes"], correct: 1 },
    { id: 1770, question: "Which organ can develop fibrosis from some chemotherapy drugs?", options: ["Brain only","Lungs","Kidneys only","Stomach only"], correct: 1 },
    { id: 1771, question: "What cardiac effect can some chemotherapy drugs cause?", options: ["Stronger heartbeat","Damage to myocardial cells","Improved cardiac function","No cardiac effects"], correct: 1 },
    { id: 1772, question: "Why might kidney damage occur with chemotherapy?", options: ["It never happens","Some drugs are toxic to kidney cells","Kidneys are immune to drugs","Only helps kidney function"], correct: 1 },
    { id: 1773, question: "What do blocking agents do in cancer treatment?", options: ["Block blood flow completely","Block receptors for growth promoters on cancer cells","Block all cell division","Block only normal cells"], correct: 1 },
    { id: 1774, question: "What is the purpose of analgesics in cancer care?", options: ["To cure cancer","To alleviate pain","To promote tumor growth","To cause nausea"], correct: 1 },
    { id: 1775, question: "Why might high doses of analgesics be needed in cancer?", options: ["They are not effective","Severe pain requires stronger pain management","To cause addiction","They are inexpensive"], correct: 1 },
    { id: 1776, question: "What factor contributes to severe fatigue in cancer patients?", options: ["Increased energy production","Inflammatory changes, cachexia, anemia","Improved sleep","Enhanced metabolism"], correct: 1 },
    { id: 1777, question: "What causes effusions in cancer patients?", options: ["Decreased fluid production","Inflammation causing fluid buildup in body cavities","Improved drainage","Enhanced absorption"], correct: 1 },
    { id: 1778, question: "Why do infections occur frequently in cancer patients?", options: ["Improved immunity","Resistance declines","Increased white blood cells","Enhanced antibody production"], correct: 1 },
    { id: 1779, question: "How do tumor cells cause bleeding?", options: ["They strengthen blood vessels","They may erode blood vessels","They prevent all bleeding","They have no effect on vessels"], correct: 1 },
    { id: 1780, question: "What happens during cancer remission?", options: ["Cancer worsens","No clinical signs of cancer","Immediate death","Guaranteed cure"], correct: 1 },
    { id: 1781, question: "Can a patient experience multiple remissions?", options: ["No, only one is possible","Yes, cycles can repeat","Remission never occurs","Only two are possible"], correct: 1 },
    { id: 1782, question: "How is cancer cure generally defined?", options: ["One month without symptoms","Five-year survival without recurrence","Six months cancer-free","Any period without symptoms"], correct: 1 },
    { id: 1783, question: "Why do some childhood cancers require 10 years cancer-free to be considered cured?", options: ["To delay celebration","Some cancers have late recurrence patterns","It is arbitrary","Children heal slower"], correct: 1 },
    { id: 1784, question: "What determines life expectancy for specific cancers?", options: ["All cancers are identical","Type of cancer, stage, and treatment response","Patient's age only","Random chance"], correct: 1 },
    { id: 1785, question: "Why do death rates vary among cancer types?", options: ["All cancers have equal mortality","Different cancers have different biological behaviors","Treatment is identical for all","No variation exists"], correct: 1 },
    { id: 1786, question: "Apoptosis is programmed cell death controlled by genetic elements.", options: ["True","False"], correct: 0 },
    { id: 1787, question: "Benign tumors always spread to distant sites in the body.", options: ["True","False"], correct: 1 },
    { id: 1788, question: "Malignant tumors are characterized by undifferentiated, nonfunctional cells.", options: ["True","False"], correct: 0 },
    { id: 1789, question: "The suffix \"-oma\" indicates a malignant tumor.", options: ["True","False"], correct: 1 },
    { id: 1790, question: "Angiogenesis is the formation of new blood vessels stimulated by tumor cells.", options: ["True","False"], correct: 0 },
    { id: 1791, question: "Cancer pain is always present from the moment a tumor begins forming.", options: ["True","False"], correct: 1 },
    { id: 1792, question: "Metastasis refers to the spread of cancer to distant sites via blood or lymph.", options: ["True","False"], correct: 0 },
    { id: 1793, question: "The TNM staging system evaluates tumor size, lymph node involvement, and metastasis.", options: ["True","False"], correct: 0 },
    { id: 1794, question: "Procarcinogens cause the first irreversible change in cellular DNA during carcinogenesis.", options: ["True","False"], correct: 0 },
    { id: 1795, question: "Radiation therapy is most effective on slowly dividing cells.", options: ["True","False"], correct: 1 },
    { id: 1796, question: "Chemotherapy drugs are typically given as a single agent for best results.", options: ["True","False"], correct: 1 },
    { id: 1797, question: "Bone marrow depression is a limiting factor in chemotherapy treatment.", options: ["True","False"], correct: 0 },
    { id: 1798, question: "All brain tumors, whether benign or malignant, can be life-threatening due to compression.", options: ["True","False"], correct: 0 },
    { id: 1799, question: "Skin cancer generally has a poor prognosis because it is difficult to detect.", options: ["True","False"], correct: 1 },
    { id: 1800, question: "Ovarian cancer has a poor prognosis due to its hidden nature and late detection.", options: ["True","False"], correct: 0 },
    { id: 1801, question: "Prostate cancer is the most common cancer in men.", options: ["True","False"], correct: 0 },
    { id: 1802, question: "Breast cancer is the most common cancer in women.", options: ["True","False"], correct: 0 },
    { id: 1803, question: "A cancer-free state is generally defined as 5-year survival without recurrence.", options: ["True","False"], correct: 0 },
    { id: 1804, question: "Complementary therapies such as massage and meditation can support cancer care.", options: ["True","False"], correct: 0 },
    { id: 1805, question: "Antioxidants in fruits and vegetables help reduce DNA damage and cancer risk.", options: ["True","False"], correct: 0 },
    { id: 1806, question: "Regular self-examination has no value in early cancer detection.", options: ["True","False"], correct: 1 },
    { id: 1807, question: "HPV and hepatitis vaccinations can reduce cancer risk from infection.", options: ["True","False"], correct: 0 },
    { id: 1808, question: "Cachexia in cancer patients refers to weight loss and weakness.", options: ["True","False"], correct: 0 },
    { id: 1809, question: "Contact inhibition prevents normal cells from growing when they touch other cells.", options: ["True","False"], correct: 0 },
    { id: 1810, question: "Cancer cells have abnormal cell membranes and altered surface antigens.", options: ["True","False"], correct: 0 },
    { id: 1811, question: "Dysplasia means normal, healthy cell growth.", options: ["True","False"], correct: 1 },
    { id: 1812, question: "Chronic inflammation and irritation can be biological risk factors for cancer.", options: ["True","False"], correct: 0 },
    { id: 1813, question: "All chemotherapy drugs have identical side effects and toxicities.", options: ["True","False"], correct: 1 },
    { id: 1814, question: "Hair loss from chemotherapy is permanent and irreversible.", options: ["True","False"], correct: 1 },
    { id: 1815, question: "Biological response modifiers augment the natural immune response against cancer.", options: ["True","False"], correct: 0 },
    { id: 1816, question: "Angiogenesis inhibitors work by inhibiting the stimulus for blood vessel growth.", options: ["True","False"], correct: 0 },
    { id: 1817, question: "Malnutrition in cancer patients can be caused by changes in taste sensation and treatment side effects.", options: ["True","False"], correct: 0 },
    { id: 1818, question: "Remission means the patient is permanently cured of cancer.", options: ["True","False"], correct: 1 },
    { id: 1819, question: "A patient can experience multiple remissions and recurrences during their cancer journey.", options: ["True","False"], correct: 0 },
    { id: 1820, question: "Laparoscopic surgery minimizes tissue damage and improves recovery time.", options: ["True","False"], correct: 0 },
    { id: 1821, question: "External beam radiation requires multiple treatments for effectiveness.", options: ["True","False"], correct: 0 },
    { id: 1822, question: "Internal radiation therapy involves insertion of radioactive material at the tumor site.", options: ["True","False"], correct: 0 },
    { id: 1823, question: "The nadir is the point of highest blood cell count during chemotherapy.", options: ["True","False"], correct: 1 },
    { id: 1824, question: "Antiemetic drugs can help decrease chemotherapy-induced nausea.", options: ["True","False"], correct: 0 },
    { id: 1825, question: "Some chemotherapy drugs can cause specific organ damage such as lung fibrosis.", options: ["True","False"], correct: 0 },
    { id: 1826, question: "Age is not a factor in cancer risk.", options: ["True","False"], correct: 1 },
    { id: 1827, question: "A high-fiber, low-fat diet can help reduce cancer risk.", options: ["True","False"], correct: 0 },
    { id: 1828, question: "Limiting UV exposure from sun and tanning booths reduces skin cancer risk.", options: ["True","False"], correct: 0 },
    { id: 1829, question: "Biopsy and cytological examination provide the most dependable confirmation of malignancy.", options: ["True","False"], correct: 0 },
    { id: 1830, question: "Tumor markers in blood tests can help detect certain cancers.", options: ["True","False"], correct: 0 },
    { id: 1831, question: "Cancer is considered a multifactorial disease with environmental, genetic, and infectious components.", options: ["True","False"], correct: 0 },
    { id: 1832, question: "Oncogenes are genes that regulate cell growth.", options: ["True","False"], correct: 0 },
    { id: 1833, question: "Radioactive isotopes pose no cancer risk regardless of exposure level.", options: ["True","False"], correct: 1 },
    { id: 1834, question: "Asbestos is a known chemical carcinogen that can cause cancer.", options: ["True","False"], correct: 0 },
    { id: 1835, question: "Paraneoplastic syndrome occurs when tumor cells release substances affecting neurological function.", options: ["True","False"], correct: 0 }
  ]
};
